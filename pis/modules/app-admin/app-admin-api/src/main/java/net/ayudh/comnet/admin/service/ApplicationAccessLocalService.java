...
/**
 * Provides the local service interface for ApplicationAccess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ApplicationAccessLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ApplicationAccessLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.ayudh.comnet.admin.service.impl.ApplicationAccessLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the application access local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ApplicationAccessLocalServiceUtil} if injection and service tracking are not available.
	 */
