...
/**
 * Provides the local service utility for ApplicationUser. This utility wraps
 * <code>net.ayudh.comnet.admin.service.impl.ApplicationUserLocalServiceImpl</code> and
...
public class ApplicationUserLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>net.ayudh.comnet.admin.service.impl.ApplicationUserLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static net.ayudh.comnet.admin.model.ApplicationUser
		addApplicationUser(
	...
	public static boolean createApplicationUser() {
		return getService().createApplicationUser();
	}
	 ...
	 */
	public static net.ayudh.comnet.admin.model.ApplicationUser
		createApplicationUser(long applicationUserId) {

		return getService().createApplicationUser(applicationUserId);
	}
	 ...
	 */
	public static net.ayudh.comnet.admin.model.ApplicationUser
			deleteApplicationUser(long applicationUserId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteApplicationUser(applicationUserId);
	}
	...
	public static net.ayudh.comnet.admin.model.ApplicationUser
		fetchApplicationUser(long applicationUserId) {

		return getService().fetchApplicationUser(applicationUserId);
	}
	 ...
	 */
	public static net.ayudh.comnet.admin.model.ApplicationUser
			getApplicationUser(long applicationUserId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getApplicationUser(applicationUserId);
	}

	public static net.ayudh.comnet.admin.model.ApplicationUser
		getApplicationUserByPersonalNo(String personalNo) {

		return getService().getApplicationUserByPersonalNo(personalNo);
	}
	 ...
	 */
	public static java.util.List<net.ayudh.comnet.admin.model.ApplicationUser>
	...
	public static boolean updateApplicationUser(
		net.ayudh.comnet.admin.model.ApplicationUser applicationUser,
		long applicationUserId) {

		return getService().updateApplicationUser(
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ApplicationUserLocalService.class);

		ServiceTracker<ApplicationUserLocalService, ApplicationUserLocalService>
			serviceTracker =
				new ServiceTracker
					<ApplicationUserLocalService, ApplicationUserLocalService>(
						bundle.getBundleContext(),
						ApplicationUserLocalService.class, null);
