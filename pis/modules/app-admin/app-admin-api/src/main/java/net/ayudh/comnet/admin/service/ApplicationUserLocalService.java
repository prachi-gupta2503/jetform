...
/**
 * Provides the local service interface for ApplicationUser. Methods of this
...
public interface ApplicationUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.ayudh.comnet.admin.service.impl.ApplicationUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the application user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ApplicationUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public boolean updateApplicationUser(
		ApplicationUser applicationUser, long applicationUserId);
