...
public interface NotificationService extends BaseService {
	...
	@AccessControlled(guestAccessEnabled = true)
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Notification> getNotificationsByTopicAndClientId(
	...
	public Notification publish(Map<String, String> message)
		throws PortalException;

	@AccessControlled(guestAccessEnabled = true)
	public Notification publish(
			String topic, String clientId, Map<String, String> message)
		throws PortalException;
	...
	public List<UserNotificationEvent> updateUserNotificationArchievedStatus(
