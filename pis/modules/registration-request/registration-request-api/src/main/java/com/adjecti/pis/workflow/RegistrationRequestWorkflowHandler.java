...
public class RegistrationRequestWorkflowHandler extends BaseWorkflowHandler<RegistrationRequest>{
	...
	private static Log logger = LogFactoryUtil.getLog(RegistrationRequestWorkflowHandler.class);
	 ...
	 @Override
	    ...
	    @Override
	    public RegistrationRequest updateStatus(int status, Map<String, Serializable> workflowContext) throws PortalException {

	    	logger.info("RegistrationRequestWorkflowHandler.updateStatus********");
	        ...
	        return registrationRequestLocalService.updateStatus(userId, resourcePrimKey, status, serviceContext);
	    }
