...
/**
 * Provides the local service interface for BulkOnbordingFile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BulkOnbordingFileLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BulkOnbordingFileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.service.impl.BulkOnbordingFileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bulk onbording file local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BulkOnbordingFileLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BulkOnbordingFile> getBulkOnboardingRecords(
			long userId, long unitId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BulkOnbordingFile> getBulkOnboardingRecordsByUserId(long userId)
		throws PortalException;
