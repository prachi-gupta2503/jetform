...
package com.adj.userportlet.service.base;

import com.adj.userportlet.model.UserPortlet;
import com.adj.userportlet.service.UserPortletLocalService;
...
/**
 * Provides the base implementation for the user portlet local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adj.userportlet.service.impl.UserPortletLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adj.userportlet.service.impl.UserPortletLocalServiceImpl
 * @generated
 */
public abstract class UserPortletLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, UserPortletLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserPortletLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adj.userportlet.service.UserPortletLocalServiceUtil</code>.
	 */
	...
	public UserPortlet addUserPortlet(UserPortlet userPortlet) {
		...
		return userPortletPersistence.update(userPortlet);
	}
	...
	public UserPortlet createUserPortlet(long id) {
		return userPortletPersistence.create(id);
	}
	...
	public UserPortlet deleteUserPortlet(long id) throws PortalException {
		return userPortletPersistence.remove(id);
	}
	...
	public UserPortlet deleteUserPortlet(UserPortlet userPortlet) {
		return userPortletPersistence.remove(userPortlet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			UserPortlet.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userPortletPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return userPortletPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userPortletPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return userPortletPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public UserPortlet fetchUserPortlet(long id) {
		return userPortletPersistence.fetchByPrimaryKey(id);
	}
	...
	public UserPortlet fetchUserPortletByUuidAndGroupId(
		...
		return userPortletPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public UserPortlet getUserPortlet(long id) throws PortalException {
		return userPortletPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userPortletLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserPortlet.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(UserPortlet.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<UserPortlet>() {

				@Override
				public void performAction(UserPortlet userPortlet)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, userPortlet);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return userPortletPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return userPortletLocalService.deleteUserPortlet(
			(UserPortlet)persistedModel);
	}

	public BasePersistence<UserPortlet> getBasePersistence() {
		return userPortletPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return userPortletPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UserPortlet> getUserPortletsByUuidAndCompanyId(
		...
		return userPortletPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<UserPortlet> getUserPortletsByUuidAndCompanyId(
		...
		return userPortletPersistence.findByUuid_C(
	...
	public UserPortlet getUserPortletByUuidAndGroupId(String uuid, long groupId)
		...
		return userPortletPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<UserPortlet> getUserPortlets(int start, int end) {
		return userPortletPersistence.findAll(start, end);
	}
	...
	public int getUserPortletsCount() {
		return userPortletPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserPortletLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		userPortletLocalService = (UserPortletLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserPortletLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userPortletPersistence.getDataSource();
	...
	protected UserPortletLocalService userPortletLocalService;

	@Reference
	protected UserPortletPersistence userPortletPersistence;
