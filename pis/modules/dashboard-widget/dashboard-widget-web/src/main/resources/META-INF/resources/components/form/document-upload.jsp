...
<div class="container">
	<div class="row">
			<div class="col-md-12 toobar-background">
				<ul class="nav nav-tabs" id="loadDocumentTab" role="tablist">
					...
					<li class="nav-item"><a class="nav-link" id="scanner-tab" data-toggle="tab" href="#scanner" role="tab" aria-controls="scanner" aria-selected="false" onClick="loadDynamSoftJS();">Scan
							Document</a></li>
				</ul>
			</div>
	</div>
