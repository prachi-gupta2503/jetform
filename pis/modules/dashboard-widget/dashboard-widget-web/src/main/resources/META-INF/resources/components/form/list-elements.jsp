...
<%	
	...
	for (HtmlElementWrapper e : form.getElements()) {
		...
		Class childListClass=e.getFormClass();
...
%>
	...
	<liferay-util:include page="/components/form/list-element.jsp" servletContext="<%=application%>">
		<liferay-util:param name="childListClass" value="<%=childListClass.getName()%>" />
		<liferay-util:param name="parentClassName" value="<%=form.getEntityClass().getName()%>" />
