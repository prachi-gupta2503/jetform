...
@HtmlForm(formId="ResidenceAddressForm_123456",
...
elements={
	...
	@HtmlElement(name="addressTypeId", controlType = ControlType.hidden, value="2" )
})


public class ResidenceAddressForm {
	Address address;

	public ResidenceAddressForm(Address address) {
		super();
