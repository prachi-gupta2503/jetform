...
public class JetFormActionCommand extends  BaseMVCActionCommand{
	private static final Log LOGGER = LogFactoryUtil.getLog(JetFormActionCommand.class.getName());
