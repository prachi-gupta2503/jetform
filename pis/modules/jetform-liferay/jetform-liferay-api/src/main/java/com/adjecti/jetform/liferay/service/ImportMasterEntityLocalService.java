...
/**
 * Provides the local service interface for ImportMasterEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ImportMasterEntityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ImportMasterEntityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.jetform.liferay.service.impl.ImportMasterEntityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the import master entity local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ImportMasterEntityLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ImportMasterEntity addImportMasterEntity(
	...
	public ImportMasterEntity createImportMasterEntity(
	...
	public ImportMasterEntity deleteImportMasterEntity(
		ImportMasterEntity importMasterEntity);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ImportMasterEntity fetchImportMasterEntity(
		long importMasterEntityId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ImportMasterEntity> getImportMasterEntities(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ImportMasterEntity getImportMasterEntity(long importMasterEntityId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ImportMasterEntity updateImportMasterEntity(
		ImportMasterEntity importMasterEntity);
