...
/**
 * The base model interface for the LevelWisePayStructure service. Represents a row in the &quot;mdm_LevelWisePayStructure&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.adjecti.mdm.liferay.model.impl.LevelWisePayStructureModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.adjecti.mdm.liferay.model.impl.LevelWisePayStructureImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface LevelWisePayStructureModel
	extends BaseModel<LevelWisePayStructure>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a level wise pay structure model instance should use the {@link LevelWisePayStructure} interface instead.
	 */
