...
/**
 * Provides the local service interface for OccupationServiceType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OccupationServiceTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OccupationServiceTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.OccupationServiceTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the occupation service type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OccupationServiceTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
