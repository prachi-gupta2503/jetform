...
/**
 * <p>
 * This class is a wrapper for {@link DesignationMode}.
 * </p>
 *
 ...
 * @generated
 */
public class DesignationModeWrapper
	extends BaseModelWrapper<DesignationMode>
	implements DesignationMode, ModelWrapper<DesignationMode> {

	public DesignationModeWrapper(DesignationMode designationMode) {
		super(designationMode);
	}
	...
	@Override
	protected DesignationModeWrapper wrap(DesignationMode designationMode) {
		return new DesignationModeWrapper(designationMode);
	}
