...
/**
 * This class is used by SOAP remote services, specifically {@link com.adjecti.mdm.liferay.service.http.ReligionServiceSoap}.
 *
...
public class ReligionSoap implements Serializable {
	...
	public static ReligionSoap[] toSoapModels(List<Religion> models) {
		List<ReligionSoap> soapModels = new ArrayList<ReligionSoap>(
			models.size());
