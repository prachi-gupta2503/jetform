...
/**
 * Provides the local service utility for VerificationType. This utility wraps
 * <code>com.adjecti.mdm.liferay.service.impl.VerificationTypeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class VerificationTypeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.VerificationTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.VerificationType
		addVerificationType(
			com.adjecti.mdm.liferay.model.VerificationType verificationType) {

		return getService().addVerificationType(verificationType);
	}
	...
	public static com.adjecti.mdm.liferay.model.VerificationType
		...
		return getService().createVerificationType(verificationTypeId);
	}
	...
	public static com.adjecti.mdm.liferay.model.VerificationType
		...
		return getService().deleteVerificationType(verificationTypeId);
	}
	...
	public static com.adjecti.mdm.liferay.model.VerificationType
		...
		return getService().deleteVerificationType(verificationType);
	}
	...
	public static com.adjecti.mdm.liferay.model.VerificationType
		fetchVerificationType(long verificationTypeId) {

		return getService().fetchVerificationType(verificationTypeId);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.VerificationType
			getVerificationType(long verificationTypeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getVerificationType(verificationTypeId);
	}
	...
	public static java.util.List<com.adjecti.mdm.liferay.model.VerificationType>
		...
		return getService().getVerificationTypes(start, end);
	}
	 ...
	 */
	public static int getVerificationTypesCount() {
		return getService().getVerificationTypesCount();
	}
	...
	public static com.adjecti.mdm.liferay.model.VerificationType
		...
		return getService().updateVerificationType(verificationType);
	}

	public static VerificationTypeLocalService getService() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			VerificationTypeLocalService.class);
					...
					new ServiceTracker
						<VerificationTypeLocalService,
						 VerificationTypeLocalService>(
							 ...
							 VerificationTypeLocalService.class, null);
