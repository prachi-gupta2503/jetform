 ...
 * <code>com.adjecti.mdm.liferay.service.impl.PostLocalServiceImpl</code> and
...
public class PostLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.PostLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Post addPost(
		com.adjecti.mdm.liferay.model.Post post) {

		return getService().addPost(post);
	}

	public static com.adjecti.mdm.liferay.model.Post addPost(
			String code, String name_En, String name_Hi, long designationId,
			boolean postBox, String description)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().addPost(
			code, name_En, name_Hi, designationId, postBox, description);
	}
	 ...
	 * @return the new post
	 */
	public static com.adjecti.mdm.liferay.model.Post createPost(long postId) {
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Post deletePost(long postId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 * @return the post that was removed
	 */
	public static com.adjecti.mdm.liferay.model.Post deletePost(
		com.adjecti.mdm.liferay.model.Post post) {

		return getService().deletePost(post);
	}

	public static void deletePostById(long postId)
		throws com.liferay.portal.kernel.exception.PortalException {

		getService().deletePostById(postId);
	}
	...
	public static com.adjecti.mdm.liferay.model.Post fetchPost(long postId) {
	 ...
	 * @throws PortalException if a post with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.Post getPost(long postId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.adjecti.mdm.liferay.model.Post> getPosts(
		int start, int end) {
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Post updatePost(
		com.adjecti.mdm.liferay.model.Post post) {

		return getService().updatePost(post);
	}

	public static com.adjecti.mdm.liferay.model.Post updatePostData(
			long postId, String code, String name_En, String name_Hi,
			long designationId, boolean postBox, String description)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().updatePostData(
			postId, code, name_En, name_Hi, designationId, postBox,
			description);
	}
	...
	private static ServiceTracker<PostLocalService, PostLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PostLocalService.class);

		ServiceTracker<PostLocalService, PostLocalService> serviceTracker =
			new ServiceTracker<PostLocalService, PostLocalService>(
				bundle.getBundleContext(), PostLocalService.class, null);
