...
/**
 * Provides the local service utility for BenefitScheme. This utility wraps
 * <code>com.adjecti.mdm.liferay.service.impl.BenefitSchemeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BenefitSchemeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.BenefitSchemeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.BenefitScheme addBenefitScheme(
		com.adjecti.mdm.liferay.model.BenefitScheme benefitScheme) {

		return getService().addBenefitScheme(benefitScheme);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.BenefitScheme
		createBenefitScheme(long benefitSchemeId) {

		return getService().createBenefitScheme(benefitSchemeId);
	}
	...
	public static com.adjecti.mdm.liferay.model.BenefitScheme
		...
		return getService().deleteBenefitScheme(benefitScheme);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.BenefitScheme
			deleteBenefitScheme(long benefitSchemeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteBenefitScheme(benefitSchemeId);
	}
	...
	public static com.adjecti.mdm.liferay.model.BenefitScheme
		fetchBenefitScheme(long benefitSchemeId) {

		return getService().fetchBenefitScheme(benefitSchemeId);
	}
	 ...
	 * @throws PortalException if a benefit scheme with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.BenefitScheme getBenefitScheme(
			long benefitSchemeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getBenefitScheme(benefitSchemeId);
	}
	 ...
	 */
	public static java.util.List<com.adjecti.mdm.liferay.model.BenefitScheme>
		getBenefitSchemes(int start, int end) {

		return getService().getBenefitSchemes(start, end);
	}
	 ...
	 */
	public static int getBenefitSchemesCount() {
		return getService().getBenefitSchemesCount();
	}
	...
	public static com.adjecti.mdm.liferay.model.BenefitScheme
		...
		return getService().updateBenefitScheme(benefitScheme);
	}

	public static BenefitSchemeLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<BenefitSchemeLocalService, BenefitSchemeLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			BenefitSchemeLocalService.class);

		ServiceTracker<BenefitSchemeLocalService, BenefitSchemeLocalService>
			serviceTracker =
				new ServiceTracker
					<BenefitSchemeLocalService, BenefitSchemeLocalService>(
						bundle.getBundleContext(),
						BenefitSchemeLocalService.class, null);
