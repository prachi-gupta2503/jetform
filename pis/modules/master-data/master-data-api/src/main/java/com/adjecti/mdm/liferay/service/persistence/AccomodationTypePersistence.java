...
/**
 * The persistence interface for the accomodation type service.
 *
 * <p>
 ...
 * @see AccomodationTypeUtil
 * @generated
 */
@ProviderType
public interface AccomodationTypePersistence
	extends BasePersistence<AccomodationType> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccomodationTypeUtil} to access the accomodation type persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<AccomodationType> accomodationTypes);
	 ...
	 */
	public java.util.List<AccomodationType> findAll();
	 ...
	 */
	public java.util.List<AccomodationType> findAll(int start, int end);
	...
	public java.util.List<AccomodationType> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AccomodationType>
			orderByComparator);
