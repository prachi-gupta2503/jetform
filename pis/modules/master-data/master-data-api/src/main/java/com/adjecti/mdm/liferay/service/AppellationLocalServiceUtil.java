...
/**
 * Provides the local service utility for Appellation. This utility wraps
 * <code>com.adjecti.mdm.liferay.service.impl.AppellationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AppellationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.AppellationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Appellation addAppellation(
		com.adjecti.mdm.liferay.model.Appellation appellation) {

		return getService().addAppellation(appellation);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Appellation createAppellation(
		long appellationId) {

		return getService().createAppellation(appellationId);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Appellation deleteAppellation(
		com.adjecti.mdm.liferay.model.Appellation appellation) {

		return getService().deleteAppellation(appellation);
	}
	...
	public static com.adjecti.mdm.liferay.model.Appellation deleteAppellation(
		...
		return getService().deleteAppellation(appellationId);
	}
	...
	public static com.adjecti.mdm.liferay.model.Appellation fetchAppellation(
		long appellationId) {

		return getService().fetchAppellation(appellationId);
	}
	 ...
	 * @throws PortalException if a appellation with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.Appellation getAppellation(
			long appellationId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getAppellation(appellationId);
	}
	 ...
	 */
	public static java.util.List<com.adjecti.mdm.liferay.model.Appellation>
		getAppellations(int start, int end) {

		return getService().getAppellations(start, end);
	}
	 ...
	 */
	public static int getAppellationsCount() {
		return getService().getAppellationsCount();
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Appellation updateAppellation(
		com.adjecti.mdm.liferay.model.Appellation appellation) {

		return getService().updateAppellation(appellation);
	}

	public static AppellationLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<AppellationLocalService, AppellationLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AppellationLocalService.class);

		ServiceTracker<AppellationLocalService, AppellationLocalService>
			serviceTracker =
				new ServiceTracker
					<AppellationLocalService, AppellationLocalService>(
						bundle.getBundleContext(),
						AppellationLocalService.class, null);
