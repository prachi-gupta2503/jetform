 ...
 * <code>com.adjecti.mdm.liferay.service.impl.StateLocalServiceImpl</code> and
...
public class StateLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.StateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.State addState(
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.State createState(
		long stateId) {
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.State deleteState(long stateId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 * @return the state that was removed
	 */
	public static com.adjecti.mdm.liferay.model.State deleteState(
		com.adjecti.mdm.liferay.model.State state) {
	...
	public static com.adjecti.mdm.liferay.model.State fetchState(long stateId) {
	 ...
	 * @throws PortalException if a state with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.State getState(long stateId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getState(stateId);
	}

	public static java.util.List<com.adjecti.mdm.liferay.model.State>
		getStateList(long countryId) {

		return getService().getStateList(countryId);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.State updateState(
		com.adjecti.mdm.liferay.model.State state) {
	...
	private static ServiceTracker<StateLocalService, StateLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(StateLocalService.class);

		ServiceTracker<StateLocalService, StateLocalService> serviceTracker =
			new ServiceTracker<StateLocalService, StateLocalService>(
				bundle.getBundleContext(), StateLocalService.class, null);
