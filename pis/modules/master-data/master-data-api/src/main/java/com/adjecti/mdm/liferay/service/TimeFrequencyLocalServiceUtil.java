...
/**
 * Provides the local service utility for TimeFrequency. This utility wraps
 * <code>com.adjecti.mdm.liferay.service.impl.TimeFrequencyLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TimeFrequencyLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.TimeFrequencyLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.TimeFrequency addTimeFrequency(
		com.adjecti.mdm.liferay.model.TimeFrequency timeFrequency) {

		return getService().addTimeFrequency(timeFrequency);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.TimeFrequency
		createTimeFrequency(long timeFrequencyId) {

		return getService().createTimeFrequency(timeFrequencyId);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.TimeFrequency
			deleteTimeFrequency(long timeFrequencyId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteTimeFrequency(timeFrequencyId);
	}
	...
	public static com.adjecti.mdm.liferay.model.TimeFrequency
		...
		return getService().deleteTimeFrequency(timeFrequency);
	}
	...
	public static com.adjecti.mdm.liferay.model.TimeFrequency
		fetchTimeFrequency(long timeFrequencyId) {

		return getService().fetchTimeFrequency(timeFrequencyId);
	}
	 ...
	 */
	public static java.util.List<com.adjecti.mdm.liferay.model.TimeFrequency>
		getTimeFrequencies(int start, int end) {

		return getService().getTimeFrequencies(start, end);
	}
	 ...
	 */
	public static int getTimeFrequenciesCount() {
		return getService().getTimeFrequenciesCount();
	}
	 ...
	 * @throws PortalException if a time frequency with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.TimeFrequency getTimeFrequency(
			long timeFrequencyId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getTimeFrequency(timeFrequencyId);
	}
	...
	public static com.adjecti.mdm.liferay.model.TimeFrequency
		...
		return getService().updateTimeFrequency(timeFrequency);
	}

	public static TimeFrequencyLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<TimeFrequencyLocalService, TimeFrequencyLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			TimeFrequencyLocalService.class);

		ServiceTracker<TimeFrequencyLocalService, TimeFrequencyLocalService>
			serviceTracker =
				new ServiceTracker
					<TimeFrequencyLocalService, TimeFrequencyLocalService>(
						bundle.getBundleContext(),
						TimeFrequencyLocalService.class, null);
