 ...
 * <code>com.adjecti.mdm.liferay.service.impl.TradeLocalServiceImpl</code> and
...
public class TradeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.TradeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Trade addTrade(
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Trade createTrade(
		long tradeId) {
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Trade deleteTrade(long tradeId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 * @return the trade that was removed
	 */
	public static com.adjecti.mdm.liferay.model.Trade deleteTrade(
		com.adjecti.mdm.liferay.model.Trade trade) {
	...
	public static com.adjecti.mdm.liferay.model.Trade fetchTrade(long tradeId) {
	 ...
	 * @throws PortalException if a trade with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.Trade getTrade(long tradeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getTrade(tradeId);
	}

	public static com.adjecti.mdm.liferay.model.Trade getTradeByCode(
		String code) {

		return getService().getTradeByCode(code);
	}

	public static java.util.List<com.adjecti.mdm.liferay.model.Trade>
		getTradeByName(String tradeName) {

		return getService().getTradeByName(tradeName);
	}
	 ...
	 */
	public static java.util.List<com.adjecti.mdm.liferay.model.Trade> getTrades(
		int start, int end) {
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Trade updateTrade(
		com.adjecti.mdm.liferay.model.Trade trade) {
	...
	private static ServiceTracker<TradeLocalService, TradeLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TradeLocalService.class);

		ServiceTracker<TradeLocalService, TradeLocalService> serviceTracker =
			new ServiceTracker<TradeLocalService, TradeLocalService>(
				bundle.getBundleContext(), TradeLocalService.class, null);
