...
/**
 * Provides the local service utility for Occupation. This utility wraps
 * <code>com.adjecti.mdm.liferay.service.impl.OccupationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OccupationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.OccupationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Occupation addOccupation(
		com.adjecti.mdm.liferay.model.Occupation occupation) {

		return getService().addOccupation(occupation);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Occupation createOccupation(
		long occupationId) {

		return getService().createOccupation(occupationId);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Occupation deleteOccupation(
			long occupationId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteOccupation(occupationId);
	}
	...
	public static com.adjecti.mdm.liferay.model.Occupation deleteOccupation(
		...
		return getService().deleteOccupation(occupation);
	}
	...
	public static com.adjecti.mdm.liferay.model.Occupation fetchOccupation(
		long occupationId) {

		return getService().fetchOccupation(occupationId);
	}
	 ...
	 * @throws PortalException if a occupation with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.Occupation getOccupation(
			long occupationId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getOccupation(occupationId);
	}
	 ...
	 */
	public static java.util.List<com.adjecti.mdm.liferay.model.Occupation>
	 ...
	 */
	public static int getOccupationsCount() {
		return getService().getOccupationsCount();
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.Occupation updateOccupation(
		com.adjecti.mdm.liferay.model.Occupation occupation) {

		return getService().updateOccupation(occupation);
	}

	public static OccupationLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<OccupationLocalService, OccupationLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(OccupationLocalService.class);

		ServiceTracker<OccupationLocalService, OccupationLocalService>
			serviceTracker =
				new ServiceTracker
					<OccupationLocalService, OccupationLocalService>(
						bundle.getBundleContext(), OccupationLocalService.class,
						null);
