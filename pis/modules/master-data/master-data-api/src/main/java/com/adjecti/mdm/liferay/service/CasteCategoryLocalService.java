...
/**
 * Provides the local service interface for CasteCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CasteCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CasteCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.CasteCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the caste category local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CasteCategoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CasteCategory addCasteCategory(CasteCategory casteCategory);
	...
	public CasteCategory createCasteCategory(long casteCategoryId);
	...
	public CasteCategory deleteCasteCategory(CasteCategory casteCategory);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CasteCategory deleteCasteCategory(long casteCategoryId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CasteCategory fetchCasteCategory(long casteCategoryId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CasteCategory> getCastCategoryByName(String categoryName);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CasteCategory> getCasteCategories(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CasteCategory getCasteCategory(long casteCategoryId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CasteCategory updateCasteCategory(CasteCategory casteCategory);
