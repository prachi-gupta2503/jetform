...
/**
 * The base model interface for the MaritalStatus service. Represents a row in the &quot;mdm_MaritalStatus&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.adjecti.mdm.liferay.model.impl.MaritalStatusModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.adjecti.mdm.liferay.model.impl.MaritalStatusImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface MaritalStatusModel
	extends BaseModel<MaritalStatus>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a marital status model instance should use the {@link MaritalStatus} interface instead.
	 */
