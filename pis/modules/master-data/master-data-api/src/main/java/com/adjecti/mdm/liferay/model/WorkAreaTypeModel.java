...
/**
 * The base model interface for the WorkAreaType service. Represents a row in the &quot;mdm_WorkAreaType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.adjecti.mdm.liferay.model.impl.WorkAreaTypeModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.adjecti.mdm.liferay.model.impl.WorkAreaTypeImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface WorkAreaTypeModel
	extends BaseModel<WorkAreaType>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a work area type model instance should use the {@link WorkAreaType} interface instead.
	 */
