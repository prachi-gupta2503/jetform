...
/**
 * Provides the local service utility for PayStructure. This utility wraps
 * <code>com.adjecti.mdm.liferay.service.impl.PayStructureLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PayStructureLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.mdm.liferay.service.impl.PayStructureLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.PayStructure addPayStructure(
		com.adjecti.mdm.liferay.model.PayStructure payStructure) {

		return getService().addPayStructure(payStructure);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.PayStructure createPayStructure(
		long payStructureId) {

		return getService().createPayStructure(payStructureId);
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.PayStructure deletePayStructure(
			long payStructureId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deletePayStructure(payStructureId);
	}
	...
	public static com.adjecti.mdm.liferay.model.PayStructure deletePayStructure(
		...
		return getService().deletePayStructure(payStructure);
	}
	...
	public static com.adjecti.mdm.liferay.model.PayStructure fetchPayStructure(
		long payStructureId) {

		return getService().fetchPayStructure(payStructureId);
	}
	 ...
	 * @throws PortalException if a pay structure with the primary key could not be found
	 */
	public static com.adjecti.mdm.liferay.model.PayStructure getPayStructure(
			long payStructureId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getPayStructure(payStructureId);
	}
	 ...
	 */
	public static java.util.List<com.adjecti.mdm.liferay.model.PayStructure>
		getPayStructures(int start, int end) {

		return getService().getPayStructures(start, end);
	}
	 ...
	 */
	public static int getPayStructuresCount() {
		return getService().getPayStructuresCount();
	}
	 ...
	 */
	public static com.adjecti.mdm.liferay.model.PayStructure updatePayStructure(
		com.adjecti.mdm.liferay.model.PayStructure payStructure) {

		return getService().updatePayStructure(payStructure);
	}

	public static PayStructureLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<PayStructureLocalService, PayStructureLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PayStructureLocalService.class);

		ServiceTracker<PayStructureLocalService, PayStructureLocalService>
			serviceTracker =
				new ServiceTracker
					<PayStructureLocalService, PayStructureLocalService>(
						bundle.getBundleContext(),
						PayStructureLocalService.class, null);
