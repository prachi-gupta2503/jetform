...
/**
 * The persistence utility for the pay component service. This utility wraps <code>com.adjecti.mdm.liferay.service.persistence.impl.PayComponentPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PayComponentUtil {
	 ...
	 */
	public static Map<Serializable, PayComponent> fetchByPrimaryKeys(
	 ...
	 */
	public static PayComponent update(
		PayComponent payComponent, ServiceContext serviceContext) {
	 ...
	 */
	public static PayComponent create(long payComponentId) {
		return getPersistence().create(payComponentId);
	}
	 ...
	 */
	public static PayComponent remove(long payComponentId)
		throws com.adjecti.mdm.liferay.exception.NoSuchPayComponentException {

		return getPersistence().remove(payComponentId);
	}
	 ...
	 * @throws NoSuchPayComponentException if a pay component with the primary key could not be found
	 */
	public static PayComponent findByPrimaryKey(long payComponentId)
		throws com.adjecti.mdm.liferay.exception.NoSuchPayComponentException {

		return getPersistence().findByPrimaryKey(payComponentId);
	}
	 ...
	 */
	public static PayComponent fetchByPrimaryKey(long payComponentId) {
		return getPersistence().fetchByPrimaryKey(payComponentId);
	}
	...
	private static ServiceTracker
		<PayComponentPersistence, PayComponentPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PayComponentPersistence.class);

		ServiceTracker<PayComponentPersistence, PayComponentPersistence>
			serviceTracker =
				new ServiceTracker
