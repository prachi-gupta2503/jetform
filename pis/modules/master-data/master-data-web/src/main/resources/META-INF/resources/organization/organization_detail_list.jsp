...
<portlet:renderURL var="updateAddressRenderURL" windowState="<%=LiferayWindowState.POP_UP.toString()%>">
	...
	<portlet:param name="formClass" value="<%=MDMFormConstant.ADDRESSFROM%>" />
	<portlet:param name="classNameId" value="<%=classNameId%>"/>
	<portlet:param name="redirectPage" value="/organization/organization_detail_list.jsp" />
...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<liferay-util:param name="formClass" value="<%=MDMFormConstant.ORGANIZATIONFORM %>" />
...
Liferay.provide(
	...
	console.log($(actionSource).attr("data-key"));
	 ...
	 var dialogId='<portlet:namespace/>orgaizationOpenDialog';
		...
		var title ='Organization Address';
		var width = 640;
