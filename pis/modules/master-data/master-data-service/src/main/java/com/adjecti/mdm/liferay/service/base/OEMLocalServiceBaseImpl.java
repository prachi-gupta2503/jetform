...
import com.adjecti.mdm.liferay.service.OEMLocalService;
...
/**
 * Provides the base implementation for the oem local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OEMLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OEMLocalServiceImpl
 * @generated
 */
public abstract class OEMLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, OEMLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OEMLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OEMLocalServiceUtil</code>.
	 */
	...
	public OEM addOEM(OEM oem) {
		...
		return oemPersistence.update(oem);
	}
	...
	public OEM createOEM(long oemId) {
		return oemPersistence.create(oemId);
	}
	...
	@Override
	public OEM deleteOEM(long oemId) throws PortalException {
		return oemPersistence.remove(oemId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OEM deleteOEM(OEM oem) {
		return oemPersistence.remove(oem);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OEM.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return oemPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return oemPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return oemPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return oemPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return oemPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public OEM fetchOEM(long oemId) {
		return oemPersistence.fetchByPrimaryKey(oemId);
	}
	 ...
	 */
	@Override
	public OEM getOEM(long oemId) throws PortalException {
		return oemPersistence.findByPrimaryKey(oemId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(oemLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OEM.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("oemId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(oemLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OEM.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("oemId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return oemPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return oemLocalService.deleteOEM((OEM)persistedModel);
	}

	public BasePersistence<OEM> getBasePersistence() {
		return oemPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return oemPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OEM> getOEMs(int start, int end) {
		return oemPersistence.findAll(start, end);
	}
	...
	public int getOEMsCount() {
		return oemPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OEMLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		oemLocalService = (OEMLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OEMLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = oemPersistence.getDataSource();
	...
	protected OEMLocalService oemLocalService;
