...
import com.adjecti.mdm.liferay.service.PayHeadService;
...
/**
 * Provides the base implementation for the pay head remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayHeadServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayHeadServiceImpl
 * @generated
 */
public abstract class PayHeadServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PayHeadService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayHeadService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayHeadServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayHeadService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		payHeadService = (PayHeadService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayHeadService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PayHeadLocalService
		payHeadLocalService;
