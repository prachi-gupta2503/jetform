...
import com.adjecti.mdm.liferay.service.DocumentTypeService;
...
/**
 * Provides the base implementation for the document type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DocumentTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DocumentTypeServiceImpl
 * @generated
 */
public abstract class DocumentTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DocumentTypeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DocumentTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DocumentTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DocumentTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		documentTypeService = (DocumentTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.DocumentTypeLocalService
