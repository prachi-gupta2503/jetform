...
public class ExperienceCacheModel
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ExperienceCacheModel)) {
			return false;
		}

		ExperienceCacheModel experienceCacheModel =
			(ExperienceCacheModel)object;
	...
	public Experience toEntityModel() {
		...
		if (code == null) {
			experienceImpl.setCode("");
		}
		else {
			experienceImpl.setCode(code);
		}

		if (name == null) {
			experienceImpl.setName("");
		}
		else {
			experienceImpl.setName(name);
		}

		experienceImpl.setDeleted(deleted);
		experienceImpl.setStatus(status);
