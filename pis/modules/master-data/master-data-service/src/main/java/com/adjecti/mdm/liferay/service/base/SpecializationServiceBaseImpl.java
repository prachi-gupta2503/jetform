...
import com.adjecti.mdm.liferay.service.SpecializationService;
...
/**
 * Provides the base implementation for the specialization remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.SpecializationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.SpecializationServiceImpl
 * @generated
 */
public abstract class SpecializationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SpecializationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SpecializationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.SpecializationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SpecializationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		specializationService = (SpecializationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SpecializationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.SpecializationLocalService
