...
import com.adjecti.mdm.liferay.service.CadreLocalService;
...
/**
 * Provides the base implementation for the cadre local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.CadreLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.CadreLocalServiceImpl
 * @generated
 */
public abstract class CadreLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CadreLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CadreLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.CadreLocalServiceUtil</code>.
	 */
	...
	@Override
	public Cadre addCadre(Cadre cadre) {
		cadre.setNew(true);

		return cadrePersistence.update(cadre);
	}
	...
	public Cadre createCadre(long cadreId) {
		return cadrePersistence.create(cadreId);
	}
	...
	@Override
	public Cadre deleteCadre(long cadreId) throws PortalException {
		return cadrePersistence.remove(cadreId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Cadre deleteCadre(Cadre cadre) {
		return cadrePersistence.remove(cadre);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Cadre.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cadrePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cadrePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cadrePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cadrePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return cadrePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Cadre fetchCadre(long cadreId) {
		return cadrePersistence.fetchByPrimaryKey(cadreId);
	}
	 ...
	 */
	@Override
	public Cadre getCadre(long cadreId) throws PortalException {
		return cadrePersistence.findByPrimaryKey(cadreId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cadreLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Cadre.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("cadreId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(cadreLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Cadre.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("cadreId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return cadrePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return cadreLocalService.deleteCadre((Cadre)persistedModel);
	}

	public BasePersistence<Cadre> getBasePersistence() {
		return cadrePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return cadrePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Cadre> getCadres(int start, int end) {
		return cadrePersistence.findAll(start, end);
	}
	...
	public int getCadresCount() {
		return cadrePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Cadre updateCadre(Cadre cadre) {
		return cadrePersistence.update(cadre);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CadreLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		cadreLocalService = (CadreLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CadreLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cadrePersistence.getDataSource();
	...
	protected CadreLocalService cadreLocalService;
