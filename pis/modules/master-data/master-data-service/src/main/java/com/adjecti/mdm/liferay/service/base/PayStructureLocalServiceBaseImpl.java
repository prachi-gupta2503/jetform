...
import com.adjecti.mdm.liferay.service.PayStructureLocalService;
...
/**
 * Provides the base implementation for the pay structure local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayStructureLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayStructureLocalServiceImpl
 * @generated
 */
public abstract class PayStructureLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PayStructureLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayStructureLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayStructureLocalServiceUtil</code>.
	 */
	...
	public PayStructure addPayStructure(PayStructure payStructure) {
		...
		return payStructurePersistence.update(payStructure);
	}
	...
	public PayStructure createPayStructure(long payStructureId) {
		return payStructurePersistence.create(payStructureId);
	}
	...
	@Override
	public PayStructure deletePayStructure(long payStructureId)
		throws PortalException {

		return payStructurePersistence.remove(payStructureId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayStructure deletePayStructure(PayStructure payStructure) {
		return payStructurePersistence.remove(payStructure);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PayStructure.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return payStructurePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return payStructurePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return payStructurePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return payStructurePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PayStructure fetchPayStructure(long payStructureId) {
		return payStructurePersistence.fetchByPrimaryKey(payStructureId);
	}
	 ...
	 */
	@Override
	public PayStructure getPayStructure(long payStructureId)
		throws PortalException {

		return payStructurePersistence.findByPrimaryKey(payStructureId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(payStructureLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PayStructure.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("payStructureId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			payStructureLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PayStructure.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return payStructurePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return payStructureLocalService.deletePayStructure(
			(PayStructure)persistedModel);
	}

	public BasePersistence<PayStructure> getBasePersistence() {
		return payStructurePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return payStructurePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayStructure> getPayStructures(int start, int end) {
		return payStructurePersistence.findAll(start, end);
	}
	...
	public int getPayStructuresCount() {
		return payStructurePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayStructureLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		payStructureLocalService = (PayStructureLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayStructureLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = payStructurePersistence.getDataSource();
	...
	protected PayStructureLocalService payStructureLocalService;
