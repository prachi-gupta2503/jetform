...
import com.adjecti.mdm.liferay.service.PayLevelService;
...
/**
 * Provides the base implementation for the pay level remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayLevelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayLevelServiceImpl
 * @generated
 */
public abstract class PayLevelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PayLevelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayLevelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayLevelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayLevelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		payLevelService = (PayLevelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayLevelService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PayLevelLocalService
		payLevelLocalService;

	protected PayLevelService payLevelService;
