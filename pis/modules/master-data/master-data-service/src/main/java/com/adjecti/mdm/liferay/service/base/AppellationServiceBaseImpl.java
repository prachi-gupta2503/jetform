...
import com.adjecti.mdm.liferay.service.AppellationService;
...
/**
 * Provides the base implementation for the appellation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.AppellationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.AppellationServiceImpl
 * @generated
 */
public abstract class AppellationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppellationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppellationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.AppellationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppellationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		appellationService = (AppellationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppellationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.AppellationLocalService
