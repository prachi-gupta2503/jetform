...
import com.adjecti.mdm.liferay.service.PostOrganizationLocalService;
...
/**
 * Provides the base implementation for the post organization local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PostOrganizationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PostOrganizationLocalServiceImpl
 * @generated
 */
public abstract class PostOrganizationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostOrganizationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PostOrganizationLocalServiceUtil</code>.
	 */
	...
	public PostOrganization addPostOrganization(
		...
		return postOrganizationPersistence.update(postOrganization);
	}
	...
	public PostOrganization createPostOrganization(long postOrganizationId) {
		return postOrganizationPersistence.create(postOrganizationId);
	}
	...
	public PostOrganization deletePostOrganization(long postOrganizationId)
		...
		return postOrganizationPersistence.remove(postOrganizationId);
	}
	...
	public PostOrganization deletePostOrganization(
		...
		return postOrganizationPersistence.remove(postOrganization);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PostOrganization.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return postOrganizationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return postOrganizationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return postOrganizationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return postOrganizationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PostOrganization fetchPostOrganization(long postOrganizationId) {
		return postOrganizationPersistence.fetchByPrimaryKey(
			postOrganizationId);
	}
	...
	public PostOrganization getPostOrganization(long postOrganizationId)
		...
		return postOrganizationPersistence.findByPrimaryKey(postOrganizationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PostOrganization.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("postOrganizationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PostOrganization.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return postOrganizationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return postOrganizationLocalService.deletePostOrganization(
			(PostOrganization)persistedModel);
	}

	public BasePersistence<PostOrganization> getBasePersistence() {
		return postOrganizationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return postOrganizationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PostOrganization> getPostOrganizations(int start, int end) {
		return postOrganizationPersistence.findAll(start, end);
	}
	...
	public int getPostOrganizationsCount() {
		return postOrganizationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostOrganizationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		postOrganizationLocalService = (PostOrganizationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostOrganizationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = postOrganizationPersistence.getDataSource();
	...
	protected PostOrganizationLocalService postOrganizationLocalService;
