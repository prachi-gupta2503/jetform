...
import com.adjecti.mdm.liferay.service.AmountTypeService;
...
/**
 * Provides the base implementation for the amount type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.AmountTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.AmountTypeServiceImpl
 * @generated
 */
public abstract class AmountTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AmountTypeService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AmountTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.AmountTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AmountTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		amountTypeService = (AmountTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AmountTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.AmountTypeLocalService
		amountTypeLocalService;

	protected AmountTypeService amountTypeService;
