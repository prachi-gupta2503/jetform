...
import com.adjecti.mdm.liferay.service.OEMService;
...
/**
 * Provides the base implementation for the oem remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OEMServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OEMServiceImpl
 * @generated
 */
public abstract class OEMServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OEMService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OEMService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OEMServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {OEMService.class, IdentifiableOSGiService.class};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		oemService = (OEMService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OEMService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.OEMLocalService oemLocalService;
