...
import com.adjecti.mdm.liferay.service.PayHeadTypeService;
...
/**
 * Provides the base implementation for the pay head type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayHeadTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayHeadTypeServiceImpl
 * @generated
 */
public abstract class PayHeadTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PayHeadTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayHeadTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayHeadTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayHeadTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		payHeadTypeService = (PayHeadTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayHeadTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PayHeadTypeLocalService
		payHeadTypeLocalService;

	protected PayHeadTypeService payHeadTypeService;
