...
import com.adjecti.mdm.liferay.service.DesignationModeService;
...
/**
 * Provides the base implementation for the designation mode remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationModeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationModeServiceImpl
 * @generated
 */
public abstract class DesignationModeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DesignationModeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationModeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationModeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationModeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		designationModeService = (DesignationModeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationModeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.DesignationModeLocalService
		designationModeLocalService;

	protected DesignationModeService designationModeService;
