...
import com.adjecti.mdm.liferay.service.PostOrganizationService;
...
/**
 * Provides the base implementation for the post organization remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PostOrganizationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PostOrganizationServiceImpl
 * @generated
 */
public abstract class PostOrganizationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PostOrganizationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostOrganizationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PostOrganizationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostOrganizationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		postOrganizationService = (PostOrganizationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostOrganizationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PostOrganizationLocalService
		postOrganizationLocalService;

	protected PostOrganizationService postOrganizationService;
