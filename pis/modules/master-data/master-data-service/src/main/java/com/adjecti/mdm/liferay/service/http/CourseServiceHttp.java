...
public class CourseServiceHttp {
	...
	public static boolean dataIsAvailbleOrNot(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CourseServiceUtil.class, "dataIsAvailbleOrNot",
				_dataIsAvailbleOrNotParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, fieldName, fieldValue);
	...
	private static final Class<?>[] _dataIsAvailbleOrNotParameterTypes0 =
