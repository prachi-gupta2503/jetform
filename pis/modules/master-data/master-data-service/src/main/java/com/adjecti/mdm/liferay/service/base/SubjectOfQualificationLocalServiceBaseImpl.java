...
import com.adjecti.mdm.liferay.service.SubjectOfQualificationLocalService;
...
/**
 * Provides the base implementation for the subject of qualification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.SubjectOfQualificationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.SubjectOfQualificationLocalServiceImpl
 * @generated
 */
public abstract class SubjectOfQualificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   SubjectOfQualificationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SubjectOfQualificationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.SubjectOfQualificationLocalServiceUtil</code>.
	 */

	/**
	 * Adds the subject of qualification to the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SubjectOfQualificationLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param subjectOfQualification the subject of qualification
	 * @return the subject of qualification that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubjectOfQualification addSubjectOfQualification(
		SubjectOfQualification subjectOfQualification) {

		subjectOfQualification.setNew(true);

		return subjectOfQualificationPersistence.update(subjectOfQualification);
	}
	...
	public SubjectOfQualification createSubjectOfQualification(
		long subjectOfQualificationId) {

		return subjectOfQualificationPersistence.create(
			subjectOfQualificationId);
	}

	/**
	 * Deletes the subject of qualification with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SubjectOfQualificationLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 ...
	 * @throws PortalException if a subject of qualification with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SubjectOfQualification deleteSubjectOfQualification(
			long subjectOfQualificationId)
		throws PortalException {

		return subjectOfQualificationPersistence.remove(
			subjectOfQualificationId);
	}

	/**
	 * Deletes the subject of qualification from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SubjectOfQualificationLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	...
	public SubjectOfQualification deleteSubjectOfQualification(
		...
		return subjectOfQualificationPersistence.remove(subjectOfQualification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SubjectOfQualification.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return subjectOfQualificationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return subjectOfQualificationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SubjectOfQualification fetchSubjectOfQualification(
		long subjectOfQualificationId) {

		return subjectOfQualificationPersistence.fetchByPrimaryKey(
			subjectOfQualificationId);
	}

	/**
	 * Returns the subject of qualification with the primary key.
	 *
	 * @param subjectOfQualificationId the primary key of the subject of qualification
	 ...
	 */
	@Override
	public SubjectOfQualification getSubjectOfQualification(
			long subjectOfQualificationId)
		throws PortalException {

		return subjectOfQualificationPersistence.findByPrimaryKey(
			subjectOfQualificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SubjectOfQualification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return subjectOfQualificationLocalService.deleteSubjectOfQualification(
			(SubjectOfQualification)persistedModel);
	}

	public BasePersistence<SubjectOfQualification> getBasePersistence() {
		return subjectOfQualificationPersistence;
	}
	 ...
	 */
	@Override
	public List<SubjectOfQualification> getSubjectOfQualifications(
		int start, int end) {

		return subjectOfQualificationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSubjectOfQualificationsCount() {
		return subjectOfQualificationPersistence.countAll();
	}

	/**
	 * Updates the subject of qualification in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SubjectOfQualificationLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param subjectOfQualification the subject of qualification
	 * @return the subject of qualification that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubjectOfQualification updateSubjectOfQualification(
		SubjectOfQualification subjectOfQualification) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SubjectOfQualificationLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		subjectOfQualificationLocalService =
			(SubjectOfQualificationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SubjectOfQualificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				subjectOfQualificationPersistence.getDataSource();
	...
	protected SubjectOfQualificationLocalService
		subjectOfQualificationLocalService;
