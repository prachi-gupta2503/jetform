...
import com.adjecti.mdm.liferay.service.UnitTypeService;
...
/**
 * Provides the base implementation for the unit type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.UnitTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.UnitTypeServiceImpl
 * @generated
 */
public abstract class UnitTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, UnitTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UnitTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.UnitTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UnitTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		unitTypeService = (UnitTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UnitTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.UnitTypeLocalService
