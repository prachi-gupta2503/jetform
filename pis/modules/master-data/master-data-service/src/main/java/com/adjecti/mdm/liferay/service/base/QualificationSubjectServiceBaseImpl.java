...
import com.adjecti.mdm.liferay.service.QualificationSubjectService;
...
/**
 * Provides the base implementation for the qualification subject remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.QualificationSubjectServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.QualificationSubjectServiceImpl
 * @generated
 */
public abstract class QualificationSubjectServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QualificationSubjectService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualificationSubjectService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.QualificationSubjectServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualificationSubjectService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		qualificationSubjectService = (QualificationSubjectService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualificationSubjectService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.QualificationSubjectLocalService
		qualificationSubjectLocalService;

	protected QualificationSubjectService qualificationSubjectService;
