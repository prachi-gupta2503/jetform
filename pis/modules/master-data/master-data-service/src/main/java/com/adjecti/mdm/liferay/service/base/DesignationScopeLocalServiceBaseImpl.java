...
import com.adjecti.mdm.liferay.service.DesignationScopeLocalService;
...
/**
 * Provides the base implementation for the designation scope local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationScopeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationScopeLocalServiceImpl
 * @generated
 */
public abstract class DesignationScopeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DesignationScopeLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationScopeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationScopeLocalServiceUtil</code>.
	 */
	...
	@Override
	public DesignationScope addDesignationScope(
		DesignationScope designationScope) {

		designationScope.setNew(true);

		return designationScopePersistence.update(designationScope);
	}
	...
	public DesignationScope createDesignationScope(
		DesignationScopePK designationScopePK) {

		return designationScopePersistence.create(designationScopePK);
	}
	...
	@Override
	public DesignationScope deleteDesignationScope(
			DesignationScopePK designationScopePK)
		throws PortalException {

		return designationScopePersistence.remove(designationScopePK);
	}
	...
	public DesignationScope deleteDesignationScope(
		...
		return designationScopePersistence.remove(designationScope);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DesignationScope.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return designationScopePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return designationScopePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return designationScopePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return designationScopePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DesignationScope fetchDesignationScope(
		DesignationScopePK designationScopePK) {

		return designationScopePersistence.fetchByPrimaryKey(
			designationScopePK);
	}
	 ...
	 */
	@Override
	public DesignationScope getDesignationScope(
			DesignationScopePK designationScopePK)
		throws PortalException {

		return designationScopePersistence.findByPrimaryKey(designationScopePK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(DesignationScope.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.designationScopeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DesignationScope.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return designationScopePersistence.create(
			(DesignationScopePK)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return designationScopeLocalService.deleteDesignationScope(
			(DesignationScope)persistedModel);
	}

	public BasePersistence<DesignationScope> getBasePersistence() {
		return designationScopePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return designationScopePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DesignationScope> getDesignationScopes(int start, int end) {
		return designationScopePersistence.findAll(start, end);
	}
	...
	public int getDesignationScopesCount() {
		return designationScopePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DesignationScope updateDesignationScope(
		DesignationScope designationScope) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationScopeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		designationScopeLocalService = (DesignationScopeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationScopeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = designationScopePersistence.getDataSource();
	...
	protected DesignationScopeLocalService designationScopeLocalService;
