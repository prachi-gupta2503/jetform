...
import com.adjecti.mdm.liferay.service.CadreDesignationLocalService;
...
/**
 * Provides the base implementation for the cadre designation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.CadreDesignationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.CadreDesignationLocalServiceImpl
 * @generated
 */
public abstract class CadreDesignationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CadreDesignationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CadreDesignationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.CadreDesignationLocalServiceUtil</code>.
	 */
	...
	public CadreDesignation addCadreDesignation(
		...
		return cadreDesignationPersistence.update(cadreDesignation);
	}
	...
	public CadreDesignation createCadreDesignation(long cadreDesignationId) {
		return cadreDesignationPersistence.create(cadreDesignationId);
	}
	...
	public CadreDesignation deleteCadreDesignation(long cadreDesignationId)
		...
		return cadreDesignationPersistence.remove(cadreDesignationId);
	}
	...
	public CadreDesignation deleteCadreDesignation(
		...
		return cadreDesignationPersistence.remove(cadreDesignation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CadreDesignation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cadreDesignationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cadreDesignationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cadreDesignationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return cadreDesignationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CadreDesignation fetchCadreDesignation(long cadreDesignationId) {
		return cadreDesignationPersistence.fetchByPrimaryKey(
			cadreDesignationId);
	}
	...
	public CadreDesignation getCadreDesignation(long cadreDesignationId)
		...
		return cadreDesignationPersistence.findByPrimaryKey(cadreDesignationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(CadreDesignation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("cadreDesignationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(CadreDesignation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return cadreDesignationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return cadreDesignationLocalService.deleteCadreDesignation(
			(CadreDesignation)persistedModel);
	}

	public BasePersistence<CadreDesignation> getBasePersistence() {
		return cadreDesignationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return cadreDesignationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CadreDesignation> getCadreDesignations(int start, int end) {
		return cadreDesignationPersistence.findAll(start, end);
	}
	...
	public int getCadreDesignationsCount() {
		return cadreDesignationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CadreDesignationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		cadreDesignationLocalService = (CadreDesignationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CadreDesignationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cadreDesignationPersistence.getDataSource();
	...
	protected CadreDesignationLocalService cadreDesignationLocalService;
