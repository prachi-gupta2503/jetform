...
import com.adjecti.mdm.liferay.service.PostReportingService;
...
/**
 * Provides the base implementation for the post reporting remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PostReportingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PostReportingServiceImpl
 * @generated
 */
public abstract class PostReportingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PostReportingService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostReportingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PostReportingServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostReportingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		postReportingService = (PostReportingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostReportingService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PostReportingLocalService
		postReportingLocalService;

	protected PostReportingService postReportingService;
