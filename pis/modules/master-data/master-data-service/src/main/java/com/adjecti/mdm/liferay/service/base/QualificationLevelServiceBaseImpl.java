...
import com.adjecti.mdm.liferay.service.QualificationLevelService;
...
/**
 * Provides the base implementation for the qualification level remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.QualificationLevelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.QualificationLevelServiceImpl
 * @generated
 */
public abstract class QualificationLevelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QualificationLevelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualificationLevelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.QualificationLevelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualificationLevelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		qualificationLevelService = (QualificationLevelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualificationLevelService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.QualificationLevelLocalService
		qualificationLevelLocalService;

	protected QualificationLevelService qualificationLevelService;
