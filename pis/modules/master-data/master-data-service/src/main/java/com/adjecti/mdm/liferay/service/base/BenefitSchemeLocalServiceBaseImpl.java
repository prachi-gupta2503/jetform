...
import com.adjecti.mdm.liferay.service.BenefitSchemeLocalService;
...
/**
 * Provides the base implementation for the benefit scheme local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.BenefitSchemeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.BenefitSchemeLocalServiceImpl
 * @generated
 */
public abstract class BenefitSchemeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BenefitSchemeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BenefitSchemeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.BenefitSchemeLocalServiceUtil</code>.
	 */
	...
	@Override
	public BenefitScheme addBenefitScheme(BenefitScheme benefitScheme) {
		benefitScheme.setNew(true);

		return benefitSchemePersistence.update(benefitScheme);
	}
	...
	public BenefitScheme createBenefitScheme(long benefitSchemeId) {
		return benefitSchemePersistence.create(benefitSchemeId);
	}
	...
	@Override
	public BenefitScheme deleteBenefitScheme(long benefitSchemeId)
		throws PortalException {

		return benefitSchemePersistence.remove(benefitSchemeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BenefitScheme deleteBenefitScheme(BenefitScheme benefitScheme) {
		return benefitSchemePersistence.remove(benefitScheme);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BenefitScheme.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return benefitSchemePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return benefitSchemePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return benefitSchemePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return benefitSchemePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BenefitScheme fetchBenefitScheme(long benefitSchemeId) {
		return benefitSchemePersistence.fetchByPrimaryKey(benefitSchemeId);
	}
	 ...
	 */
	@Override
	public BenefitScheme getBenefitScheme(long benefitSchemeId)
		throws PortalException {

		return benefitSchemePersistence.findByPrimaryKey(benefitSchemeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(benefitSchemeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BenefitScheme.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("benefitSchemeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			benefitSchemeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BenefitScheme.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return benefitSchemePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return benefitSchemeLocalService.deleteBenefitScheme(
			(BenefitScheme)persistedModel);
	}

	public BasePersistence<BenefitScheme> getBasePersistence() {
		return benefitSchemePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return benefitSchemePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BenefitScheme> getBenefitSchemes(int start, int end) {
		return benefitSchemePersistence.findAll(start, end);
	}
	...
	public int getBenefitSchemesCount() {
		return benefitSchemePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BenefitScheme updateBenefitScheme(BenefitScheme benefitScheme) {
		return benefitSchemePersistence.update(benefitScheme);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BenefitSchemeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		benefitSchemeLocalService = (BenefitSchemeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BenefitSchemeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = benefitSchemePersistence.getDataSource();
	...
	protected BenefitSchemeLocalService benefitSchemeLocalService;
