...
import com.adjecti.mdm.liferay.service.EnumerationEntityService;
...
/**
 * Provides the base implementation for the enumeration entity remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.EnumerationEntityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.EnumerationEntityServiceImpl
 * @generated
 */
public abstract class EnumerationEntityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EnumerationEntityService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EnumerationEntityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.EnumerationEntityServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EnumerationEntityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		enumerationEntityService = (EnumerationEntityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EnumerationEntityService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.EnumerationEntityLocalService
		enumerationEntityLocalService;

	protected EnumerationEntityService enumerationEntityService;
