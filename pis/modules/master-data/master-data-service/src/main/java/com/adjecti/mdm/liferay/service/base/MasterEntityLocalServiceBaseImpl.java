...
import com.adjecti.mdm.liferay.service.MasterEntityLocalService;
...
/**
 * Provides the base implementation for the master entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.MasterEntityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.MasterEntityLocalServiceImpl
 * @generated
 */
public abstract class MasterEntityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MasterEntityLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterEntityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.MasterEntityLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterEntity addMasterEntity(MasterEntity masterEntity) {
		masterEntity.setNew(true);

		return masterEntityPersistence.update(masterEntity);
	}
	...
	public MasterEntity createMasterEntity(long masterEntityId) {
		return masterEntityPersistence.create(masterEntityId);
	}
	...
	@Override
	public MasterEntity deleteMasterEntity(long masterEntityId)
		throws PortalException {

		return masterEntityPersistence.remove(masterEntityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterEntity deleteMasterEntity(MasterEntity masterEntity) {
		return masterEntityPersistence.remove(masterEntity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterEntity.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterEntityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterEntityPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterEntityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterEntityPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterEntity fetchMasterEntity(long masterEntityId) {
		return masterEntityPersistence.fetchByPrimaryKey(masterEntityId);
	}
	 ...
	 */
	@Override
	public MasterEntity getMasterEntity(long masterEntityId)
		throws PortalException {

		return masterEntityPersistence.findByPrimaryKey(masterEntityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterEntityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterEntity.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("masterEntityId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			masterEntityLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterEntity.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterEntityPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterEntityLocalService.deleteMasterEntity(
			(MasterEntity)persistedModel);
	}

	public BasePersistence<MasterEntity> getBasePersistence() {
		return masterEntityPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterEntityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterEntity> getMasterEntities(int start, int end) {
		return masterEntityPersistence.findAll(start, end);
	}
	...
	public int getMasterEntitiesCount() {
		return masterEntityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterEntity updateMasterEntity(MasterEntity masterEntity) {
		return masterEntityPersistence.update(masterEntity);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterEntityLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterEntityLocalService = (MasterEntityLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterEntityLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return MasterEntity.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterEntityPersistence.getDataSource();
	...
	protected MasterEntityLocalService masterEntityLocalService;
