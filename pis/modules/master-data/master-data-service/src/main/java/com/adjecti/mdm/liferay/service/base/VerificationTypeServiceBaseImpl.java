...
import com.adjecti.mdm.liferay.service.VerificationTypeService;
...
/**
 * Provides the base implementation for the verification type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.VerificationTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.VerificationTypeServiceImpl
 * @generated
 */
public abstract class VerificationTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, VerificationTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VerificationTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.VerificationTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VerificationTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		verificationTypeService = (VerificationTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return VerificationTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.VerificationTypeLocalService
		verificationTypeLocalService;

	protected VerificationTypeService verificationTypeService;
