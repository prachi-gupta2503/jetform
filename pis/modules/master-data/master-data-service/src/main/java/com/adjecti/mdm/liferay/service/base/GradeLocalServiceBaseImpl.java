 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.GradeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.GradeLocalServiceImpl
 * @generated
 */
public abstract class GradeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, GradeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GradeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.GradeLocalServiceUtil</code>.
	 */
	...
	public Grade createGrade(long gradeId) {
		return gradePersistence.create(gradeId);
	}
	...
	@Override
	public Grade deleteGrade(long gradeId) throws PortalException {
		return gradePersistence.remove(gradeId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Grade.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return gradePersistence.findWithDynamicQuery(
	...
	@Override
	public Grade fetchGrade(long gradeId) {
		return gradePersistence.fetchByPrimaryKey(gradeId);
	}
	 ...
	 */
	@Override
	public Grade getGrade(long gradeId) throws PortalException {
		return gradePersistence.findByPrimaryKey(gradeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("gradeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("gradeId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return gradePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public BasePersistence<Grade> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GradeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		gradeLocalService = (GradeLocalService)aopProxy;
	}
