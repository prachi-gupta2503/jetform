...
import com.adjecti.mdm.liferay.service.JoiningModeService;
...
/**
 * Provides the base implementation for the joining mode remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.JoiningModeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.JoiningModeServiceImpl
 * @generated
 */
public abstract class JoiningModeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JoiningModeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JoiningModeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.JoiningModeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JoiningModeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		joiningModeService = (JoiningModeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JoiningModeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.JoiningModeLocalService
		joiningModeLocalService;

	protected JoiningModeService joiningModeService;
