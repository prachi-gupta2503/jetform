...
import com.adjecti.mdm.liferay.service.PersonalNoPrefixLocalService;
...
/**
 * Provides the base implementation for the personal no prefix local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PersonalNoPrefixLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PersonalNoPrefixLocalServiceImpl
 * @generated
 */
public abstract class PersonalNoPrefixLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersonalNoPrefixLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PersonalNoPrefixLocalServiceUtil</code>.
	 */
	...
	@Override
	public PersonalNoPrefix addPersonalNoPrefix(
		PersonalNoPrefix personalNoPrefix) {

		personalNoPrefix.setNew(true);

		return personalNoPrefixPersistence.update(personalNoPrefix);
	}
	...
	public PersonalNoPrefix createPersonalNoPrefix(long personalNoPrefixId) {
		return personalNoPrefixPersistence.create(personalNoPrefixId);
	}
	...
	@Override
	public PersonalNoPrefix deletePersonalNoPrefix(long personalNoPrefixId)
		throws PortalException {

		return personalNoPrefixPersistence.remove(personalNoPrefixId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PersonalNoPrefix deletePersonalNoPrefix(
		PersonalNoPrefix personalNoPrefix) {

		return personalNoPrefixPersistence.remove(personalNoPrefix);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PersonalNoPrefix.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return personalNoPrefixPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return personalNoPrefixPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return personalNoPrefixPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return personalNoPrefixPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PersonalNoPrefix fetchPersonalNoPrefix(long personalNoPrefixId) {
		return personalNoPrefixPersistence.fetchByPrimaryKey(
			personalNoPrefixId);
	}
	 ...
	 */
	@Override
	public PersonalNoPrefix getPersonalNoPrefix(long personalNoPrefixId)
		throws PortalException {

		return personalNoPrefixPersistence.findByPrimaryKey(personalNoPrefixId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PersonalNoPrefix.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("personalNoPrefixId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PersonalNoPrefix.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return personalNoPrefixPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return personalNoPrefixLocalService.deletePersonalNoPrefix(
			(PersonalNoPrefix)persistedModel);
	}

	public BasePersistence<PersonalNoPrefix> getBasePersistence() {
		return personalNoPrefixPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return personalNoPrefixPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PersonalNoPrefix> getPersonalNoPrefixes(int start, int end) {
		return personalNoPrefixPersistence.findAll(start, end);
	}
	...
	public int getPersonalNoPrefixesCount() {
		return personalNoPrefixPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PersonalNoPrefix updatePersonalNoPrefix(
		PersonalNoPrefix personalNoPrefix) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersonalNoPrefixLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		personalNoPrefixLocalService = (PersonalNoPrefixLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersonalNoPrefixLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = personalNoPrefixPersistence.getDataSource();
	...
	protected PersonalNoPrefixLocalService personalNoPrefixLocalService;
