...
import com.adjecti.mdm.liferay.service.DiseaseLocalService;
...
/**
 * Provides the base implementation for the disease local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DiseaseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DiseaseLocalServiceImpl
 * @generated
 */
public abstract class DiseaseLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DiseaseLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DiseaseLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DiseaseLocalServiceUtil</code>.
	 */
	...
	public Disease addDisease(Disease disease) {
		...
		return diseasePersistence.update(disease);
	}
	...
	public Disease createDisease(long diseaseId) {
		return diseasePersistence.create(diseaseId);
	}
	...
	@Override
	public Disease deleteDisease(long diseaseId) throws PortalException {
		return diseasePersistence.remove(diseaseId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Disease deleteDisease(Disease disease) {
		return diseasePersistence.remove(disease);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Disease.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return diseasePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return diseasePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return diseasePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return diseasePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Disease fetchDisease(long diseaseId) {
		return diseasePersistence.fetchByPrimaryKey(diseaseId);
	}
	 ...
	 */
	@Override
	public Disease getDisease(long diseaseId) throws PortalException {
		return diseasePersistence.findByPrimaryKey(diseaseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(diseaseLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Disease.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("diseaseId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Disease.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("diseaseId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return diseasePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return diseaseLocalService.deleteDisease((Disease)persistedModel);
	}

	public BasePersistence<Disease> getBasePersistence() {
		return diseasePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return diseasePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Disease> getDiseases(int start, int end) {
		return diseasePersistence.findAll(start, end);
	}
	...
	public int getDiseasesCount() {
		return diseasePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DiseaseLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		diseaseLocalService = (DiseaseLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DiseaseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = diseasePersistence.getDataSource();
	...
	protected DiseaseLocalService diseaseLocalService;
