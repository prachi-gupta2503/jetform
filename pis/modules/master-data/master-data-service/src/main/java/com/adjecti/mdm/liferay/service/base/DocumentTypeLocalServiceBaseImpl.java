...
/**
 * Provides the base implementation for the document type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DocumentTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DocumentTypeLocalServiceImpl
 * @generated
 */
public abstract class DocumentTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DocumentTypeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DocumentTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DocumentTypeLocalServiceUtil</code>.
	 */
	...
	public DocumentType addDocumentType(DocumentType documentType) {
		...
		return documentTypePersistence.update(documentType);
	}
	...
	public DocumentType createDocumentType(long documentTypeId) {
		return documentTypePersistence.create(documentTypeId);
	}
	...
	public DocumentType deleteDocumentType(long documentTypeId)
		...
		return documentTypePersistence.remove(documentTypeId);
	}
	...
	public DocumentType deleteDocumentType(DocumentType documentType) {
		return documentTypePersistence.remove(documentType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DocumentType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return documentTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return documentTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return documentTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return documentTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DocumentType fetchDocumentType(long documentTypeId) {
		return documentTypePersistence.fetchByPrimaryKey(documentTypeId);
	}
	...
	public DocumentType getDocumentType(long documentTypeId)
		...
		return documentTypePersistence.findByPrimaryKey(documentTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(documentTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DocumentType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("documentTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			documentTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DocumentType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return documentTypePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return documentTypeLocalService.deleteDocumentType(
			(DocumentType)persistedModel);
	}

	public BasePersistence<DocumentType> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return documentTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DocumentType> getDocumentTypes(int start, int end) {
		return documentTypePersistence.findAll(start, end);
	}
	...
	public int getDocumentTypesCount() {
		return documentTypePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DocumentTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		documentTypeLocalService = (DocumentTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = documentTypePersistence.getDataSource();
	...
	protected DocumentTypeLocalService documentTypeLocalService;
