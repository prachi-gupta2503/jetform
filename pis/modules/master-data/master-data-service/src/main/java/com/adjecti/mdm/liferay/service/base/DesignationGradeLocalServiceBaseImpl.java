...
import com.adjecti.mdm.liferay.service.DesignationGradeLocalService;
...
/**
 * Provides the base implementation for the designation grade local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationGradeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationGradeLocalServiceImpl
 * @generated
 */
public abstract class DesignationGradeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DesignationGradeLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationGradeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationGradeLocalServiceUtil</code>.
	 */
	...
	@Override
	public DesignationGrade addDesignationGrade(
		DesignationGrade designationGrade) {

		designationGrade.setNew(true);

		return designationGradePersistence.update(designationGrade);
	}
	...
	public DesignationGrade createDesignationGrade(long designationGradeId) {
		return designationGradePersistence.create(designationGradeId);
	}
	...
	@Override
	public DesignationGrade deleteDesignationGrade(long designationGradeId)
		throws PortalException {

		return designationGradePersistence.remove(designationGradeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DesignationGrade deleteDesignationGrade(
		DesignationGrade designationGrade) {

		return designationGradePersistence.remove(designationGrade);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DesignationGrade.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return designationGradePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return designationGradePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return designationGradePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return designationGradePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DesignationGrade fetchDesignationGrade(long designationGradeId) {
		return designationGradePersistence.fetchByPrimaryKey(
			designationGradeId);
	}
	 ...
	 */
	@Override
	public DesignationGrade getDesignationGrade(long designationGradeId)
		throws PortalException {

		return designationGradePersistence.findByPrimaryKey(designationGradeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(DesignationGrade.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("designationGradeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DesignationGrade.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return designationGradePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return designationGradeLocalService.deleteDesignationGrade(
			(DesignationGrade)persistedModel);
	}

	public BasePersistence<DesignationGrade> getBasePersistence() {
		return designationGradePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return designationGradePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DesignationGrade> getDesignationGrades(int start, int end) {
		return designationGradePersistence.findAll(start, end);
	}
	...
	public int getDesignationGradesCount() {
		return designationGradePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DesignationGrade updateDesignationGrade(
		DesignationGrade designationGrade) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationGradeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		designationGradeLocalService = (DesignationGradeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationGradeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = designationGradePersistence.getDataSource();
	...
	protected DesignationGradeLocalService designationGradeLocalService;
