...
/**
 * Provides the base implementation for the marital status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.MaritalStatusLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.MaritalStatusLocalServiceImpl
 * @generated
 */
public abstract class MaritalStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MaritalStatusLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MaritalStatusLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.MaritalStatusLocalServiceUtil</code>.
	 */
	...
	public MaritalStatus addMaritalStatus(MaritalStatus maritalStatus) {
		...
		return maritalStatusPersistence.update(maritalStatus);
	}
	...
	public MaritalStatus createMaritalStatus(long maritalStatusId) {
		return maritalStatusPersistence.create(maritalStatusId);
	}
	...
	@Override
	public MaritalStatus deleteMaritalStatus(long maritalStatusId)
		throws PortalException {

		return maritalStatusPersistence.remove(maritalStatusId);
	}
	...
	public MaritalStatus deleteMaritalStatus(MaritalStatus maritalStatus) {
		return maritalStatusPersistence.remove(maritalStatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MaritalStatus.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return maritalStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return maritalStatusPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return maritalStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return maritalStatusPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MaritalStatus fetchMaritalStatus(long maritalStatusId) {
		return maritalStatusPersistence.fetchByPrimaryKey(maritalStatusId);
	}
	 ...
	 */
	@Override
	public MaritalStatus getMaritalStatus(long maritalStatusId)
		throws PortalException {

		return maritalStatusPersistence.findByPrimaryKey(maritalStatusId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(maritalStatusLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MaritalStatus.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("maritalStatusId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			maritalStatusLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MaritalStatus.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return maritalStatusPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return maritalStatusLocalService.deleteMaritalStatus(
			(MaritalStatus)persistedModel);
	}

	public BasePersistence<MaritalStatus> getBasePersistence() {
		return maritalStatusPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return maritalStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MaritalStatus> getMaritalStatuses(int start, int end) {
		return maritalStatusPersistence.findAll(start, end);
	}
	...
	public int getMaritalStatusesCount() {
		return maritalStatusPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MaritalStatusLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		maritalStatusLocalService = (MaritalStatusLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MaritalStatusLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return MaritalStatus.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = maritalStatusPersistence.getDataSource();
	...
	protected MaritalStatusLocalService maritalStatusLocalService;
