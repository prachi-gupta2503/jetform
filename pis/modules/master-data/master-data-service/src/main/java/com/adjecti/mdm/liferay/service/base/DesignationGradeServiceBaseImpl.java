...
import com.adjecti.mdm.liferay.service.DesignationGradeService;
...
/**
 * Provides the base implementation for the designation grade remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationGradeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationGradeServiceImpl
 * @generated
 */
public abstract class DesignationGradeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DesignationGradeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationGradeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationGradeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationGradeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		designationGradeService = (DesignationGradeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationGradeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.DesignationGradeLocalService
		designationGradeLocalService;

	protected DesignationGradeService designationGradeService;
