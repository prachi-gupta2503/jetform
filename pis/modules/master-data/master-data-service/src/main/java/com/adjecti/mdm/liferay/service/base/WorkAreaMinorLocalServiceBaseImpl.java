...
import com.adjecti.mdm.liferay.service.WorkAreaMinorLocalService;
...
/**
 * Provides the base implementation for the work area minor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.WorkAreaMinorLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.WorkAreaMinorLocalServiceImpl
 * @generated
 */
public abstract class WorkAreaMinorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, WorkAreaMinorLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkAreaMinorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.WorkAreaMinorLocalServiceUtil</code>.
	 */
	...
	@Override
	public WorkAreaMinor addWorkAreaMinor(WorkAreaMinor workAreaMinor) {
		workAreaMinor.setNew(true);

		return workAreaMinorPersistence.update(workAreaMinor);
	}
	...
	public WorkAreaMinor createWorkAreaMinor(long workAreaMinorId) {
		return workAreaMinorPersistence.create(workAreaMinorId);
	}
	...
	@Override
	public WorkAreaMinor deleteWorkAreaMinor(long workAreaMinorId)
		throws PortalException {

		return workAreaMinorPersistence.remove(workAreaMinorId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public WorkAreaMinor deleteWorkAreaMinor(WorkAreaMinor workAreaMinor) {
		return workAreaMinorPersistence.remove(workAreaMinor);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WorkAreaMinor.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return workAreaMinorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return workAreaMinorPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return workAreaMinorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return workAreaMinorPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WorkAreaMinor fetchWorkAreaMinor(long workAreaMinorId) {
		return workAreaMinorPersistence.fetchByPrimaryKey(workAreaMinorId);
	}
	 ...
	 */
	@Override
	public WorkAreaMinor getWorkAreaMinor(long workAreaMinorId)
		throws PortalException {

		return workAreaMinorPersistence.findByPrimaryKey(workAreaMinorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(workAreaMinorLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WorkAreaMinor.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("workAreaMinorId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(WorkAreaMinor.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return workAreaMinorPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return workAreaMinorLocalService.deleteWorkAreaMinor(
			(WorkAreaMinor)persistedModel);
	}

	public BasePersistence<WorkAreaMinor> getBasePersistence() {
		return workAreaMinorPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return workAreaMinorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<WorkAreaMinor> getWorkAreaMinors(int start, int end) {
		return workAreaMinorPersistence.findAll(start, end);
	}
	...
	public int getWorkAreaMinorsCount() {
		return workAreaMinorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public WorkAreaMinor updateWorkAreaMinor(WorkAreaMinor workAreaMinor) {
		return workAreaMinorPersistence.update(workAreaMinor);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkAreaMinorLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		workAreaMinorLocalService = (WorkAreaMinorLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkAreaMinorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = workAreaMinorPersistence.getDataSource();
	...
	protected WorkAreaMinorLocalService workAreaMinorLocalService;
