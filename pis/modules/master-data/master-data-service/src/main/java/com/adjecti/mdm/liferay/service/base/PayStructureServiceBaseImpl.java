...
import com.adjecti.mdm.liferay.service.PayStructureService;
...
/**
 * Provides the base implementation for the pay structure remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayStructureServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayStructureServiceImpl
 * @generated
 */
public abstract class PayStructureServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PayStructureService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayStructureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayStructureServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayStructureService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		payStructureService = (PayStructureService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayStructureService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PayStructureLocalService
		payStructureLocalService;

	protected PayStructureService payStructureService;
