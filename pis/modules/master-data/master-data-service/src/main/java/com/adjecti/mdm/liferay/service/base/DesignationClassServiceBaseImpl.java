...
import com.adjecti.mdm.liferay.service.DesignationClassService;
...
/**
 * Provides the base implementation for the designation class remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationClassServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationClassServiceImpl
 * @generated
 */
public abstract class DesignationClassServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DesignationClassService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationClassService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationClassServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationClassService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		designationClassService = (DesignationClassService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationClassService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.DesignationClassLocalService
		designationClassLocalService;

	protected DesignationClassService designationClassService;
