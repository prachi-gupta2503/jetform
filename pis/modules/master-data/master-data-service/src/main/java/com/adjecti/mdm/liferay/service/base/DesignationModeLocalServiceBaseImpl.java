...
import com.adjecti.mdm.liferay.service.DesignationModeLocalService;
...
/**
 * Provides the base implementation for the designation mode local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationModeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationModeLocalServiceImpl
 * @generated
 */
public abstract class DesignationModeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DesignationModeLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationModeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationModeLocalServiceUtil</code>.
	 */
	...
	@Override
	public DesignationMode addDesignationMode(DesignationMode designationMode) {
		designationMode.setNew(true);

		return designationModePersistence.update(designationMode);
	}
	...
	public DesignationMode createDesignationMode(long designationModeId) {
		return designationModePersistence.create(designationModeId);
	}
	...
	@Override
	public DesignationMode deleteDesignationMode(long designationModeId)
		throws PortalException {

		return designationModePersistence.remove(designationModeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DesignationMode deleteDesignationMode(
		DesignationMode designationMode) {

		return designationModePersistence.remove(designationMode);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DesignationMode.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return designationModePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return designationModePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return designationModePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return designationModePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DesignationMode fetchDesignationMode(long designationModeId) {
		return designationModePersistence.fetchByPrimaryKey(designationModeId);
	}
	 ...
	 */
	@Override
	public DesignationMode getDesignationMode(long designationModeId)
		throws PortalException {

		return designationModePersistence.findByPrimaryKey(designationModeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(designationModeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DesignationMode.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("designationModeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			designationModeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DesignationMode.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return designationModePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return designationModeLocalService.deleteDesignationMode(
			(DesignationMode)persistedModel);
	}

	public BasePersistence<DesignationMode> getBasePersistence() {
		return designationModePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return designationModePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DesignationMode> getDesignationModes(int start, int end) {
		return designationModePersistence.findAll(start, end);
	}
	...
	public int getDesignationModesCount() {
		return designationModePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DesignationMode updateDesignationMode(
		DesignationMode designationMode) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationModeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		designationModeLocalService = (DesignationModeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationModeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = designationModePersistence.getDataSource();
	...
	protected DesignationModeLocalService designationModeLocalService;
