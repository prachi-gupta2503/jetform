...
import com.adjecti.mdm.liferay.service.AccomodationTypeLocalService;
...
/**
 * Provides the base implementation for the accomodation type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.AccomodationTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.AccomodationTypeLocalServiceImpl
 * @generated
 */
public abstract class AccomodationTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccomodationTypeLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccomodationTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.AccomodationTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public AccomodationType addAccomodationType(
		AccomodationType accomodationType) {

		accomodationType.setNew(true);

		return accomodationTypePersistence.update(accomodationType);
	}
	...
	public AccomodationType createAccomodationType(long accomodationTypeId) {
		return accomodationTypePersistence.create(accomodationTypeId);
	}
	...
	@Override
	public AccomodationType deleteAccomodationType(long accomodationTypeId)
		throws PortalException {

		return accomodationTypePersistence.remove(accomodationTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccomodationType deleteAccomodationType(
		AccomodationType accomodationType) {

		return accomodationTypePersistence.remove(accomodationType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccomodationType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accomodationTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return accomodationTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accomodationTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return accomodationTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AccomodationType fetchAccomodationType(long accomodationTypeId) {
		return accomodationTypePersistence.fetchByPrimaryKey(
			accomodationTypeId);
	}
	 ...
	 */
	@Override
	public AccomodationType getAccomodationType(long accomodationTypeId)
		throws PortalException {

		return accomodationTypePersistence.findByPrimaryKey(accomodationTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccomodationType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accomodationTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AccomodationType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return accomodationTypePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return accomodationTypeLocalService.deleteAccomodationType(
			(AccomodationType)persistedModel);
	}

	public BasePersistence<AccomodationType> getBasePersistence() {
		return accomodationTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return accomodationTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AccomodationType> getAccomodationTypes(int start, int end) {
		return accomodationTypePersistence.findAll(start, end);
	}
	...
	public int getAccomodationTypesCount() {
		return accomodationTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AccomodationType updateAccomodationType(
		AccomodationType accomodationType) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccomodationTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		accomodationTypeLocalService = (AccomodationTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccomodationTypeLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return AccomodationType.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accomodationTypePersistence.getDataSource();
	...
	protected AccomodationTypeLocalService accomodationTypeLocalService;
