...
import com.adjecti.mdm.liferay.service.DesignationClassLocalService;
...
/**
 * Provides the base implementation for the designation class local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationClassLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationClassLocalServiceImpl
 * @generated
 */
public abstract class DesignationClassLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DesignationClassLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationClassLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationClassLocalServiceUtil</code>.
	 */
	...
	@Override
	public DesignationClass addDesignationClass(
		DesignationClass designationClass) {

		designationClass.setNew(true);

		return designationClassPersistence.update(designationClass);
	}
	...
	public DesignationClass createDesignationClass(long designationClassId) {
		return designationClassPersistence.create(designationClassId);
	}
	...
	@Override
	public DesignationClass deleteDesignationClass(long designationClassId)
		throws PortalException {

		return designationClassPersistence.remove(designationClassId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DesignationClass deleteDesignationClass(
		DesignationClass designationClass) {

		return designationClassPersistence.remove(designationClass);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DesignationClass.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return designationClassPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return designationClassPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return designationClassPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return designationClassPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DesignationClass fetchDesignationClass(long designationClassId) {
		return designationClassPersistence.fetchByPrimaryKey(
			designationClassId);
	}
	 ...
	 */
	@Override
	public DesignationClass getDesignationClass(long designationClassId)
		throws PortalException {

		return designationClassPersistence.findByPrimaryKey(designationClassId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(DesignationClass.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("designationClassId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DesignationClass.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return designationClassPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return designationClassLocalService.deleteDesignationClass(
			(DesignationClass)persistedModel);
	}

	public BasePersistence<DesignationClass> getBasePersistence() {
		return designationClassPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return designationClassPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DesignationClass> getDesignationClasses(int start, int end) {
		return designationClassPersistence.findAll(start, end);
	}
	...
	public int getDesignationClassesCount() {
		return designationClassPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DesignationClass updateDesignationClass(
		DesignationClass designationClass) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationClassLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		designationClassLocalService = (DesignationClassLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationClassLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = designationClassPersistence.getDataSource();
	...
	protected DesignationClassLocalService designationClassLocalService;
