...
/**
 * Provides the base implementation for the blood group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.BloodGroupLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.BloodGroupLocalServiceImpl
 * @generated
 */
public abstract class BloodGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BloodGroupLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BloodGroupLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.BloodGroupLocalServiceUtil</code>.
	 */
	...
	public BloodGroup addBloodGroup(BloodGroup bloodGroup) {
		...
		return bloodGroupPersistence.update(bloodGroup);
	}
	...
	public BloodGroup createBloodGroup(long bloodGroupId) {
		return bloodGroupPersistence.create(bloodGroupId);
	}
	...
	@Override
	public BloodGroup deleteBloodGroup(long bloodGroupId)
		throws PortalException {

		return bloodGroupPersistence.remove(bloodGroupId);
	}
	...
	public BloodGroup deleteBloodGroup(BloodGroup bloodGroup) {
		return bloodGroupPersistence.remove(bloodGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BloodGroup.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return bloodGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return bloodGroupPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return bloodGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return bloodGroupPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BloodGroup fetchBloodGroup(long bloodGroupId) {
		return bloodGroupPersistence.fetchByPrimaryKey(bloodGroupId);
	}
	 ...
	 */
	@Override
	public BloodGroup getBloodGroup(long bloodGroupId) throws PortalException {
		return bloodGroupPersistence.findByPrimaryKey(bloodGroupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(bloodGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BloodGroup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("bloodGroupId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			bloodGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BloodGroup.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return bloodGroupPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return bloodGroupLocalService.deleteBloodGroup(
			(BloodGroup)persistedModel);
	}

	public BasePersistence<BloodGroup> getBasePersistence() {
		return bloodGroupPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return bloodGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BloodGroup> getBloodGroups(int start, int end) {
		return bloodGroupPersistence.findAll(start, end);
	}
	...
	public int getBloodGroupsCount() {
		return bloodGroupPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BloodGroupLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		bloodGroupLocalService = (BloodGroupLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BloodGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = bloodGroupPersistence.getDataSource();
	...
	protected BloodGroupLocalService bloodGroupLocalService;
