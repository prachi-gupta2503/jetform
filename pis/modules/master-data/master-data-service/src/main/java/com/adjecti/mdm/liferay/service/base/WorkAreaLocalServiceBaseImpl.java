...
import com.adjecti.mdm.liferay.service.WorkAreaLocalService;
...
/**
 * Provides the base implementation for the work area local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.WorkAreaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.WorkAreaLocalServiceImpl
 * @generated
 */
public abstract class WorkAreaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, WorkAreaLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkAreaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.WorkAreaLocalServiceUtil</code>.
	 */
	...
	@Override
	public WorkArea addWorkArea(WorkArea workArea) {
		workArea.setNew(true);

		return workAreaPersistence.update(workArea);
	}
	...
	public WorkArea createWorkArea(long workAreaId) {
		return workAreaPersistence.create(workAreaId);
	}
	...
	@Override
	public WorkArea deleteWorkArea(long workAreaId) throws PortalException {
		return workAreaPersistence.remove(workAreaId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public WorkArea deleteWorkArea(WorkArea workArea) {
		return workAreaPersistence.remove(workArea);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WorkArea.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return workAreaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return workAreaPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return workAreaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return workAreaPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WorkArea fetchWorkArea(long workAreaId) {
		return workAreaPersistence.fetchByPrimaryKey(workAreaId);
	}
	 ...
	 */
	@Override
	public WorkArea getWorkArea(long workAreaId) throws PortalException {
		return workAreaPersistence.findByPrimaryKey(workAreaId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(workAreaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WorkArea.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("workAreaId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			workAreaLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(WorkArea.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("workAreaId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return workAreaPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return workAreaLocalService.deleteWorkArea((WorkArea)persistedModel);
	}

	public BasePersistence<WorkArea> getBasePersistence() {
		return workAreaPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return workAreaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<WorkArea> getWorkAreas(int start, int end) {
		return workAreaPersistence.findAll(start, end);
	}
	...
	public int getWorkAreasCount() {
		return workAreaPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public WorkArea updateWorkArea(WorkArea workArea) {
		return workAreaPersistence.update(workArea);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkAreaLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		workAreaLocalService = (WorkAreaLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkAreaLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = workAreaPersistence.getDataSource();
	...
	protected WorkAreaLocalService workAreaLocalService;
