...
import com.adjecti.mdm.liferay.service.base.DistrictServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.adjecti.mdm.liferay.service.DistrictService</code> interface.
 *
 * <p>
...
public class DistrictServiceImpl extends DistrictServiceBaseImpl {
	...
	public List<District> getDistrictList(long stateId){
		return districtLocalService.getDistrictList(stateId);
	}
}