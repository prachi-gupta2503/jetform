...
import com.adjecti.mdm.liferay.service.PersonalNoPrefixService;
...
/**
 * Provides the base implementation for the personal no prefix remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PersonalNoPrefixServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PersonalNoPrefixServiceImpl
 * @generated
 */
public abstract class PersonalNoPrefixServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PersonalNoPrefixService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersonalNoPrefixService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PersonalNoPrefixServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersonalNoPrefixService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		personalNoPrefixService = (PersonalNoPrefixService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersonalNoPrefixService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PersonalNoPrefixLocalService
		personalNoPrefixLocalService;

	protected PersonalNoPrefixService personalNoPrefixService;
