...
import com.adjecti.mdm.liferay.service.SubjectOfTrainingLocalService;
...
/**
 * Provides the base implementation for the subject of training local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.SubjectOfTrainingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.SubjectOfTrainingLocalServiceImpl
 * @generated
 */
public abstract class SubjectOfTrainingLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SubjectOfTrainingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.SubjectOfTrainingLocalServiceUtil</code>.
	 */
	...
	@Override
	public SubjectOfTraining addSubjectOfTraining(
		SubjectOfTraining subjectOfTraining) {

		subjectOfTraining.setNew(true);

		return subjectOfTrainingPersistence.update(subjectOfTraining);
	}
	...
	public SubjectOfTraining createSubjectOfTraining(long subjectOfTrainingId) {
		return subjectOfTrainingPersistence.create(subjectOfTrainingId);
	}
	...
	@Override
	public SubjectOfTraining deleteSubjectOfTraining(long subjectOfTrainingId)
		throws PortalException {

		return subjectOfTrainingPersistence.remove(subjectOfTrainingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SubjectOfTraining deleteSubjectOfTraining(
		SubjectOfTraining subjectOfTraining) {

		return subjectOfTrainingPersistence.remove(subjectOfTraining);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SubjectOfTraining.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return subjectOfTrainingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return subjectOfTrainingPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return subjectOfTrainingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return subjectOfTrainingPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SubjectOfTraining fetchSubjectOfTraining(long subjectOfTrainingId) {
		return subjectOfTrainingPersistence.fetchByPrimaryKey(
			subjectOfTrainingId);
	}
	 ...
	 */
	@Override
	public SubjectOfTraining getSubjectOfTraining(long subjectOfTrainingId)
		throws PortalException {

		return subjectOfTrainingPersistence.findByPrimaryKey(
			subjectOfTrainingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SubjectOfTraining.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("subjectOfTrainingId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SubjectOfTraining.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return subjectOfTrainingPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return subjectOfTrainingLocalService.deleteSubjectOfTraining(
			(SubjectOfTraining)persistedModel);
	}

	public BasePersistence<SubjectOfTraining> getBasePersistence() {
		return subjectOfTrainingPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return subjectOfTrainingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SubjectOfTraining> getSubjectOfTrainings(int start, int end) {
		return subjectOfTrainingPersistence.findAll(start, end);
	}
	...
	public int getSubjectOfTrainingsCount() {
		return subjectOfTrainingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubjectOfTraining updateSubjectOfTraining(
		SubjectOfTraining subjectOfTraining) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SubjectOfTrainingLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		subjectOfTrainingLocalService = (SubjectOfTrainingLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SubjectOfTrainingLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return SubjectOfTraining.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				subjectOfTrainingPersistence.getDataSource();
	...
	protected SubjectOfTrainingLocalService subjectOfTrainingLocalService;
