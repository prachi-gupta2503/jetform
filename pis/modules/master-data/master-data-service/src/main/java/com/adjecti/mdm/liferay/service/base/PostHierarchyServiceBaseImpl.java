...
import com.adjecti.mdm.liferay.service.PostHierarchyService;
...
/**
 * Provides the base implementation for the post hierarchy remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PostHierarchyServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PostHierarchyServiceImpl
 * @generated
 */
public abstract class PostHierarchyServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PostHierarchyService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostHierarchyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PostHierarchyServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostHierarchyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		postHierarchyService = (PostHierarchyService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostHierarchyService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PostHierarchyLocalService
		postHierarchyLocalService;

	protected PostHierarchyService postHierarchyService;
