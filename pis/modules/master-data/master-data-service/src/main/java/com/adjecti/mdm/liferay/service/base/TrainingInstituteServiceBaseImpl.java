...
import com.adjecti.mdm.liferay.service.TrainingInstituteService;
...
/**
 * Provides the base implementation for the training institute remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TrainingInstituteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TrainingInstituteServiceImpl
 * @generated
 */
public abstract class TrainingInstituteServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TrainingInstituteService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingInstituteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TrainingInstituteServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TrainingInstituteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		trainingInstituteService = (TrainingInstituteService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingInstituteService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.TrainingInstituteLocalService
		trainingInstituteLocalService;

	protected TrainingInstituteService trainingInstituteService;
