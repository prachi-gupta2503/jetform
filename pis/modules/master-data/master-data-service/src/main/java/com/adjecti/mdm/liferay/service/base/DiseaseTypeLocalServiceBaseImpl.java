...
import com.adjecti.mdm.liferay.service.DiseaseTypeLocalService;
...
/**
 * Provides the base implementation for the disease type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DiseaseTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DiseaseTypeLocalServiceImpl
 * @generated
 */
public abstract class DiseaseTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DiseaseTypeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DiseaseTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DiseaseTypeLocalServiceUtil</code>.
	 */
	...
	public DiseaseType addDiseaseType(DiseaseType diseaseType) {
		...
		return diseaseTypePersistence.update(diseaseType);
	}
	...
	public DiseaseType createDiseaseType(long diseaseTypeId) {
		return diseaseTypePersistence.create(diseaseTypeId);
	}
	...
	@Override
	public DiseaseType deleteDiseaseType(long diseaseTypeId)
		throws PortalException {

		return diseaseTypePersistence.remove(diseaseTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DiseaseType deleteDiseaseType(DiseaseType diseaseType) {
		return diseaseTypePersistence.remove(diseaseType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DiseaseType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return diseaseTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return diseaseTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return diseaseTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return diseaseTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DiseaseType fetchDiseaseType(long diseaseTypeId) {
		return diseaseTypePersistence.fetchByPrimaryKey(diseaseTypeId);
	}
	 ...
	 */
	@Override
	public DiseaseType getDiseaseType(long diseaseTypeId)
		throws PortalException {

		return diseaseTypePersistence.findByPrimaryKey(diseaseTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(diseaseTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DiseaseType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("diseaseTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			diseaseTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DiseaseType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return diseaseTypePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return diseaseTypeLocalService.deleteDiseaseType(
			(DiseaseType)persistedModel);
	}

	public BasePersistence<DiseaseType> getBasePersistence() {
		return diseaseTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return diseaseTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DiseaseType> getDiseaseTypes(int start, int end) {
		return diseaseTypePersistence.findAll(start, end);
	}
	...
	public int getDiseaseTypesCount() {
		return diseaseTypePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DiseaseTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		diseaseTypeLocalService = (DiseaseTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DiseaseTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = diseaseTypePersistence.getDataSource();
	...
	protected DiseaseTypeLocalService diseaseTypeLocalService;
