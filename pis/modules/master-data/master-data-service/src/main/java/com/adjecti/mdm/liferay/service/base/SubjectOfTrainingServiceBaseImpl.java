...
import com.adjecti.mdm.liferay.service.SubjectOfTrainingService;
...
/**
 * Provides the base implementation for the subject of training remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.SubjectOfTrainingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.SubjectOfTrainingServiceImpl
 * @generated
 */
public abstract class SubjectOfTrainingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SubjectOfTrainingService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SubjectOfTrainingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.SubjectOfTrainingServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SubjectOfTrainingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		subjectOfTrainingService = (SubjectOfTrainingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SubjectOfTrainingService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.SubjectOfTrainingLocalService
		subjectOfTrainingLocalService;

	protected SubjectOfTrainingService subjectOfTrainingService;
