...
import com.adjecti.mdm.liferay.service.OrganizationDetailLocalService;
...
/**
 * Provides the base implementation for the organization detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OrganizationDetailLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OrganizationDetailLocalServiceImpl
 * @generated
 */
public abstract class OrganizationDetailLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrganizationDetailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OrganizationDetailLocalServiceUtil</code>.
	 */
	...
	public OrganizationDetail addOrganizationDetail(
		...
		return organizationDetailPersistence.update(organizationDetail);
	}
	...
	public OrganizationDetail createOrganizationDetail(
		...
		return organizationDetailPersistence.create(organizationDetailId);
	}
	...
	public OrganizationDetail deleteOrganizationDetail(
		...
		return organizationDetailPersistence.remove(organizationDetailId);
	}
	...
	public OrganizationDetail deleteOrganizationDetail(
		...
		return organizationDetailPersistence.remove(organizationDetail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OrganizationDetail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return organizationDetailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return organizationDetailPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return organizationDetailPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public OrganizationDetail fetchOrganizationDetail(
		...
		return organizationDetailPersistence.fetchByPrimaryKey(
	...
	public OrganizationDetail getOrganizationDetail(long organizationDetailId)
		...
		return organizationDetailPersistence.findByPrimaryKey(
			organizationDetailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OrganizationDetail.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(OrganizationDetail.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return organizationDetailPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return organizationDetailLocalService.deleteOrganizationDetail(
			(OrganizationDetail)persistedModel);
	}

	public BasePersistence<OrganizationDetail> getBasePersistence() {
		return organizationDetailPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return organizationDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OrganizationDetail> getOrganizationDetails(int start, int end) {
		return organizationDetailPersistence.findAll(start, end);
	}
	...
	public int getOrganizationDetailsCount() {
		return organizationDetailPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OrganizationDetailLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		organizationDetailLocalService =
			(OrganizationDetailLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrganizationDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				organizationDetailPersistence.getDataSource();
	...
	protected OrganizationDetailLocalService organizationDetailLocalService;
