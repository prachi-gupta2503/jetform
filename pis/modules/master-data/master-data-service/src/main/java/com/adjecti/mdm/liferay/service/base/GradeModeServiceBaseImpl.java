...
import com.adjecti.mdm.liferay.service.GradeModeService;
...
/**
 * Provides the base implementation for the grade mode remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.GradeModeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.GradeModeServiceImpl
 * @generated
 */
public abstract class GradeModeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GradeModeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GradeModeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.GradeModeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GradeModeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		gradeModeService = (GradeModeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GradeModeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.GradeModeLocalService
		gradeModeLocalService;

	protected GradeModeService gradeModeService;
