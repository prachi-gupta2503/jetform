...
import com.adjecti.mdm.liferay.model.impl.DocumentImpl;
import com.adjecti.mdm.liferay.model.impl.DocumentModelImpl;
...
public class DocumentPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new DocumentModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Document.class.getName()));
	...
	private static class DocumentModelArgumentsResolver
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						documentModelImpl.getColumnBitmask(columnName);
				}
