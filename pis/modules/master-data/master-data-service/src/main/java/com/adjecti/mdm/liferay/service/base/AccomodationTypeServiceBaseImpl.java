...
import com.adjecti.mdm.liferay.service.AccomodationTypeService;
...
/**
 * Provides the base implementation for the accomodation type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.AccomodationTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.AccomodationTypeServiceImpl
 * @generated
 */
public abstract class AccomodationTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AccomodationTypeService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccomodationTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.AccomodationTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccomodationTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accomodationTypeService = (AccomodationTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccomodationTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.AccomodationTypeLocalService
		accomodationTypeLocalService;

	protected AccomodationTypeService accomodationTypeService;
