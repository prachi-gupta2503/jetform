...
import com.adjecti.mdm.liferay.service.OrganizationHistoryService;
...
/**
 * Provides the base implementation for the organization history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OrganizationHistoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OrganizationHistoryServiceImpl
 * @generated
 */
public abstract class OrganizationHistoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OrganizationHistoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrganizationHistoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OrganizationHistoryServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OrganizationHistoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		organizationHistoryService = (OrganizationHistoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrganizationHistoryService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.OrganizationHistoryLocalService
		organizationHistoryLocalService;

	protected OrganizationHistoryService organizationHistoryService;
