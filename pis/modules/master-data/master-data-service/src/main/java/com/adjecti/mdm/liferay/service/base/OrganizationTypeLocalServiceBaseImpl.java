...
import com.adjecti.mdm.liferay.service.OrganizationTypeLocalService;
...
/**
 * Provides the base implementation for the organization type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OrganizationTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OrganizationTypeLocalServiceImpl
 * @generated
 */
public abstract class OrganizationTypeLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrganizationTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OrganizationTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public OrganizationType addOrganizationType(
		OrganizationType organizationType) {

		organizationType.setNew(true);

		return organizationTypePersistence.update(organizationType);
	}
	...
	public OrganizationType createOrganizationType(long organizationTypeId) {
		return organizationTypePersistence.create(organizationTypeId);
	}
	...
	@Override
	public OrganizationType deleteOrganizationType(long organizationTypeId)
		throws PortalException {

		return organizationTypePersistence.remove(organizationTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OrganizationType deleteOrganizationType(
		OrganizationType organizationType) {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OrganizationType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return organizationTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return organizationTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return organizationTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return organizationTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OrganizationType fetchOrganizationType(long organizationTypeId) {
		return organizationTypePersistence.fetchByPrimaryKey(
			organizationTypeId);
	}
	 ...
	 */
	@Override
	public OrganizationType getOrganizationType(long organizationTypeId)
		throws PortalException {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OrganizationType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("organizationTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(OrganizationType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return organizationTypePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return organizationTypeLocalService.deleteOrganizationType(
			(OrganizationType)persistedModel);
	}

	public BasePersistence<OrganizationType> getBasePersistence() {
		return organizationTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return organizationTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OrganizationType> getOrganizationTypes(int start, int end) {
		return organizationTypePersistence.findAll(start, end);
	}
	...
	public int getOrganizationTypesCount() {
		return organizationTypePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OrganizationTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		organizationTypeLocalService = (OrganizationTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrganizationTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = organizationTypePersistence.getDataSource();
	...
	protected OrganizationTypeLocalService organizationTypeLocalService;
