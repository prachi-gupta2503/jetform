...
import com.adjecti.mdm.liferay.service.WorkStationLocalService;
...
/**
 * Provides the base implementation for the work station local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.WorkStationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.WorkStationLocalServiceImpl
 * @generated
 */
public abstract class WorkStationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, WorkStationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkStationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.WorkStationLocalServiceUtil</code>.
	 */
	...
	public WorkStation addWorkStation(WorkStation workStation) {
		...
		return workStationPersistence.update(workStation);
	}
	...
	public WorkStation createWorkStation(long workStationId) {
		return workStationPersistence.create(workStationId);
	}
	...
	@Override
	public WorkStation deleteWorkStation(long workStationId)
		throws PortalException {

		return workStationPersistence.remove(workStationId);
	}
	...
	public WorkStation deleteWorkStation(WorkStation workStation) {
		return workStationPersistence.remove(workStation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WorkStation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return workStationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return workStationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return workStationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return workStationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WorkStation fetchWorkStation(long workStationId) {
		return workStationPersistence.fetchByPrimaryKey(workStationId);
	}
	...
	public WorkStation getWorkStation(long workStationId)
		...
		return workStationPersistence.findByPrimaryKey(workStationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(workStationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WorkStation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("workStationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(WorkStation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return workStationPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return workStationLocalService.deleteWorkStation(
			(WorkStation)persistedModel);
	}

	public BasePersistence<WorkStation> getBasePersistence() {
		return workStationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return workStationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<WorkStation> getWorkStations(int start, int end) {
		return workStationPersistence.findAll(start, end);
	}
	...
	public int getWorkStationsCount() {
		return workStationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkStationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		workStationLocalService = (WorkStationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkStationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = workStationPersistence.getDataSource();
	...
	protected WorkStationLocalService workStationLocalService;
