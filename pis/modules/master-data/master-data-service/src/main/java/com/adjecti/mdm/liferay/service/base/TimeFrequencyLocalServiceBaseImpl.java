...
import com.adjecti.mdm.liferay.service.TimeFrequencyLocalService;
...
/**
 * Provides the base implementation for the time frequency local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TimeFrequencyLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TimeFrequencyLocalServiceImpl
 * @generated
 */
public abstract class TimeFrequencyLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TimeFrequencyLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TimeFrequencyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TimeFrequencyLocalServiceUtil</code>.
	 */
	...
	@Override
	public TimeFrequency addTimeFrequency(TimeFrequency timeFrequency) {
		timeFrequency.setNew(true);

		return timeFrequencyPersistence.update(timeFrequency);
	}
	...
	public TimeFrequency createTimeFrequency(long timeFrequencyId) {
		return timeFrequencyPersistence.create(timeFrequencyId);
	}
	...
	@Override
	public TimeFrequency deleteTimeFrequency(long timeFrequencyId)
		throws PortalException {

		return timeFrequencyPersistence.remove(timeFrequencyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TimeFrequency deleteTimeFrequency(TimeFrequency timeFrequency) {
		return timeFrequencyPersistence.remove(timeFrequency);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TimeFrequency.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return timeFrequencyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return timeFrequencyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return timeFrequencyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return timeFrequencyPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TimeFrequency fetchTimeFrequency(long timeFrequencyId) {
		return timeFrequencyPersistence.fetchByPrimaryKey(timeFrequencyId);
	}
	 ...
	 */
	@Override
	public TimeFrequency getTimeFrequency(long timeFrequencyId)
		throws PortalException {

		return timeFrequencyPersistence.findByPrimaryKey(timeFrequencyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(timeFrequencyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TimeFrequency.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("timeFrequencyId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TimeFrequency.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return timeFrequencyPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return timeFrequencyLocalService.deleteTimeFrequency(
			(TimeFrequency)persistedModel);
	}

	public BasePersistence<TimeFrequency> getBasePersistence() {
		return timeFrequencyPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return timeFrequencyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TimeFrequency> getTimeFrequencies(int start, int end) {
		return timeFrequencyPersistence.findAll(start, end);
	}
	...
	public int getTimeFrequenciesCount() {
		return timeFrequencyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TimeFrequency updateTimeFrequency(TimeFrequency timeFrequency) {
		return timeFrequencyPersistence.update(timeFrequency);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TimeFrequencyLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		timeFrequencyLocalService = (TimeFrequencyLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TimeFrequencyLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return TimeFrequency.class;
	}

	protected String getModelClassName() {
		return TimeFrequency.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = timeFrequencyPersistence.getDataSource();
	...
	protected TimeFrequencyLocalService timeFrequencyLocalService;
