...
import com.adjecti.mdm.liferay.service.MaritalStatusService;
...
/**
 * Provides the base implementation for the marital status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.MaritalStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.MaritalStatusServiceImpl
 * @generated
 */
public abstract class MaritalStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MaritalStatusService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MaritalStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.MaritalStatusServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MaritalStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		maritalStatusService = (MaritalStatusService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MaritalStatusService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.MaritalStatusLocalService
