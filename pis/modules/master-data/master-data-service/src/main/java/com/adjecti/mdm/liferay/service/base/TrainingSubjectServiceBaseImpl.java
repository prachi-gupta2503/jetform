...
import com.adjecti.mdm.liferay.service.TrainingSubjectService;
...
/**
 * Provides the base implementation for the training subject remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TrainingSubjectServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TrainingSubjectServiceImpl
 * @generated
 */
public abstract class TrainingSubjectServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TrainingSubjectService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingSubjectService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TrainingSubjectServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TrainingSubjectService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		trainingSubjectService = (TrainingSubjectService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingSubjectService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.TrainingSubjectLocalService
		trainingSubjectLocalService;

	protected TrainingSubjectService trainingSubjectService;
