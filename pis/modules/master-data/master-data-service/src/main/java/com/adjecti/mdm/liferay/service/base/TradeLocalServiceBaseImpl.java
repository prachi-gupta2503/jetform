 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TradeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TradeLocalServiceImpl
 * @generated
 */
public abstract class TradeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TradeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TradeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TradeLocalServiceUtil</code>.
	 */
	...
	@Override
	public Trade deleteTrade(long tradeId) throws PortalException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Trade.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tradePersistence.findWithDynamicQuery(
	...
	@Override
	public Trade fetchTrade(long tradeId) {
	 ...
	 */
	@Override
	public Trade getTrade(long tradeId) throws PortalException {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(tradeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Trade.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("tradeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(tradeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Trade.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("tradeId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tradePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return tradeLocalService.deleteTrade((Trade)persistedModel);
	}

	public BasePersistence<Trade> getBasePersistence() {
	 ...
	 */
	@Override
	public List<Trade> getTrades(int start, int end) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TradeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tradeLocalService = (TradeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TradeLocalService.class.getName();
	}
	...
	protected TradeLocalService tradeLocalService;
