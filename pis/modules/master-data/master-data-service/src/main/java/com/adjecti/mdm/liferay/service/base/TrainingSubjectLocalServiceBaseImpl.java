...
import com.adjecti.mdm.liferay.service.TrainingSubjectLocalService;
...
/**
 * Provides the base implementation for the training subject local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TrainingSubjectLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TrainingSubjectLocalServiceImpl
 * @generated
 */
public abstract class TrainingSubjectLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingSubjectLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TrainingSubjectLocalServiceUtil</code>.
	 */
	...
	@Override
	public TrainingSubject addTrainingSubject(TrainingSubject trainingSubject) {
		trainingSubject.setNew(true);

		return trainingSubjectPersistence.update(trainingSubject);
	}
	...
	public TrainingSubject createTrainingSubject(long trainingSubjectId) {
		return trainingSubjectPersistence.create(trainingSubjectId);
	}
	...
	@Override
	public TrainingSubject deleteTrainingSubject(long trainingSubjectId)
		throws PortalException {

		return trainingSubjectPersistence.remove(trainingSubjectId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrainingSubject deleteTrainingSubject(
		TrainingSubject trainingSubject) {

		return trainingSubjectPersistence.remove(trainingSubject);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingSubject.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingSubjectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return trainingSubjectPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingSubjectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return trainingSubjectPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TrainingSubject fetchTrainingSubject(long trainingSubjectId) {
		return trainingSubjectPersistence.fetchByPrimaryKey(trainingSubjectId);
	}
	 ...
	 */
	@Override
	public TrainingSubject getTrainingSubject(long trainingSubjectId)
		throws PortalException {

		return trainingSubjectPersistence.findByPrimaryKey(trainingSubjectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(trainingSubjectLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TrainingSubject.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("trainingSubjectId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TrainingSubject.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingSubjectPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return trainingSubjectLocalService.deleteTrainingSubject(
			(TrainingSubject)persistedModel);
	}

	public BasePersistence<TrainingSubject> getBasePersistence() {
		return trainingSubjectPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingSubjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrainingSubject> getTrainingSubjects(int start, int end) {
		return trainingSubjectPersistence.findAll(start, end);
	}
	...
	public int getTrainingSubjectsCount() {
		return trainingSubjectPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrainingSubject updateTrainingSubject(
		TrainingSubject trainingSubject) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TrainingSubjectLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		trainingSubjectLocalService = (TrainingSubjectLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingSubjectLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return TrainingSubject.class;
	}

	protected String getModelClassName() {
		return TrainingSubject.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = trainingSubjectPersistence.getDataSource();
	...
	protected TrainingSubjectLocalService trainingSubjectLocalService;
