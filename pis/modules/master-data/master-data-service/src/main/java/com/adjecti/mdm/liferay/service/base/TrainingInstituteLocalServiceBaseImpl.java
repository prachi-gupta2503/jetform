...
import com.adjecti.mdm.liferay.service.TrainingInstituteLocalService;
...
/**
 * Provides the base implementation for the training institute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TrainingInstituteLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TrainingInstituteLocalServiceImpl
 * @generated
 */
public abstract class TrainingInstituteLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingInstituteLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TrainingInstituteLocalServiceUtil</code>.
	 */
	...
	@Override
	public TrainingInstitute addTrainingInstitute(
		TrainingInstitute trainingInstitute) {

		trainingInstitute.setNew(true);

		return trainingInstitutePersistence.update(trainingInstitute);
	}
	...
	public TrainingInstitute createTrainingInstitute(long trainingInstituteId) {
		return trainingInstitutePersistence.create(trainingInstituteId);
	}
	...
	@Override
	public TrainingInstitute deleteTrainingInstitute(long trainingInstituteId)
		throws PortalException {

		return trainingInstitutePersistence.remove(trainingInstituteId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrainingInstitute deleteTrainingInstitute(
		TrainingInstitute trainingInstitute) {

		return trainingInstitutePersistence.remove(trainingInstitute);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingInstitute.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingInstitutePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return trainingInstitutePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingInstitutePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return trainingInstitutePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TrainingInstitute fetchTrainingInstitute(long trainingInstituteId) {
		return trainingInstitutePersistence.fetchByPrimaryKey(
			trainingInstituteId);
	}
	 ...
	 */
	@Override
	public TrainingInstitute getTrainingInstitute(long trainingInstituteId)
		throws PortalException {

		return trainingInstitutePersistence.findByPrimaryKey(
			trainingInstituteId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TrainingInstitute.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("trainingInstituteId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TrainingInstitute.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingInstitutePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return trainingInstituteLocalService.deleteTrainingInstitute(
			(TrainingInstitute)persistedModel);
	}

	public BasePersistence<TrainingInstitute> getBasePersistence() {
		return trainingInstitutePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingInstitutePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrainingInstitute> getTrainingInstitutes(int start, int end) {
		return trainingInstitutePersistence.findAll(start, end);
	}
	...
	public int getTrainingInstitutesCount() {
		return trainingInstitutePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrainingInstitute updateTrainingInstitute(
		TrainingInstitute trainingInstitute) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TrainingInstituteLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		trainingInstituteLocalService = (TrainingInstituteLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingInstituteLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				trainingInstitutePersistence.getDataSource();
	...
	protected TrainingInstituteLocalService trainingInstituteLocalService;
