...
import com.adjecti.mdm.liferay.service.QualificationGradeLocalService;
...
/**
 * Provides the base implementation for the qualification grade local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.QualificationGradeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.QualificationGradeLocalServiceImpl
 * @generated
 */
public abstract class QualificationGradeLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualificationGradeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.QualificationGradeLocalServiceUtil</code>.
	 */
	...
	@Override
	public QualificationGrade addQualificationGrade(
		QualificationGrade qualificationGrade) {

		qualificationGrade.setNew(true);

		return qualificationGradePersistence.update(qualificationGrade);
	}
	...
	public QualificationGrade createQualificationGrade(
		long qualificationGradeId) {

		return qualificationGradePersistence.create(qualificationGradeId);
	}
	...
	@Override
	public QualificationGrade deleteQualificationGrade(
			long qualificationGradeId)
		throws PortalException {

		return qualificationGradePersistence.remove(qualificationGradeId);
	}
	...
	public QualificationGrade deleteQualificationGrade(
		...
		return qualificationGradePersistence.remove(qualificationGrade);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QualificationGrade.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return qualificationGradePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return qualificationGradePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return qualificationGradePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public QualificationGrade fetchQualificationGrade(
		long qualificationGradeId) {

		return qualificationGradePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public QualificationGrade getQualificationGrade(long qualificationGradeId)
		throws PortalException {

		return qualificationGradePersistence.findByPrimaryKey(
			qualificationGradeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(QualificationGrade.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(QualificationGrade.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return qualificationGradePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return qualificationGradeLocalService.deleteQualificationGrade(
			(QualificationGrade)persistedModel);
	}

	public BasePersistence<QualificationGrade> getBasePersistence() {
		return qualificationGradePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return qualificationGradePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QualificationGrade> getQualificationGrades(int start, int end) {
		return qualificationGradePersistence.findAll(start, end);
	}
	...
	public int getQualificationGradesCount() {
		return qualificationGradePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QualificationGrade updateQualificationGrade(
		QualificationGrade qualificationGrade) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualificationGradeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		qualificationGradeLocalService =
			(QualificationGradeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualificationGradeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				qualificationGradePersistence.getDataSource();
	...
	protected QualificationGradeLocalService qualificationGradeLocalService;
