...
import com.adjecti.mdm.liferay.service.EnumerationEntityLocalService;
...
/**
 * Provides the base implementation for the enumeration entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.EnumerationEntityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.EnumerationEntityLocalServiceImpl
 * @generated
 */
public abstract class EnumerationEntityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EnumerationEntityLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EnumerationEntityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.EnumerationEntityLocalServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EnumerationEntityLocalService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		enumerationEntityLocalService = (EnumerationEntityLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EnumerationEntityLocalService.class.getName();
	}
	...
	protected EnumerationEntityLocalService enumerationEntityLocalService;
