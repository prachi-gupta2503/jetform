...
import com.adjecti.mdm.liferay.service.CadreDesignationService;
...
/**
 * Provides the base implementation for the cadre designation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.CadreDesignationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.CadreDesignationServiceImpl
 * @generated
 */
public abstract class CadreDesignationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CadreDesignationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CadreDesignationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.CadreDesignationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CadreDesignationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cadreDesignationService = (CadreDesignationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CadreDesignationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.CadreDesignationLocalService
		cadreDesignationLocalService;

	protected CadreDesignationService cadreDesignationService;
