...
public class DistrictServiceHttp {
	...
	public static java.util.List<com.adjecti.mdm.liferay.model.District>
		getDistrictList(HttpPrincipal httpPrincipal, long stateId) {

		try {
			MethodKey methodKey = new MethodKey(
				DistrictServiceUtil.class, "getDistrictList",
				_getDistrictListParameterTypes0);
			...
			return (java.util.List<com.adjecti.mdm.liferay.model.District>)
				returnObj;
		}
	...
	private static final Class<?>[] _getDistrictListParameterTypes0 =
