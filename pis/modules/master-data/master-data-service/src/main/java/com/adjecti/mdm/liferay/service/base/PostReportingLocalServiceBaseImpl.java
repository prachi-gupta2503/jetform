...
/**
 * Provides the base implementation for the post reporting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PostReportingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PostReportingLocalServiceImpl
 * @generated
 */
public abstract class PostReportingLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PostReportingLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostReportingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PostReportingLocalServiceUtil</code>.
	 */
	...
	@Override
	public PostReporting addPostReporting(PostReporting postReporting) {
		postReporting.setNew(true);

		return postReportingPersistence.update(postReporting);
	}
	...
	public PostReporting createPostReporting(long postReportingId) {
		return postReportingPersistence.create(postReportingId);
	}
	...
	@Override
	public PostReporting deletePostReporting(long postReportingId)
		throws PortalException {

		return postReportingPersistence.remove(postReportingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PostReporting deletePostReporting(PostReporting postReporting) {
		return postReportingPersistence.remove(postReporting);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PostReporting.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return postReportingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return postReportingPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return postReportingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return postReportingPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PostReporting fetchPostReporting(long postReportingId) {
		return postReportingPersistence.fetchByPrimaryKey(postReportingId);
	}
	 ...
	 */
	@Override
	public PostReporting getPostReporting(long postReportingId)
		throws PortalException {

		return postReportingPersistence.findByPrimaryKey(postReportingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(postReportingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PostReporting.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("postReportingId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			postReportingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PostReporting.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return postReportingPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return postReportingLocalService.deletePostReporting(
			(PostReporting)persistedModel);
	}

	public BasePersistence<PostReporting> getBasePersistence() {
		return postReportingPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return postReportingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PostReporting> getPostReportings(int start, int end) {
		return postReportingPersistence.findAll(start, end);
	}
	...
	public int getPostReportingsCount() {
		return postReportingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PostReporting updatePostReporting(PostReporting postReporting) {
		return postReportingPersistence.update(postReporting);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostReportingLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		postReportingLocalService = (PostReportingLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostReportingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = postReportingPersistence.getDataSource();
	...
	protected PostReportingLocalService postReportingLocalService;
