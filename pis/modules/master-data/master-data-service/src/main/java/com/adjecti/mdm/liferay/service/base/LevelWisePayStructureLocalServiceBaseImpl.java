...
import com.adjecti.mdm.liferay.service.LevelWisePayStructureLocalService;
...
/**
 * Provides the base implementation for the level wise pay structure local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.LevelWisePayStructureLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.LevelWisePayStructureLocalServiceImpl
 * @generated
 */
public abstract class LevelWisePayStructureLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LevelWisePayStructureLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.LevelWisePayStructureLocalServiceUtil</code>.
	 */
	...
	@Override
	public LevelWisePayStructure addLevelWisePayStructure(
		LevelWisePayStructure levelWisePayStructure) {

		levelWisePayStructure.setNew(true);

		return levelWisePayStructurePersistence.update(levelWisePayStructure);
	}
	...
	public LevelWisePayStructure createLevelWisePayStructure(
		long levelWisePayStructureId) {

		return levelWisePayStructurePersistence.create(levelWisePayStructureId);
	}
	...
	@Override
	public LevelWisePayStructure deleteLevelWisePayStructure(
			long levelWisePayStructureId)
		throws PortalException {

		return levelWisePayStructurePersistence.remove(levelWisePayStructureId);
	}
	...
	public LevelWisePayStructure deleteLevelWisePayStructure(
		...
		return levelWisePayStructurePersistence.remove(levelWisePayStructure);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LevelWisePayStructure.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return levelWisePayStructurePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return levelWisePayStructurePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public LevelWisePayStructure fetchLevelWisePayStructure(
		long levelWisePayStructureId) {

		return levelWisePayStructurePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public LevelWisePayStructure getLevelWisePayStructure(
			long levelWisePayStructureId)
		throws PortalException {

		return levelWisePayStructurePersistence.findByPrimaryKey(
			levelWisePayStructureId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(LevelWisePayStructure.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return levelWisePayStructurePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return levelWisePayStructureLocalService.deleteLevelWisePayStructure(
			(LevelWisePayStructure)persistedModel);
	}

	public BasePersistence<LevelWisePayStructure> getBasePersistence() {
		return levelWisePayStructurePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return levelWisePayStructurePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LevelWisePayStructure> getLevelWisePayStructures(
		int start, int end) {

		return levelWisePayStructurePersistence.findAll(start, end);
	}
	...
	public int getLevelWisePayStructuresCount() {
		return levelWisePayStructurePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LevelWisePayStructure updateLevelWisePayStructure(
		LevelWisePayStructure levelWisePayStructure) {
	...
	public void setAopProxy(Object aopProxy) {
		levelWisePayStructureLocalService =
			(LevelWisePayStructureLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LevelWisePayStructureLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				levelWisePayStructurePersistence.getDataSource();
	...
	protected LevelWisePayStructureLocalService
		levelWisePayStructureLocalService;
