...
import com.adjecti.mdm.liferay.service.AmountTypeLocalService;
...
/**
 * Provides the base implementation for the amount type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.AmountTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.AmountTypeLocalServiceImpl
 * @generated
 */
public abstract class AmountTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AmountTypeLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AmountTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.AmountTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public AmountType addAmountType(AmountType amountType) {
		amountType.setNew(true);

		return amountTypePersistence.update(amountType);
	}
	...
	public AmountType createAmountType(long amountTypeId) {
		return amountTypePersistence.create(amountTypeId);
	}
	...
	@Override
	public AmountType deleteAmountType(long amountTypeId)
		throws PortalException {

		return amountTypePersistence.remove(amountTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AmountType deleteAmountType(AmountType amountType) {
		return amountTypePersistence.remove(amountType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AmountType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return amountTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return amountTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return amountTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return amountTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AmountType fetchAmountType(long amountTypeId) {
		return amountTypePersistence.fetchByPrimaryKey(amountTypeId);
	}
	 ...
	 */
	@Override
	public AmountType getAmountType(long amountTypeId) throws PortalException {
		return amountTypePersistence.findByPrimaryKey(amountTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(amountTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AmountType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("amountTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			amountTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AmountType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return amountTypePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return amountTypeLocalService.deleteAmountType(
			(AmountType)persistedModel);
	}

	public BasePersistence<AmountType> getBasePersistence() {
		return amountTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return amountTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AmountType> getAmountTypes(int start, int end) {
		return amountTypePersistence.findAll(start, end);
	}
	...
	public int getAmountTypesCount() {
		return amountTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AmountType updateAmountType(AmountType amountType) {
		return amountTypePersistence.update(amountType);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AmountTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		amountTypeLocalService = (AmountTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AmountTypeLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return AmountType.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = amountTypePersistence.getDataSource();
	...
	protected AmountTypeLocalService amountTypeLocalService;
