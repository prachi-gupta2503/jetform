...
import com.adjecti.mdm.liferay.service.PhTypeService;
...
/**
 * Provides the base implementation for the ph type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PhTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PhTypeServiceImpl
 * @generated
 */
public abstract class PhTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PhTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PhTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PhTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PhTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		phTypeService = (PhTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PhTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PhTypeLocalService
		phTypeLocalService;

	protected PhTypeService phTypeService;
