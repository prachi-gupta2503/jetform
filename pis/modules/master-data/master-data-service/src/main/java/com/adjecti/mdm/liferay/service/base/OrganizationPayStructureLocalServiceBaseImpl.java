...
import com.adjecti.mdm.liferay.service.OrganizationPayStructureLocalService;
...
/**
 * Provides the base implementation for the organization pay structure local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OrganizationPayStructureLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OrganizationPayStructureLocalServiceImpl
 * @generated
 */
public abstract class OrganizationPayStructureLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrganizationPayStructureLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OrganizationPayStructureLocalServiceUtil</code>.
	 */
	...
	@Override
	public OrganizationPayStructure addOrganizationPayStructure(
		OrganizationPayStructure organizationPayStructure) {

		organizationPayStructure.setNew(true);

		return organizationPayStructurePersistence.update(
	...
	public OrganizationPayStructure createOrganizationPayStructure(
		long organizationPayStructureId) {

		return organizationPayStructurePersistence.create(
	...
	@Override
	public OrganizationPayStructure deleteOrganizationPayStructure(
			long organizationPayStructureId)
		throws PortalException {

		return organizationPayStructurePersistence.remove(
			organizationPayStructureId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OrganizationPayStructure.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return organizationPayStructurePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return organizationPayStructurePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public OrganizationPayStructure fetchOrganizationPayStructure(
		long organizationPayStructureId) {

		return organizationPayStructurePersistence.fetchByPrimaryKey(
			organizationPayStructureId);
	}
	 ...
	 */
	@Override
	public OrganizationPayStructure getOrganizationPayStructure(
			long organizationPayStructureId)
		throws PortalException {

		return organizationPayStructurePersistence.findByPrimaryKey(
			organizationPayStructureId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OrganizationPayStructure.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			OrganizationPayStructure.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return organizationPayStructureLocalService.
			deleteOrganizationPayStructure(
				(OrganizationPayStructure)persistedModel);
	}

	public BasePersistence<OrganizationPayStructure> getBasePersistence() {
		return organizationPayStructurePersistence;
	}
	 ...
	 */
	@Override
	public List<OrganizationPayStructure> getOrganizationPayStructures(
		int start, int end) {

		return organizationPayStructurePersistence.findAll(start, end);
	}
	...
	public int getOrganizationPayStructuresCount() {
		return organizationPayStructurePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OrganizationPayStructure updateOrganizationPayStructure(
		OrganizationPayStructure organizationPayStructure) {
	...
	public void setAopProxy(Object aopProxy) {
		organizationPayStructureLocalService =
			(OrganizationPayStructureLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrganizationPayStructureLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return OrganizationPayStructure.class;
	}

	protected String getModelClassName() {
		return OrganizationPayStructure.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				organizationPayStructurePersistence.getDataSource();
	...
	protected OrganizationPayStructureLocalService
		organizationPayStructureLocalService;
