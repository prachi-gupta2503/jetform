...
import com.adjecti.mdm.liferay.service.PayComponentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayComponentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayComponentLocalServiceImpl
 * @generated
 */
public abstract class PayComponentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PayComponentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayComponentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayComponentLocalServiceUtil</code>.
	 */
	...
	public PayComponent createPayComponent(long payComponentId) {
		return payComponentPersistence.create(payComponentId);
	}
	...
	@Override
	public PayComponent deletePayComponent(long payComponentId)
		throws PortalException {

		return payComponentPersistence.remove(payComponentId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PayComponent.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return payComponentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return payComponentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PayComponent fetchPayComponent(long payComponentId) {
		return payComponentPersistence.fetchByPrimaryKey(payComponentId);
	}
	 ...
	 */
	@Override
	public PayComponent getPayComponent(long payComponentId)
		throws PortalException {

		return payComponentPersistence.findByPrimaryKey(payComponentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("payComponentId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return payComponentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return payComponentLocalService.deletePayComponent(
			(PayComponent)persistedModel);
	}

	public BasePersistence<PayComponent> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayComponentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		payComponentLocalService = (PayComponentLocalService)aopProxy;
	}
