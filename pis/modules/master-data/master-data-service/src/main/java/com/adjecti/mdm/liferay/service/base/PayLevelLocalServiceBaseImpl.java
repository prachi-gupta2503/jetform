...
/**
 * Provides the base implementation for the pay level local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayLevelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayLevelLocalServiceImpl
 * @generated
 */
public abstract class PayLevelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PayLevelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayLevelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayLevelLocalServiceUtil</code>.
	 */
	...
	@Override
	public PayLevel addPayLevel(PayLevel payLevel) {
		payLevel.setNew(true);

		return payLevelPersistence.update(payLevel);
	}
	...
	public PayLevel createPayLevel(long payLevelId) {
		return payLevelPersistence.create(payLevelId);
	}
	...
	@Override
	public PayLevel deletePayLevel(long payLevelId) throws PortalException {
		return payLevelPersistence.remove(payLevelId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayLevel deletePayLevel(PayLevel payLevel) {
		return payLevelPersistence.remove(payLevel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PayLevel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return payLevelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return payLevelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return payLevelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return payLevelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PayLevel fetchPayLevel(long payLevelId) {
		return payLevelPersistence.fetchByPrimaryKey(payLevelId);
	}
	 ...
	 */
	@Override
	public PayLevel getPayLevel(long payLevelId) throws PortalException {
		return payLevelPersistence.findByPrimaryKey(payLevelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(payLevelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PayLevel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("payLevelId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			payLevelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PayLevel.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("payLevelId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return payLevelPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return payLevelLocalService.deletePayLevel((PayLevel)persistedModel);
	}

	public BasePersistence<PayLevel> getBasePersistence() {
		return payLevelPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return payLevelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayLevel> getPayLevels(int start, int end) {
		return payLevelPersistence.findAll(start, end);
	}
	...
	public int getPayLevelsCount() {
		return payLevelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PayLevel updatePayLevel(PayLevel payLevel) {
		return payLevelPersistence.update(payLevel);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayLevelLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		payLevelLocalService = (PayLevelLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayLevelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = payLevelPersistence.getDataSource();
	...
	protected PayLevelLocalService payLevelLocalService;
