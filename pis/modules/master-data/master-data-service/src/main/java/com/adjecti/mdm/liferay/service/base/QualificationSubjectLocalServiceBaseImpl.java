...
import com.adjecti.mdm.liferay.service.QualificationSubjectLocalService;
...
/**
 * Provides the base implementation for the qualification subject local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.QualificationSubjectLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.QualificationSubjectLocalServiceImpl
 * @generated
 */
public abstract class QualificationSubjectLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualificationSubjectLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.QualificationSubjectLocalServiceUtil</code>.
	 */
	...
	@Override
	public QualificationSubject addQualificationSubject(
		QualificationSubject qualificationSubject) {

		qualificationSubject.setNew(true);

		return qualificationSubjectPersistence.update(qualificationSubject);
	}
	...
	public QualificationSubject createQualificationSubject(
		long qualificationSubjectId) {

		return qualificationSubjectPersistence.create(qualificationSubjectId);
	}
	...
	@Override
	public QualificationSubject deleteQualificationSubject(
			long qualificationSubjectId)
		throws PortalException {

		return qualificationSubjectPersistence.remove(qualificationSubjectId);
	}
	...
	public QualificationSubject deleteQualificationSubject(
		...
		return qualificationSubjectPersistence.remove(qualificationSubject);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QualificationSubject.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return qualificationSubjectPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return qualificationSubjectPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public QualificationSubject fetchQualificationSubject(
		long qualificationSubjectId) {

		return qualificationSubjectPersistence.fetchByPrimaryKey(
	...
	public QualificationSubject getQualificationSubject(
		...
		return qualificationSubjectPersistence.findByPrimaryKey(
			qualificationSubjectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(QualificationSubject.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return qualificationSubjectPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return qualificationSubjectLocalService.deleteQualificationSubject(
			(QualificationSubject)persistedModel);
	}

	public BasePersistence<QualificationSubject> getBasePersistence() {
		return qualificationSubjectPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return qualificationSubjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QualificationSubject> getQualificationSubjects(
		int start, int end) {

		return qualificationSubjectPersistence.findAll(start, end);
	}
	...
	public int getQualificationSubjectsCount() {
		return qualificationSubjectPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QualificationSubject updateQualificationSubject(
		QualificationSubject qualificationSubject) {
	...
	public void setAopProxy(Object aopProxy) {
		qualificationSubjectLocalService =
			(QualificationSubjectLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualificationSubjectLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				qualificationSubjectPersistence.getDataSource();
	...
	protected QualificationSubjectLocalService qualificationSubjectLocalService;
