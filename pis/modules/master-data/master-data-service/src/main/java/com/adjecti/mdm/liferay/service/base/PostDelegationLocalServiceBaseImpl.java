...
import com.adjecti.mdm.liferay.service.PostDelegationLocalService;
...
/**
 * Provides the base implementation for the post delegation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PostDelegationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PostDelegationLocalServiceImpl
 * @generated
 */
public abstract class PostDelegationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PostDelegationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostDelegationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PostDelegationLocalServiceUtil</code>.
	 */
	...
	@Override
	public PostDelegation addPostDelegation(PostDelegation postDelegation) {
		postDelegation.setNew(true);

		return postDelegationPersistence.update(postDelegation);
	}
	...
	public PostDelegation createPostDelegation(long postDelegationId) {
		return postDelegationPersistence.create(postDelegationId);
	}
	...
	@Override
	public PostDelegation deletePostDelegation(long postDelegationId)
		throws PortalException {

		return postDelegationPersistence.remove(postDelegationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PostDelegation deletePostDelegation(PostDelegation postDelegation) {
		return postDelegationPersistence.remove(postDelegation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PostDelegation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return postDelegationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return postDelegationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return postDelegationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return postDelegationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PostDelegation fetchPostDelegation(long postDelegationId) {
		return postDelegationPersistence.fetchByPrimaryKey(postDelegationId);
	}
	 ...
	 */
	@Override
	public PostDelegation getPostDelegation(long postDelegationId)
		throws PortalException {

		return postDelegationPersistence.findByPrimaryKey(postDelegationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(postDelegationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PostDelegation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("postDelegationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			postDelegationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PostDelegation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return postDelegationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return postDelegationLocalService.deletePostDelegation(
			(PostDelegation)persistedModel);
	}

	public BasePersistence<PostDelegation> getBasePersistence() {
		return postDelegationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return postDelegationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PostDelegation> getPostDelegations(int start, int end) {
		return postDelegationPersistence.findAll(start, end);
	}
	...
	public int getPostDelegationsCount() {
		return postDelegationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PostDelegation updatePostDelegation(PostDelegation postDelegation) {
		return postDelegationPersistence.update(postDelegation);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostDelegationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		postDelegationLocalService = (PostDelegationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostDelegationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = postDelegationPersistence.getDataSource();
	...
	protected PostDelegationLocalService postDelegationLocalService;
