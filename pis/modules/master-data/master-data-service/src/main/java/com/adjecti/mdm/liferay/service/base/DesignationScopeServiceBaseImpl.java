...
import com.adjecti.mdm.liferay.service.DesignationScopeService;
...
/**
 * Provides the base implementation for the designation scope remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationScopeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationScopeServiceImpl
 * @generated
 */
public abstract class DesignationScopeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DesignationScopeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationScopeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationScopeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationScopeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		designationScopeService = (DesignationScopeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationScopeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.DesignationScopeLocalService
		designationScopeLocalService;

	protected DesignationScopeService designationScopeService;
