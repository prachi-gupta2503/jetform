...
import com.adjecti.mdm.liferay.service.PostDelegationService;
...
/**
 * Provides the base implementation for the post delegation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PostDelegationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PostDelegationServiceImpl
 * @generated
 */
public abstract class PostDelegationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PostDelegationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostDelegationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PostDelegationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostDelegationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		postDelegationService = (PostDelegationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostDelegationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.PostDelegationLocalService
		postDelegationLocalService;

	protected PostDelegationService postDelegationService;
