...
import com.adjecti.mdm.liferay.service.OccupationServiceTypeService;
...
/**
 * Provides the base implementation for the occupation service type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OccupationServiceTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OccupationServiceTypeServiceImpl
 * @generated
 */
public abstract class OccupationServiceTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OccupationServiceTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OccupationServiceTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OccupationServiceTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OccupationServiceTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		occupationServiceTypeService = (OccupationServiceTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OccupationServiceTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.OccupationServiceTypeLocalService
		occupationServiceTypeLocalService;

	protected OccupationServiceTypeService occupationServiceTypeService;
