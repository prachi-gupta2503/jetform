...
import com.adjecti.mdm.liferay.service.OrganizationStationService;
...
/**
 * Provides the base implementation for the organization station remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OrganizationStationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OrganizationStationServiceImpl
 * @generated
 */
public abstract class OrganizationStationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OrganizationStationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrganizationStationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OrganizationStationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OrganizationStationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		organizationStationService = (OrganizationStationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrganizationStationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.OrganizationStationLocalService
		organizationStationLocalService;

	protected OrganizationStationService organizationStationService;
