...
import com.adjecti.mdm.liferay.service.FamilyRelationLocalService;
...
/**
 * Provides the base implementation for the family relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.FamilyRelationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.FamilyRelationLocalServiceImpl
 * @generated
 */
public abstract class FamilyRelationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FamilyRelationLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyRelationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.FamilyRelationLocalServiceUtil</code>.
	 */
	...
	public FamilyRelation addFamilyRelation(FamilyRelation familyRelation) {
		...
		return familyRelationPersistence.update(familyRelation);
	}
	...
	public FamilyRelation createFamilyRelation(long familyRelationId) {
		return familyRelationPersistence.create(familyRelationId);
	}
	...
	@Override
	public FamilyRelation deleteFamilyRelation(long familyRelationId)
		throws PortalException {

		return familyRelationPersistence.remove(familyRelationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FamilyRelation deleteFamilyRelation(FamilyRelation familyRelation) {
		return familyRelationPersistence.remove(familyRelation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FamilyRelation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return familyRelationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return familyRelationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return familyRelationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return familyRelationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FamilyRelation fetchFamilyRelation(long familyRelationId) {
		return familyRelationPersistence.fetchByPrimaryKey(familyRelationId);
	}
	 ...
	 */
	@Override
	public FamilyRelation getFamilyRelation(long familyRelationId)
		throws PortalException {

		return familyRelationPersistence.findByPrimaryKey(familyRelationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(familyRelationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FamilyRelation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("familyRelationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			familyRelationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FamilyRelation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return familyRelationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return familyRelationLocalService.deleteFamilyRelation(
			(FamilyRelation)persistedModel);
	}

	public BasePersistence<FamilyRelation> getBasePersistence() {
		return familyRelationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return familyRelationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FamilyRelation> getFamilyRelations(int start, int end) {
		return familyRelationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFamilyRelationsCount() {
		return familyRelationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyRelationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		familyRelationLocalService = (FamilyRelationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyRelationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = familyRelationPersistence.getDataSource();
	...
	protected FamilyRelationLocalService familyRelationLocalService;
