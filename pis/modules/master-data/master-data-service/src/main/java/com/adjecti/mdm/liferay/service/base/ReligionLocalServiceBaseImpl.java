...
/**
 * Provides the base implementation for the religion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.ReligionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.ReligionLocalServiceImpl
 * @generated
 */
public abstract class ReligionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ReligionLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReligionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.ReligionLocalServiceUtil</code>.
	 */
	...
	public Religion addReligion(Religion religion) {
		...
		return religionPersistence.update(religion);
	}
	...
	@Override
	public Religion deleteReligion(long religionId) throws PortalException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Religion deleteReligion(Religion religion) {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Religion.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return religionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return religionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Religion fetchReligion(long religionId) {
	 ...
	 */
	@Override
	public Religion getReligion(long religionId) throws PortalException {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(religionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Religion.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("religionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Religion.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("religionId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return religionPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return religionLocalService.deleteReligion((Religion)persistedModel);
	}

	public BasePersistence<Religion> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReligionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		religionLocalService = (ReligionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReligionLocalService.class.getName();
	}
