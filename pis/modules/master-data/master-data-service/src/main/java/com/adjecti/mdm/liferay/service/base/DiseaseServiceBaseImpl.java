...
import com.adjecti.mdm.liferay.service.DiseaseService;
...
/**
 * Provides the base implementation for the disease remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DiseaseServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DiseaseServiceImpl
 * @generated
 */
public abstract class DiseaseServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DiseaseService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DiseaseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DiseaseServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DiseaseService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		diseaseService = (DiseaseService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DiseaseService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.DiseaseLocalService
		diseaseLocalService;
