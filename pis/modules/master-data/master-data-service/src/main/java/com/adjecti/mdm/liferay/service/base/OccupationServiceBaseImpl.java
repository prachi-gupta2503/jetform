...
import com.adjecti.mdm.liferay.service.OccupationService;
...
/**
 * Provides the base implementation for the occupation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OccupationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OccupationServiceImpl
 * @generated
 */
public abstract class OccupationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OccupationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OccupationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OccupationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OccupationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		occupationService = (OccupationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OccupationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.OccupationLocalService
