...
import com.adjecti.mdm.liferay.service.PayHeadLocalService;
...
/**
 * Provides the base implementation for the pay head local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayHeadLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayHeadLocalServiceImpl
 * @generated
 */
public abstract class PayHeadLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PayHeadLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayHeadLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayHeadLocalServiceUtil</code>.
	 */
	...
	public PayHead addPayHead(PayHead payHead) {
		...
		return payHeadPersistence.update(payHead);
	}
	...
	public PayHead createPayHead(long payHeadId) {
		return payHeadPersistence.create(payHeadId);
	}
	...
	@Override
	public PayHead deletePayHead(long payHeadId) throws PortalException {
		return payHeadPersistence.remove(payHeadId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayHead deletePayHead(PayHead payHead) {
		return payHeadPersistence.remove(payHead);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PayHead.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return payHeadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return payHeadPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return payHeadPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return payHeadPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PayHead fetchPayHead(long payHeadId) {
		return payHeadPersistence.fetchByPrimaryKey(payHeadId);
	}
	 ...
	 */
	@Override
	public PayHead getPayHead(long payHeadId) throws PortalException {
		return payHeadPersistence.findByPrimaryKey(payHeadId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(payHeadLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PayHead.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("payHeadId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PayHead.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("payHeadId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return payHeadPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return payHeadLocalService.deletePayHead((PayHead)persistedModel);
	}

	public BasePersistence<PayHead> getBasePersistence() {
		return payHeadPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return payHeadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayHead> getPayHeads(int start, int end) {
		return payHeadPersistence.findAll(start, end);
	}
	...
	public int getPayHeadsCount() {
		return payHeadPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PayHead updatePayHead(PayHead payHead) {
		return payHeadPersistence.update(payHead);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayHeadLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		payHeadLocalService = (PayHeadLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayHeadLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = payHeadPersistence.getDataSource();
	...
	protected PayHeadLocalService payHeadLocalService;
