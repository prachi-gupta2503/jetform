...
import com.adjecti.mdm.liferay.service.WorkAreaService;
...
/**
 * Provides the base implementation for the work area remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.WorkAreaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.WorkAreaServiceImpl
 * @generated
 */
public abstract class WorkAreaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WorkAreaService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkAreaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.WorkAreaServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkAreaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		workAreaService = (WorkAreaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkAreaService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.WorkAreaLocalService
		workAreaLocalService;

	protected WorkAreaService workAreaService;
