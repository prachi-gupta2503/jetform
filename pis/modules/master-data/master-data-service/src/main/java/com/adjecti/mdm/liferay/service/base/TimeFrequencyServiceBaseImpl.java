...
import com.adjecti.mdm.liferay.service.TimeFrequencyService;
...
/**
 * Provides the base implementation for the time frequency remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TimeFrequencyServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TimeFrequencyServiceImpl
 * @generated
 */
public abstract class TimeFrequencyServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TimeFrequencyService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TimeFrequencyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TimeFrequencyServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TimeFrequencyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		timeFrequencyService = (TimeFrequencyService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TimeFrequencyService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.TimeFrequencyLocalService
		timeFrequencyLocalService;

	protected TimeFrequencyService timeFrequencyService;
