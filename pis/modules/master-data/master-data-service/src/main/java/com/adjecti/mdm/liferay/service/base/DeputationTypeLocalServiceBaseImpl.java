...
import com.adjecti.mdm.liferay.service.DeputationTypeLocalService;
...
/**
 * Provides the base implementation for the deputation type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DeputationTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DeputationTypeLocalServiceImpl
 * @generated
 */
public abstract class DeputationTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DeputationTypeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DeputationTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DeputationTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public DeputationType addDeputationType(DeputationType deputationType) {
		deputationType.setNew(true);

		return deputationTypePersistence.update(deputationType);
	}
	...
	public DeputationType createDeputationType(long deputationTypeId) {
		return deputationTypePersistence.create(deputationTypeId);
	}
	...
	@Override
	public DeputationType deleteDeputationType(long deputationTypeId)
		throws PortalException {

		return deputationTypePersistence.remove(deputationTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DeputationType deleteDeputationType(DeputationType deputationType) {
		return deputationTypePersistence.remove(deputationType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DeputationType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return deputationTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return deputationTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return deputationTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return deputationTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DeputationType fetchDeputationType(long deputationTypeId) {
		return deputationTypePersistence.fetchByPrimaryKey(deputationTypeId);
	}
	 ...
	 */
	@Override
	public DeputationType getDeputationType(long deputationTypeId)
		throws PortalException {

		return deputationTypePersistence.findByPrimaryKey(deputationTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(deputationTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DeputationType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("deputationTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			deputationTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DeputationType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return deputationTypePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return deputationTypeLocalService.deleteDeputationType(
			(DeputationType)persistedModel);
	}

	public BasePersistence<DeputationType> getBasePersistence() {
		return deputationTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return deputationTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DeputationType> getDeputationTypes(int start, int end) {
		return deputationTypePersistence.findAll(start, end);
	}
	...
	public int getDeputationTypesCount() {
		return deputationTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DeputationType updateDeputationType(DeputationType deputationType) {
		return deputationTypePersistence.update(deputationType);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DeputationTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		deputationTypeLocalService = (DeputationTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeputationTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = deputationTypePersistence.getDataSource();
	...
	protected DeputationTypeLocalService deputationTypeLocalService;
