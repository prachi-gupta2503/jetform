...
import com.adjecti.mdm.liferay.service.OrganizationStationLocalService;
...
/**
 * Provides the base implementation for the organization station local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OrganizationStationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OrganizationStationLocalServiceImpl
 * @generated
 */
public abstract class OrganizationStationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrganizationStationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OrganizationStationLocalServiceUtil</code>.
	 */
	...
	@Override
	public OrganizationStation addOrganizationStation(
		OrganizationStation organizationStation) {

		organizationStation.setNew(true);

		return organizationStationPersistence.update(organizationStation);
	}
	...
	public OrganizationStation createOrganizationStation(
		long organizationStationId) {

		return organizationStationPersistence.create(organizationStationId);
	}
	...
	@Override
	public OrganizationStation deleteOrganizationStation(
			long organizationStationId)
		throws PortalException {

		return organizationStationPersistence.remove(organizationStationId);
	}
	...
	public OrganizationStation deleteOrganizationStation(
		...
		return organizationStationPersistence.remove(organizationStation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OrganizationStation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return organizationStationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return organizationStationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public OrganizationStation fetchOrganizationStation(
		long organizationStationId) {

		return organizationStationPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public OrganizationStation getOrganizationStation(
			long organizationStationId)
		throws PortalException {

		return organizationStationPersistence.findByPrimaryKey(
			organizationStationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OrganizationStation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return organizationStationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return organizationStationLocalService.deleteOrganizationStation(
			(OrganizationStation)persistedModel);
	}

	public BasePersistence<OrganizationStation> getBasePersistence() {
		return organizationStationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return organizationStationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OrganizationStation> getOrganizationStations(
		int start, int end) {

		return organizationStationPersistence.findAll(start, end);
	}
	...
	public int getOrganizationStationsCount() {
		return organizationStationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OrganizationStation updateOrganizationStation(
		OrganizationStation organizationStation) {
	...
	public void setAopProxy(Object aopProxy) {
		organizationStationLocalService =
			(OrganizationStationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrganizationStationLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return OrganizationStation.class;
	}

	protected String getModelClassName() {
		return OrganizationStation.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				organizationStationPersistence.getDataSource();
	...
	protected OrganizationStationLocalService organizationStationLocalService;
