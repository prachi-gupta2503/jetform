...
import com.adjecti.mdm.liferay.service.TrainingCourseLocalService;
...
/**
 * Provides the base implementation for the training course local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.TrainingCourseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.TrainingCourseLocalServiceImpl
 * @generated
 */
public abstract class TrainingCourseLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TrainingCourseLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingCourseLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.TrainingCourseLocalServiceUtil</code>.
	 */
	...
	public TrainingCourse addTrainingCourse(TrainingCourse trainingCourse) {
		...
		return trainingCoursePersistence.update(trainingCourse);
	}
	...
	public TrainingCourse createTrainingCourse(long trainingCourseId) {
		return trainingCoursePersistence.create(trainingCourseId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrainingCourse deleteTrainingCourse(TrainingCourse trainingCourse) {
		return trainingCoursePersistence.remove(trainingCourse);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingCourse.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingCoursePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return trainingCoursePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingCoursePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return trainingCoursePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TrainingCourse fetchTrainingCourse(long trainingCourseId) {
		return trainingCoursePersistence.fetchByPrimaryKey(trainingCourseId);
	}
	 ...
	 */
	@Override
	public TrainingCourse getTrainingCourse(long trainingCourseId)
		throws PortalException {

		return trainingCoursePersistence.findByPrimaryKey(trainingCourseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(trainingCourseLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TrainingCourse.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("trainingCourseId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TrainingCourse.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingCoursePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return trainingCourseLocalService.deleteTrainingCourse(
			(TrainingCourse)persistedModel);
	}

	public BasePersistence<TrainingCourse> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingCoursePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrainingCourse> getTrainingCourses(int start, int end) {
		return trainingCoursePersistence.findAll(start, end);
	}
	...
	public int getTrainingCoursesCount() {
		return trainingCoursePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TrainingCourseLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		trainingCourseLocalService = (TrainingCourseLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingCourseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = trainingCoursePersistence.getDataSource();
