...
import com.adjecti.mdm.liferay.service.AppellationLocalService;
...
/**
 * Provides the base implementation for the appellation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.AppellationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.AppellationLocalServiceImpl
 * @generated
 */
public abstract class AppellationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AppellationLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppellationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.AppellationLocalServiceUtil</code>.
	 */
	...
	@Override
	public Appellation addAppellation(Appellation appellation) {
		appellation.setNew(true);

		return appellationPersistence.update(appellation);
	}
	...
	public Appellation createAppellation(long appellationId) {
		return appellationPersistence.create(appellationId);
	}
	...
	@Override
	public Appellation deleteAppellation(long appellationId)
		throws PortalException {

		return appellationPersistence.remove(appellationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Appellation deleteAppellation(Appellation appellation) {
		return appellationPersistence.remove(appellation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Appellation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return appellationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return appellationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return appellationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return appellationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Appellation fetchAppellation(long appellationId) {
		return appellationPersistence.fetchByPrimaryKey(appellationId);
	}
	 ...
	 */
	@Override
	public Appellation getAppellation(long appellationId)
		throws PortalException {

		return appellationPersistence.findByPrimaryKey(appellationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(appellationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Appellation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("appellationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			appellationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Appellation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return appellationPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return appellationLocalService.deleteAppellation(
			(Appellation)persistedModel);
	}

	public BasePersistence<Appellation> getBasePersistence() {
		return appellationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return appellationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Appellation> getAppellations(int start, int end) {
		return appellationPersistence.findAll(start, end);
	}
	...
	public int getAppellationsCount() {
		return appellationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Appellation updateAppellation(Appellation appellation) {
		return appellationPersistence.update(appellation);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppellationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		appellationLocalService = (AppellationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppellationLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return Appellation.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = appellationPersistence.getDataSource();
	...
	protected AppellationLocalService appellationLocalService;
