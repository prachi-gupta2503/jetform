...
import com.adjecti.mdm.liferay.service.OrganizationHistoryLocalService;
...
/**
 * Provides the base implementation for the organization history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OrganizationHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OrganizationHistoryLocalServiceImpl
 * @generated
 */
public abstract class OrganizationHistoryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrganizationHistoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OrganizationHistoryLocalServiceUtil</code>.
	 */
	...
	@Override
	public OrganizationHistory addOrganizationHistory(
		OrganizationHistory organizationHistory) {

		organizationHistory.setNew(true);

		return organizationHistoryPersistence.update(organizationHistory);
	}
	...
	public OrganizationHistory createOrganizationHistory(
		long organizationHistoryId) {

		return organizationHistoryPersistence.create(organizationHistoryId);
	}
	...
	@Override
	public OrganizationHistory deleteOrganizationHistory(
			long organizationHistoryId)
		throws PortalException {

		return organizationHistoryPersistence.remove(organizationHistoryId);
	}
	...
	public OrganizationHistory deleteOrganizationHistory(
		...
		return organizationHistoryPersistence.remove(organizationHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OrganizationHistory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return organizationHistoryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return organizationHistoryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public OrganizationHistory fetchOrganizationHistory(
		long organizationHistoryId) {

		return organizationHistoryPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public OrganizationHistory getOrganizationHistory(
			long organizationHistoryId)
		throws PortalException {

		return organizationHistoryPersistence.findByPrimaryKey(
			organizationHistoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OrganizationHistory.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return organizationHistoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return organizationHistoryLocalService.deleteOrganizationHistory(
			(OrganizationHistory)persistedModel);
	}

	public BasePersistence<OrganizationHistory> getBasePersistence() {
		return organizationHistoryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return organizationHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OrganizationHistory> getOrganizationHistories(
		int start, int end) {

		return organizationHistoryPersistence.findAll(start, end);
	}
	...
	public int getOrganizationHistoriesCount() {
		return organizationHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OrganizationHistory updateOrganizationHistory(
		OrganizationHistory organizationHistory) {
	...
	public void setAopProxy(Object aopProxy) {
		organizationHistoryLocalService =
			(OrganizationHistoryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrganizationHistoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				organizationHistoryPersistence.getDataSource();
	...
	protected OrganizationHistoryLocalService organizationHistoryLocalService;
