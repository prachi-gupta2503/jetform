...
import com.adjecti.mdm.liferay.service.LevelWisePayStructureService;
...
/**
 * Provides the base implementation for the level wise pay structure remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.LevelWisePayStructureServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.LevelWisePayStructureServiceImpl
 * @generated
 */
public abstract class LevelWisePayStructureServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LevelWisePayStructureService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LevelWisePayStructureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.LevelWisePayStructureServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LevelWisePayStructureService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		levelWisePayStructureService = (LevelWisePayStructureService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LevelWisePayStructureService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.LevelWisePayStructureLocalService
		levelWisePayStructureLocalService;

	protected LevelWisePayStructureService levelWisePayStructureService;
