...
import com.adjecti.mdm.liferay.service.CasteCategoryService;
...
/**
 * Provides the base implementation for the caste category remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.CasteCategoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.CasteCategoryServiceImpl
 * @generated
 */
public abstract class CasteCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CasteCategoryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CasteCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.CasteCategoryServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CasteCategoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		casteCategoryService = (CasteCategoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CasteCategoryService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = casteCategoryPersistence.getDataSource();
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.CasteCategoryLocalService
		casteCategoryLocalService;

	protected CasteCategoryService casteCategoryService;
