...
import com.adjecti.mdm.liferay.service.DesignationGroupService;
...
/**
 * Provides the base implementation for the designation group remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.DesignationGroupServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.DesignationGroupServiceImpl
 * @generated
 */
public abstract class DesignationGroupServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DesignationGroupService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DesignationGroupService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.DesignationGroupServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DesignationGroupService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		designationGroupService = (DesignationGroupService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DesignationGroupService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.DesignationGroupLocalService
		designationGroupLocalService;

	protected DesignationGroupService designationGroupService;
