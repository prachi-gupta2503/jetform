...
import com.adjecti.mdm.liferay.service.QualificationGradeService;
...
/**
 * Provides the base implementation for the qualification grade remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.QualificationGradeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.QualificationGradeServiceImpl
 * @generated
 */
public abstract class QualificationGradeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QualificationGradeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualificationGradeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.QualificationGradeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualificationGradeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		qualificationGradeService = (QualificationGradeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualificationGradeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.QualificationGradeLocalService
		qualificationGradeLocalService;

	protected QualificationGradeService qualificationGradeService;
