...
import com.adjecti.mdm.liferay.service.OccupationLocalService;
...
/**
 * Provides the base implementation for the occupation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.OccupationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.OccupationLocalServiceImpl
 * @generated
 */
public abstract class OccupationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, OccupationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OccupationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.OccupationLocalServiceUtil</code>.
	 */
	...
	public Occupation addOccupation(Occupation occupation) {
		...
		return occupationPersistence.update(occupation);
	}
	...
	public Occupation createOccupation(long occupationId) {
		return occupationPersistence.create(occupationId);
	}
	...
	@Override
	public Occupation deleteOccupation(long occupationId)
		throws PortalException {

		return occupationPersistence.remove(occupationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Occupation deleteOccupation(Occupation occupation) {
		return occupationPersistence.remove(occupation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Occupation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return occupationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return occupationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return occupationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return occupationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Occupation fetchOccupation(long occupationId) {
		return occupationPersistence.fetchByPrimaryKey(occupationId);
	}
	 ...
	 */
	@Override
	public Occupation getOccupation(long occupationId) throws PortalException {
		return occupationPersistence.findByPrimaryKey(occupationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(occupationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Occupation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("occupationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			occupationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Occupation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return occupationPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return occupationLocalService.deleteOccupation(
			(Occupation)persistedModel);
	}

	public BasePersistence<Occupation> getBasePersistence() {
		return occupationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return occupationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Occupation> getOccupations(int start, int end) {
		return occupationPersistence.findAll(start, end);
	}
	...
	public int getOccupationsCount() {
		return occupationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OccupationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		occupationLocalService = (OccupationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OccupationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = occupationPersistence.getDataSource();
	...
	protected OccupationLocalService occupationLocalService;
