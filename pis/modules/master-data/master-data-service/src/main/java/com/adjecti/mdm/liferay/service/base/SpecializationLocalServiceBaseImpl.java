...
import com.adjecti.mdm.liferay.service.SpecializationLocalService;
...
/**
 * Provides the base implementation for the specialization local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.SpecializationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.SpecializationLocalServiceImpl
 * @generated
 */
public abstract class SpecializationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SpecializationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SpecializationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.SpecializationLocalServiceUtil</code>.
	 */
	...
	public Specialization addSpecialization(Specialization specialization) {
		...
		return specializationPersistence.update(specialization);
	}
	...
	public Specialization createSpecialization(long specializationId) {
		return specializationPersistence.create(specializationId);
	}
	...
	@Override
	public Specialization deleteSpecialization(long specializationId)
		throws PortalException {

		return specializationPersistence.remove(specializationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Specialization deleteSpecialization(Specialization specialization) {
		return specializationPersistence.remove(specialization);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Specialization.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return specializationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return specializationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return specializationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return specializationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Specialization fetchSpecialization(long specializationId) {
		return specializationPersistence.fetchByPrimaryKey(specializationId);
	}
	...
	public Specialization getSpecialization(long specializationId)
		...
		return specializationPersistence.findByPrimaryKey(specializationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(specializationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Specialization.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Specialization.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return specializationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return specializationLocalService.deleteSpecialization(
			(Specialization)persistedModel);
	}

	public BasePersistence<Specialization> getBasePersistence() {
		return specializationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return specializationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Specialization> getSpecializations(int start, int end) {
		return specializationPersistence.findAll(start, end);
	}
	...
	public int getSpecializationsCount() {
		return specializationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SpecializationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		specializationLocalService = (SpecializationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SpecializationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = specializationPersistence.getDataSource();
	...
	protected SpecializationLocalService specializationLocalService;
