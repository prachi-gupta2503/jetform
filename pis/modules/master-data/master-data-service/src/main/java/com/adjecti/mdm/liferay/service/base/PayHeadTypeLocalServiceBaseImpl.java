...
import com.adjecti.mdm.liferay.service.PayHeadTypeLocalService;
...
/**
 * Provides the base implementation for the pay head type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.PayHeadTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.PayHeadTypeLocalServiceImpl
 * @generated
 */
public abstract class PayHeadTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PayHeadTypeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PayHeadTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.PayHeadTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public PayHeadType addPayHeadType(PayHeadType payHeadType) {
		payHeadType.setNew(true);

		return payHeadTypePersistence.update(payHeadType);
	}
	...
	public PayHeadType createPayHeadType(long payHeadTypeId) {
		return payHeadTypePersistence.create(payHeadTypeId);
	}
	...
	@Override
	public PayHeadType deletePayHeadType(long payHeadTypeId)
		throws PortalException {

		return payHeadTypePersistence.remove(payHeadTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayHeadType deletePayHeadType(PayHeadType payHeadType) {
		return payHeadTypePersistence.remove(payHeadType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PayHeadType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return payHeadTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return payHeadTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return payHeadTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return payHeadTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PayHeadType fetchPayHeadType(long payHeadTypeId) {
		return payHeadTypePersistence.fetchByPrimaryKey(payHeadTypeId);
	}
	 ...
	 */
	@Override
	public PayHeadType getPayHeadType(long payHeadTypeId)
		throws PortalException {

		return payHeadTypePersistence.findByPrimaryKey(payHeadTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(payHeadTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PayHeadType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("payHeadTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			payHeadTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PayHeadType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return payHeadTypePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return payHeadTypeLocalService.deletePayHeadType(
			(PayHeadType)persistedModel);
	}

	public BasePersistence<PayHeadType> getBasePersistence() {
		return payHeadTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return payHeadTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayHeadType> getPayHeadTypes(int start, int end) {
		return payHeadTypePersistence.findAll(start, end);
	}
	...
	public int getPayHeadTypesCount() {
		return payHeadTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PayHeadType updatePayHeadType(PayHeadType payHeadType) {
		return payHeadTypePersistence.update(payHeadType);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PayHeadTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		payHeadTypeLocalService = (PayHeadTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayHeadTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = payHeadTypePersistence.getDataSource();
	...
	protected PayHeadTypeLocalService payHeadTypeLocalService;
