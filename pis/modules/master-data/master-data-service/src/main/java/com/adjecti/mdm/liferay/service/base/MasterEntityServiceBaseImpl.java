...
import com.adjecti.mdm.liferay.service.MasterEntityService;
...
/**
 * Provides the base implementation for the master entity remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.MasterEntityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.MasterEntityServiceImpl
 * @generated
 */
public abstract class MasterEntityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterEntityService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterEntityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.MasterEntityServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterEntityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterEntityService = (MasterEntityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterEntityService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.MasterEntityLocalService
		masterEntityLocalService;

	protected MasterEntityService masterEntityService;
