...
import com.adjecti.mdm.liferay.service.CourseCategoryLocalService;
...
/**
 * Provides the base implementation for the course category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.CourseCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.CourseCategoryLocalServiceImpl
 * @generated
 */
public abstract class CourseCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CourseCategoryLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CourseCategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.CourseCategoryLocalServiceUtil</code>.
	 */
	...
	public CourseCategory addCourseCategory(CourseCategory courseCategory) {
		...
		return courseCategoryPersistence.update(courseCategory);
	}
	...
	public CourseCategory createCourseCategory(long courseCategoryId) {
		return courseCategoryPersistence.create(courseCategoryId);
	}
	...
	@Override
	public CourseCategory deleteCourseCategory(long courseCategoryId)
		throws PortalException {

		return courseCategoryPersistence.remove(courseCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CourseCategory deleteCourseCategory(CourseCategory courseCategory) {
		return courseCategoryPersistence.remove(courseCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CourseCategory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return courseCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return courseCategoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return courseCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return courseCategoryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CourseCategory fetchCourseCategory(long courseCategoryId) {
		return courseCategoryPersistence.fetchByPrimaryKey(courseCategoryId);
	}
	...
	public CourseCategory getCourseCategory(long courseCategoryId)
		...
		return courseCategoryPersistence.findByPrimaryKey(courseCategoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(courseCategoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CourseCategory.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("courseCategoryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			courseCategoryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CourseCategory.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return courseCategoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return courseCategoryLocalService.deleteCourseCategory(
			(CourseCategory)persistedModel);
	}

	public BasePersistence<CourseCategory> getBasePersistence() {
		return courseCategoryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return courseCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CourseCategory> getCourseCategories(int start, int end) {
		return courseCategoryPersistence.findAll(start, end);
	}
	...
	public int getCourseCategoriesCount() {
		return courseCategoryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CourseCategoryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		courseCategoryLocalService = (CourseCategoryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CourseCategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = courseCategoryPersistence.getDataSource();
	...
	protected CourseCategoryLocalService courseCategoryLocalService;
