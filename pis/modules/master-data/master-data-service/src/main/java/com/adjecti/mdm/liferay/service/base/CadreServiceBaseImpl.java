...
import com.adjecti.mdm.liferay.service.CadreService;
...
/**
 * Provides the base implementation for the cadre remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.CadreServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.CadreServiceImpl
 * @generated
 */
public abstract class CadreServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CadreService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CadreService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.CadreServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CadreService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cadreService = (CadreService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CadreService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.CadreLocalService
		cadreLocalService;
