...
import com.adjecti.mdm.liferay.service.GenderService;
...
/**
 * Provides the base implementation for the gender remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.GenderServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.GenderServiceImpl
 * @generated
 */
public abstract class GenderServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GenderService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GenderService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.GenderServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GenderService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		genderService = (GenderService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GenderService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.mdm.liferay.service.GenderLocalService
		genderLocalService;
