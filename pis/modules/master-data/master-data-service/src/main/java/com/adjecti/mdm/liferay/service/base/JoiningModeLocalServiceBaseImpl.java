...
import com.adjecti.mdm.liferay.service.JoiningModeLocalService;
...
/**
 * Provides the base implementation for the joining mode local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.mdm.liferay.service.impl.JoiningModeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.mdm.liferay.service.impl.JoiningModeLocalServiceImpl
 * @generated
 */
public abstract class JoiningModeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, JoiningModeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JoiningModeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.mdm.liferay.service.JoiningModeLocalServiceUtil</code>.
	 */
	...
	@Override
	public JoiningMode addJoiningMode(JoiningMode joiningMode) {
		joiningMode.setNew(true);

		return joiningModePersistence.update(joiningMode);
	}
	...
	public JoiningMode createJoiningMode(long joiningModeId) {
		return joiningModePersistence.create(joiningModeId);
	}
	...
	@Override
	public JoiningMode deleteJoiningMode(long joiningModeId)
		throws PortalException {

		return joiningModePersistence.remove(joiningModeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JoiningMode deleteJoiningMode(JoiningMode joiningMode) {
		return joiningModePersistence.remove(joiningMode);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JoiningMode.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return joiningModePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return joiningModePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return joiningModePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return joiningModePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public JoiningMode fetchJoiningMode(long joiningModeId) {
		return joiningModePersistence.fetchByPrimaryKey(joiningModeId);
	}
	 ...
	 */
	@Override
	public JoiningMode getJoiningMode(long joiningModeId)
		throws PortalException {

		return joiningModePersistence.findByPrimaryKey(joiningModeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(joiningModeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(JoiningMode.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("joiningModeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			joiningModeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(JoiningMode.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return joiningModePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return joiningModeLocalService.deleteJoiningMode(
			(JoiningMode)persistedModel);
	}

	public BasePersistence<JoiningMode> getBasePersistence() {
		return joiningModePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return joiningModePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JoiningMode> getJoiningModes(int start, int end) {
		return joiningModePersistence.findAll(start, end);
	}
	...
	public int getJoiningModesCount() {
		return joiningModePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JoiningMode updateJoiningMode(JoiningMode joiningMode) {
		return joiningModePersistence.update(joiningMode);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JoiningModeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		joiningModeLocalService = (JoiningModeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JoiningModeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = joiningModePersistence.getDataSource();
	...
	protected JoiningModeLocalService joiningModeLocalService;
