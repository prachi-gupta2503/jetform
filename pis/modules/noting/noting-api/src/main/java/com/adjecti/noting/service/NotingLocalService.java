...
/**
 * Provides the local service interface for Noting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NotingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NotingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.noting.service.impl.NotingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the noting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Noting addNoting(String title, String content, long pdfId)
