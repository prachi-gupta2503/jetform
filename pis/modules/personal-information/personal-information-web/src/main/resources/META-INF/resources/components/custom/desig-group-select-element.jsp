...
<%
	...
	for(Role ur: userRoles){
		...
		if(ur.getName().equalsIgnoreCase("group_a_creator") || ur.getName().equalsIgnoreCase("group_a_approver")){
			groupA=true;
		}else if(ur.getName().equalsIgnoreCase("group_b_creator") || ur.getName().equalsIgnoreCase("group_b_approver")){
			groupB=true;
		}else if(ur.getName().equalsIgnoreCase("group_c_creator") || ur.getName().equalsIgnoreCase("group_c_approver")){
			groupC=true;
		}
	}
...
<%
	for(DesignationGroup dg:desGroups){
		...
		if((groupA && !dg.getName().equalsIgnoreCase("a")) || (groupB && !dg.getName().equalsIgnoreCase("b")) || (groupC && !dg.getName().equalsIgnoreCase("c"))){
			continue;
		}
