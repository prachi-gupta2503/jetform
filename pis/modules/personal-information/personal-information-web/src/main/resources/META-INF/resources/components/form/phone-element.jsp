...
<%
	if(readOnly){
%>
		<aui:input type="text" name="<%=childFormNamespace+htmlElement.getName()%>" maxLength="10" label="" placeholder="<%=htmlElement.getLabel()%>" value="<%=savedValue%>" readOnly="<%=readOnly%>" />
<%
	}else{
%>
		<aui:input type="text" name="<%=childFormNamespace+htmlElement.getName()%>" maxLength="10" label="" placeholder="<%=htmlElement.getLabel()%>" value="<%=savedValue%>">
