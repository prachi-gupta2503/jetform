...
%>
<a class="btn bg-primary text-white mr-1" data-toggle="collapse" href="#collapseSearch" role="button" aria-expanded="true" aria-controls="collapseSearch">
	<i class="fas fa-search view-icon"></i>
</a>
<%--
