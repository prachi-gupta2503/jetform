...
<%
        	...
        	if(!StringUtils.isBlank(htmlElement.getMatchWith())){
 %>
         <aui:validator name="custom" errorMessage="some-error">
	        function (val, fieldNode, ruleValue) {
	        
	        console.log("to unit value"+ val);
	        console.log("<%=htmlElement.getMatchWith()%>")
	        var matchWith="<%=htmlElement.getMatchWith()%>";
	        console.log($("#<portlet:namespace/><%=childFormNamespace%>"+matchWith).val());
	        matchWithVal=$("#<portlet:namespace/><%=childFormNamespace%>"+matchWith).val();
	        var errorMessage="";
	        var valid=true;
	        if(matchWithVal==val){
