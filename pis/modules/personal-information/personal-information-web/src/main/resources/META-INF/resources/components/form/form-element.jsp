...
<%
	...
	String childFormNamespace = ParamUtil.getString(request, "childFormNamespace");
	...
	HtmlElementWrapper formElement=(HtmlElementWrapper)request.getAttribute("htmlElement_"+elementName);
	...
	request.setAttribute("childFormClass", formClass);
	request.setAttribute("childFormClassPK", formClassPK);
	request.setAttribute("childFormNamespace", childFormNamespace);
...
--%>
<liferay-util:include page="/components/form/script-elements-child-form.jsp" servletContext="<%=application%>" />
<%--@ include file="/components/form/script-elements.jsp"--%>
<%
request.removeAttribute("childFormClass");
request.removeAttribute("childFormClassPK");
request.removeAttribute("childFormNamespace");
request.removeAttribute("childFormId");
request.removeAttribute(form.getId());
%>
