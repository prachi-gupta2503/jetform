...
/**
 * Provides the local service interface for EmployeeDigitalSignature. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeDigitalSignatureLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployeeDigitalSignatureLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeDigitalSignatureLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee digital signature local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeDigitalSignatureLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EmployeeDigitalSignature addEmployeeDigitalSignature(
	...
	public EmployeeDigitalSignature createEmployeeDigitalSignature(
	...
	public EmployeeDigitalSignature deleteEmployeeDigitalSignature(
		EmployeeDigitalSignature employeeDigitalSignature);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeDigitalSignature fetchEmployeeDigitalSignature(
		long employeeDigitalSignatureId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeDigitalSignature getEmployeeDigitalSignature(
			long employeeDigitalSignatureId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeDigitalSignature> getEmployeeDigitalSignatures(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EmployeeDigitalSignature updateEmployeeDigitalSignature(
		EmployeeDigitalSignature employeeDigitalSignature);
