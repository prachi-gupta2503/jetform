...
/**
 * Provides the local service interface for EmployeeJoining. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeJoiningLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployeeJoiningLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeJoiningLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee joining local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeJoiningLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EmployeeJoining addEmployeeJoiningDetails(
			EmployeeJoining employeeJoiningData)
		throws EmployeeJoiningException, PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeJoining> searchEmployeeJoining(
