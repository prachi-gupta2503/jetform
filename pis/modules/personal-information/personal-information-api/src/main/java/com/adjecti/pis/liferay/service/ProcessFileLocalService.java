...
/**
 * Provides the local service interface for ProcessFile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProcessFileLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProcessFileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.ProcessFileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the process file local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProcessFileLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ProcessFile addProcessFile(ProcessFile processFile);
	...
	public ProcessFile createProcessFile(long processFileId);
	...
	public ProcessFile deleteProcessFile(long processFileId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProcessFile deleteProcessFile(ProcessFile processFile);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessFile fetchProcessFile(long processFileId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessFile fetchProcessFileByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessFile getProcessFile(long processFileId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessFile getProcessFileByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProcessFile> getProcessFiles(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProcessFile> getProcessFilesByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProcessFile updateProcessFile(ProcessFile processFile);
