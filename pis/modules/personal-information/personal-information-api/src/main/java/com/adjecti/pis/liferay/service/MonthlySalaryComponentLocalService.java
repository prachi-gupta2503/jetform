...
/**
 * Provides the local service interface for MonthlySalaryComponent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MonthlySalaryComponentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MonthlySalaryComponentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.MonthlySalaryComponentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the monthly salary component local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MonthlySalaryComponentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MonthlySalaryComponent addMonthlySalaryComponent(
	...
	public MonthlySalaryComponent createMonthlySalaryComponent(
	...
	public MonthlySalaryComponent deleteMonthlySalaryComponent(
			long monthlySalaryComponentId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlySalaryComponent fetchMonthlySalaryComponent(
		long monthlySalaryComponentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlySalaryComponent getMonthlySalaryComponent(
			long monthlySalaryComponentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MonthlySalaryComponent> getMonthlySalaryComponents(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MonthlySalaryComponent updateMonthlySalaryComponent(
		MonthlySalaryComponent monthlySalaryComponent);
