...
/**
 * Provides the local service interface for EmployeeBenefitScheme. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeBenefitSchemeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployeeBenefitSchemeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeBenefitSchemeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee benefit scheme local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeBenefitSchemeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EmployeeBenefitScheme addEmployeeBenefitScheme(
	...
	public EmployeeBenefitScheme createEmployeeBenefitScheme(
	...
	public EmployeeBenefitScheme deleteEmployeeBenefitScheme(
		EmployeeBenefitScheme employeeBenefitScheme);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeBenefitScheme fetchEmployeeBenefitScheme(
		long employeeBenefitSchemeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeBenefitScheme getEmployeeBenefitScheme(
			long employeeBenefitSchemeId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeBenefitScheme> getEmployeeBenefitSchemes(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EmployeeBenefitScheme updateEmployeeBenefitScheme(
		EmployeeBenefitScheme employeeBenefitScheme);
