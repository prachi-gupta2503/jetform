...
/**
 * The base model interface for the EmployeeReporting service. Represents a row in the &quot;pis_EmployeeReporting&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.adjecti.pis.liferay.model.impl.EmployeeReportingModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.adjecti.pis.liferay.model.impl.EmployeeReportingImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface EmployeeReportingModel
	extends BaseModel<EmployeeReporting>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a employee reporting model instance should use the {@link EmployeeReporting} interface instead.
	 */
