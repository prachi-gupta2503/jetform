...
/**
 * Provides the local service utility for FamilyMemberServiceDetail. This utility wraps
 * <code>com.adjecti.pis.liferay.service.impl.FamilyMemberServiceDetailLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FamilyMemberServiceDetailLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.FamilyMemberServiceDetailLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.pis.liferay.model.FamilyMemberServiceDetail
		addFamilyMemberServiceDetail(
			com.adjecti.pis.liferay.model.FamilyMemberServiceDetail
				familyMemberServiceDetail) {

		return getService().addFamilyMemberServiceDetail(
			familyMemberServiceDetail);
	}
	...
	public static com.adjecti.pis.liferay.model.FamilyMemberServiceDetail
		...
		return getService().createFamilyMemberServiceDetail(
	...
	public static com.adjecti.pis.liferay.model.FamilyMemberServiceDetail
		...
		return getService().deleteFamilyMemberServiceDetail(
			familyMemberServiceDetail);
	}
	...
	public static com.adjecti.pis.liferay.model.FamilyMemberServiceDetail
		...
		return getService().fetchFamilyMemberServiceDetail(
			familyMemberServiceDetailId);
	}
	...
	public static com.adjecti.pis.liferay.model.FamilyMemberServiceDetail
		...
		return getService().getFamilyMemberServiceDetail(
			familyMemberServiceDetailId);
	}
	...
	public static java.util.List
		...
		return getService().getFamilyMemberServiceDetails(start, end);
	}
	 ...
	 */
	public static int getFamilyMemberServiceDetailsCount() {
		return getService().getFamilyMemberServiceDetailsCount();
	}
	...
	public static com.adjecti.pis.liferay.model.FamilyMemberServiceDetail
		...
		return getService().updateFamilyMemberServiceDetail(
			familyMemberServiceDetail);
	}

	public static FamilyMemberServiceDetailLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<FamilyMemberServiceDetailLocalService,
		 FamilyMemberServiceDetailLocalService> _serviceTracker;
	...
	static {
		...
		ServiceTracker
			<FamilyMemberServiceDetailLocalService,
			 FamilyMemberServiceDetailLocalService> serviceTracker =
				new ServiceTracker
					<FamilyMemberServiceDetailLocalService,
					 FamilyMemberServiceDetailLocalService>(
						 bundle.getBundleContext(),
						 FamilyMemberServiceDetailLocalService.class, null);
