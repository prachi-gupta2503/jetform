...
/**
 * Provides the local service interface for JoiningProcess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JoiningProcessLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JoiningProcessLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.JoiningProcessLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the joining process local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JoiningProcessLocalServiceUtil} if injection and service tracking are not available.
	 */
