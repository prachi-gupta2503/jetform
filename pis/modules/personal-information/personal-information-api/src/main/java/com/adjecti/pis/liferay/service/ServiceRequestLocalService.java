...
/**
 * Provides the local service interface for ServiceRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ServiceRequestLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ServiceRequestLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.ServiceRequestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the service request local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ServiceRequestLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ServiceRequest> getByServiceRequestTypeIdAndDeleted(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ServiceRequest> getServiceRequestByStatusAndOrganization(
