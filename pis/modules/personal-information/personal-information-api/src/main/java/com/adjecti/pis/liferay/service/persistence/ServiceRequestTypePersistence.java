...
import com.adjecti.pis.liferay.exception.NoSuchServiceRequestTypeException;
...
/**
 * The persistence interface for the service request type service.
 *
 * <p>
 ...
 * @see ServiceRequestTypeUtil
 * @generated
 */
@ProviderType
public interface ServiceRequestTypePersistence
	extends BasePersistence<ServiceRequestType> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ServiceRequestTypeUtil} to access the service request type persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<ServiceRequestType> serviceRequestTypes);
	...
	public ServiceRequestType updateImpl(ServiceRequestType serviceRequestType);
	 ...
	 */
	public java.util.List<ServiceRequestType> findAll();
	 ...
	 */
	public java.util.List<ServiceRequestType> findAll(int start, int end);
	...
	public java.util.List<ServiceRequestType> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ServiceRequestType>
			orderByComparator);
