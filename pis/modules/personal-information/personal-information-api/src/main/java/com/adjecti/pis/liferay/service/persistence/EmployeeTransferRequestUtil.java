 ...
 * @see EmployeeTransferRequestPersistence
 * @generated
 */
public class EmployeeTransferRequestUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(employeeTransferRequest);
	}
	 ...
	 */
	public static Map<Serializable, EmployeeTransferRequest> fetchByPrimaryKeys(
	 ...
	 */
	public static List<EmployeeTransferRequest> findWithDynamicQuery(
	 ...
	 */
	public static EmployeeTransferRequest update(
		EmployeeTransferRequest employeeTransferRequest) {

		return getPersistence().update(employeeTransferRequest);
	}
	...
	public static EmployeeTransferRequest update(
		...
		return getPersistence().update(employeeTransferRequest, serviceContext);
	}
	 ...
	 */
	public static List<EmployeeTransferRequest> findByUuid(String uuid) {
	 ...
	 */
	public static List<EmployeeTransferRequest> findByUuid(
	 ...
	 */
	public static EmployeeTransferRequest findByUuid_First(
			String uuid,
			OrderByComparator<EmployeeTransferRequest> orderByComparator)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeTransferRequestException {
	 ...
	 */
	public static EmployeeTransferRequest fetchByUuid_First(
		String uuid,
		OrderByComparator<EmployeeTransferRequest> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeTransferRequestException if a matching employee transfer request could not be found
	 */
	public static EmployeeTransferRequest findByUuid_Last(
			String uuid,
			OrderByComparator<EmployeeTransferRequest> orderByComparator)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeTransferRequestException {
	 ...
	 */
	public static EmployeeTransferRequest fetchByUuid_Last(
		String uuid,
		OrderByComparator<EmployeeTransferRequest> orderByComparator) {
	 ...
	 */
	public static EmployeeTransferRequest[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			employeeTransferRequestId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchEmployeeTransferRequestException if a matching employee transfer request could not be found
	 */
	public static EmployeeTransferRequest findByUUID_G(
	 ...
	 */
	public static EmployeeTransferRequest fetchByUUID_G(
		String uuid, long groupId) {
	 ...
	 */
	public static EmployeeTransferRequest removeByUUID_G(
			String uuid, long groupId)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeTransferRequestException {
	 ...
	 * @return the matching employee transfer requests
	 */
	public static List<EmployeeTransferRequest> findByUuid_C(
	 ...
	 * @throws NoSuchEmployeeTransferRequestException if a matching employee transfer request could not be found
	 */
	public static EmployeeTransferRequest findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<EmployeeTransferRequest> orderByComparator)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeTransferRequestException {
	 ...
	 * @return the first matching employee transfer request, or <code>null</code> if a matching employee transfer request could not be found
	 */
	public static EmployeeTransferRequest fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<EmployeeTransferRequest> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeTransferRequestException if a matching employee transfer request could not be found
	 */
	public static EmployeeTransferRequest findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<EmployeeTransferRequest> orderByComparator)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeTransferRequestException {
	 ...
	 * @return the last matching employee transfer request, or <code>null</code> if a matching employee transfer request could not be found
	 */
	public static EmployeeTransferRequest fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<EmployeeTransferRequest> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeTransferRequestException if a employee transfer request with the primary key could not be found
	 */
	public static EmployeeTransferRequest[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			employeeTransferRequestId, uuid, companyId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(employeeTransferRequest);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(employeeTransferRequests);
	}
	 ...
	 */
	public static EmployeeTransferRequest create(
		long employeeTransferRequestId) {

		return getPersistence().create(employeeTransferRequestId);
	}
	 ...
	 * @throws NoSuchEmployeeTransferRequestException if a employee transfer request with the primary key could not be found
	 */
	public static EmployeeTransferRequest remove(long employeeTransferRequestId)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeTransferRequestException {

		return getPersistence().remove(employeeTransferRequestId);
	}

	public static EmployeeTransferRequest updateImpl(
		EmployeeTransferRequest employeeTransferRequest) {

		return getPersistence().updateImpl(employeeTransferRequest);
	}
	 ...
	 * @throws NoSuchEmployeeTransferRequestException if a employee transfer request with the primary key could not be found
	 */
	public static EmployeeTransferRequest findByPrimaryKey(
			long employeeTransferRequestId)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeTransferRequestException {

		return getPersistence().findByPrimaryKey(employeeTransferRequestId);
	}
	 ...
	 */
	public static EmployeeTransferRequest fetchByPrimaryKey(
		long employeeTransferRequestId) {

		return getPersistence().fetchByPrimaryKey(employeeTransferRequestId);
	}
	 ...
	 */
	public static List<EmployeeTransferRequest> findAll() {
	 ...
	 */
	public static List<EmployeeTransferRequest> findAll(int start, int end) {
	...
	public static EmployeeTransferRequestPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<EmployeeTransferRequestPersistence, EmployeeTransferRequestPersistence>
			_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			EmployeeTransferRequestPersistence.class);

		ServiceTracker
			<EmployeeTransferRequestPersistence,
			 EmployeeTransferRequestPersistence> serviceTracker =
				new ServiceTracker
					<EmployeeTransferRequestPersistence,
					 EmployeeTransferRequestPersistence>(
						 bundle.getBundleContext(),
						 EmployeeTransferRequestPersistence.class, null);
