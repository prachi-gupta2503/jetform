 ...
 * @see FamilyMemberServiceDetailPersistence
 * @generated
 */
public class FamilyMemberServiceDetailUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(familyMemberServiceDetail);
	}
	 ...
	 */
	public static Map<Serializable, FamilyMemberServiceDetail>
	 ...
	 */
	public static List<FamilyMemberServiceDetail> findWithDynamicQuery(
	 ...
	 */
	public static FamilyMemberServiceDetail update(
		FamilyMemberServiceDetail familyMemberServiceDetail) {

		return getPersistence().update(familyMemberServiceDetail);
	}
	...
	public static FamilyMemberServiceDetail update(
		...
		return getPersistence().update(
			familyMemberServiceDetail, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(familyMemberServiceDetail);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(familyMemberServiceDetails);
	}
	 ...
	 */
	public static FamilyMemberServiceDetail create(
		long familyMemberServiceDetailId) {

		return getPersistence().create(familyMemberServiceDetailId);
	}
	 ...
	 */
	public static FamilyMemberServiceDetail remove(
			long familyMemberServiceDetailId)
		throws com.adjecti.pis.liferay.exception.
			NoSuchFamilyMemberServiceDetailException {

		return getPersistence().remove(familyMemberServiceDetailId);
	}

	public static FamilyMemberServiceDetail updateImpl(
		FamilyMemberServiceDetail familyMemberServiceDetail) {

		return getPersistence().updateImpl(familyMemberServiceDetail);
	}
	 ...
	 * @throws NoSuchFamilyMemberServiceDetailException if a family member service detail with the primary key could not be found
	 */
	public static FamilyMemberServiceDetail findByPrimaryKey(
			long familyMemberServiceDetailId)
		throws com.adjecti.pis.liferay.exception.
			NoSuchFamilyMemberServiceDetailException {

		return getPersistence().findByPrimaryKey(familyMemberServiceDetailId);
	}
	 ...
	 */
	public static FamilyMemberServiceDetail fetchByPrimaryKey(
		long familyMemberServiceDetailId) {

		return getPersistence().fetchByPrimaryKey(familyMemberServiceDetailId);
	}
	 ...
	 */
	public static List<FamilyMemberServiceDetail> findAll() {
	 ...
	 */
	public static List<FamilyMemberServiceDetail> findAll(int start, int end) {
	...
	public static FamilyMemberServiceDetailPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<FamilyMemberServiceDetailPersistence,
		 FamilyMemberServiceDetailPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			FamilyMemberServiceDetailPersistence.class);

		ServiceTracker
			<FamilyMemberServiceDetailPersistence,
			 FamilyMemberServiceDetailPersistence> serviceTracker =
				new ServiceTracker
					<FamilyMemberServiceDetailPersistence,
					 FamilyMemberServiceDetailPersistence>(
						 bundle.getBundleContext(),
						 FamilyMemberServiceDetailPersistence.class, null);
