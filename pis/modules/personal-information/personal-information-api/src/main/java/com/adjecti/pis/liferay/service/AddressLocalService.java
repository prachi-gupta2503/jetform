...
public interface AddressLocalService
	...
	public List<Address> addAddress(
			List<Address> addressDetails, long employeeId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Address> getAccomodationTypeByAccomodationTypeId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Address> getAddressesByJoiningProcessIdAndAccomodationTypeId(
