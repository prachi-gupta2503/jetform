...
/**
 * Provides the remote service interface for EmployeeOrganization. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeOrganizationServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface EmployeeOrganizationService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeOrganizationServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee organization remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeOrganizationServiceUtil} if injection and service tracking are not available.
	 */
