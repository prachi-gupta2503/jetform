...
/**
 * Provides the local service utility for EmployeeTransferRequest. This utility wraps
 * <code>com.adjecti.pis.liferay.service.impl.EmployeeTransferRequestLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeeTransferRequestLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeTransferRequestLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		addEmployeeTransferRequest(
			com.adjecti.pis.liferay.model.EmployeeTransferRequest
				employeeTransferRequest) {

		return getService().addEmployeeTransferRequest(employeeTransferRequest);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		...
		return getService().createEmployeeTransferRequest(
	...
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		...
		return getService().deleteEmployeeTransferRequest(
			employeeTransferRequest);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		...
		return getService().fetchEmployeeTransferRequest(
			employeeTransferRequestId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		...
		return getService().fetchEmployeeTransferRequestByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		...
		return getService().getEmployeeTransferRequest(
			employeeTransferRequestId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		...
		return getService().getEmployeeTransferRequestByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static java.util.List
		...
		return getService().getEmployeeTransferRequests(start, end);
	}
	...
	public static java.util.List
		...
		return getService().getEmployeeTransferRequestsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getEmployeeTransferRequestsCount() {
		return getService().getEmployeeTransferRequestsCount();
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeTransferRequest
		...
		return getService().updateEmployeeTransferRequest(
			employeeTransferRequest);
	}

	public static EmployeeTransferRequestLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<EmployeeTransferRequestLocalService,
		 EmployeeTransferRequestLocalService> _serviceTracker;
	...
	static {
		...
		ServiceTracker
			<EmployeeTransferRequestLocalService,
			 EmployeeTransferRequestLocalService> serviceTracker =
				new ServiceTracker
					<EmployeeTransferRequestLocalService,
					 EmployeeTransferRequestLocalService>(
						 bundle.getBundleContext(),
						 EmployeeTransferRequestLocalService.class, null);
