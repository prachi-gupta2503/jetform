...
/**
 * The base model interface for the ServiceRequestWfStatusType service. Represents a row in the &quot;pis_ServiceRequestWfStatusType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.adjecti.pis.liferay.model.impl.ServiceRequestWfStatusTypeModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.adjecti.pis.liferay.model.impl.ServiceRequestWfStatusTypeImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface ServiceRequestWfStatusTypeModel
	extends BaseModel<ServiceRequestWfStatusType>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a service request wf status type model instance should use the {@link ServiceRequestWfStatusType} interface instead.
	 */
