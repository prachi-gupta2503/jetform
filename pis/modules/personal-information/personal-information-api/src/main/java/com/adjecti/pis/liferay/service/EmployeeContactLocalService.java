...
/**
 * Provides the local service interface for EmployeeContact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeContactLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployeeContactLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeContactLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee contact local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeContactLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EmployeeContact createEmployeeContact(long employeeContactId);
	...
	public EmployeeContact deleteEmployeeContact(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EmployeeContact deleteEmployeeContact(long employeeContactId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeContact fetchEmployeeContact(long employeeContactId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeContact getEmployeeContact(long employeeContactId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeContact> getEmployeeContacts(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EmployeeContact updateEmployeeContact(
		EmployeeContact employeeContact);
