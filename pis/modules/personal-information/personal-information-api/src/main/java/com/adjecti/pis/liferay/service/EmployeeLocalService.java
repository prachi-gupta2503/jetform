...
public interface EmployeeLocalService
	...
	public void deleteEmployeeAssociations(Employee employee)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONArray getByDateOfBirth(String designationGroupName)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONArray getByRetirementMonth(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Employee> getEmployeeByDesignationGroupId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONArray getEmployeeList(Map<String, String[]> parameters)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONArray getEmployees(Map<String, String> parameters)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Employee> getEmployeesByOrganizationIdAndPersonalNo(
		long organizationId, String personalNo);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Employee> getEmployeesBySubOrganizationId(
	...
	public void onOrganizationDetailBeforeUpdate(
		OrganizationDetail oldObject, OrganizationDetail newObject);

	public void performWorkFlowAction(long employeeId, String action)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Employee> searchEmployeeModel(
		Map<String, String> searchFilter, String orderBy);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONArray searchEmployees(
			long organizationId, long tradeId, long gradeId, long designationId,
	...
	public boolean updateIDAMUser(
		Employee employee, Map<String, String[]> fieldValues);

	public boolean updateIDAMUser(
		long employeeId, Map<String, String[]> fieldValues);
