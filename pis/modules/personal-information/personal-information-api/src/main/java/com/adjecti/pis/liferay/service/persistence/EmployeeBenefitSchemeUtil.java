...
/**
 * The persistence utility for the employee benefit scheme service. This utility wraps <code>com.adjecti.pis.liferay.service.persistence.impl.EmployeeBenefitSchemePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see EmployeeBenefitSchemePersistence
 * @generated
 */
public class EmployeeBenefitSchemeUtil {
	 ...
	 */
	public static void clearCache(EmployeeBenefitScheme employeeBenefitScheme) {
		getPersistence().clearCache(employeeBenefitScheme);
	}
	 ...
	 */
	public static Map<Serializable, EmployeeBenefitScheme> fetchByPrimaryKeys(
	 ...
	 */
	public static List<EmployeeBenefitScheme> findWithDynamicQuery(
	 ...
	 */
	public static EmployeeBenefitScheme update(
		EmployeeBenefitScheme employeeBenefitScheme) {

		return getPersistence().update(employeeBenefitScheme);
	}
	...
	public static EmployeeBenefitScheme update(
		...
		return getPersistence().update(employeeBenefitScheme, serviceContext);
	}
	 ...
	 */
	public static List<EmployeeBenefitScheme> findByEmployeeId(
		long employeeId) {
	 ...
	 */
	public static EmployeeBenefitScheme findByEmployeeId_First(
			long employeeId,
			OrderByComparator<EmployeeBenefitScheme> orderByComparator)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeBenefitSchemeException {
	 ...
	 */
	public static EmployeeBenefitScheme fetchByEmployeeId_First(
		long employeeId,
		OrderByComparator<EmployeeBenefitScheme> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeBenefitSchemeException if a matching employee benefit scheme could not be found
	 */
	public static EmployeeBenefitScheme findByEmployeeId_Last(
			long employeeId,
			OrderByComparator<EmployeeBenefitScheme> orderByComparator)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeBenefitSchemeException {
	 ...
	 */
	public static EmployeeBenefitScheme fetchByEmployeeId_Last(
		long employeeId,
		OrderByComparator<EmployeeBenefitScheme> orderByComparator) {
	 ...
	 */
	public static EmployeeBenefitScheme[] findByEmployeeId_PrevAndNext(
		...
		return getPersistence().findByEmployeeId_PrevAndNext(
			employeeBenefitSchemeId, employeeId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(employeeBenefitScheme);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(employeeBenefitSchemes);
	}
	 ...
	 */
	public static EmployeeBenefitScheme create(long employeeBenefitSchemeId) {
		return getPersistence().create(employeeBenefitSchemeId);
	}
	 ...
	 * @throws NoSuchEmployeeBenefitSchemeException if a employee benefit scheme with the primary key could not be found
	 */
	public static EmployeeBenefitScheme remove(long employeeBenefitSchemeId)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeBenefitSchemeException {

		return getPersistence().remove(employeeBenefitSchemeId);
	}

	public static EmployeeBenefitScheme updateImpl(
		EmployeeBenefitScheme employeeBenefitScheme) {

		return getPersistence().updateImpl(employeeBenefitScheme);
	}
	 ...
	 * @throws NoSuchEmployeeBenefitSchemeException if a employee benefit scheme with the primary key could not be found
	 */
	public static EmployeeBenefitScheme findByPrimaryKey(
			long employeeBenefitSchemeId)
		throws com.adjecti.pis.liferay.exception.
			NoSuchEmployeeBenefitSchemeException {

		return getPersistence().findByPrimaryKey(employeeBenefitSchemeId);
	}
	 ...
	 */
	public static EmployeeBenefitScheme fetchByPrimaryKey(
		long employeeBenefitSchemeId) {

		return getPersistence().fetchByPrimaryKey(employeeBenefitSchemeId);
	}
	 ...
	 */
	public static List<EmployeeBenefitScheme> findAll() {
	 ...
	 */
	public static List<EmployeeBenefitScheme> findAll(int start, int end) {
	...
	public static EmployeeBenefitSchemePersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<EmployeeBenefitSchemePersistence, EmployeeBenefitSchemePersistence>
			_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			EmployeeBenefitSchemePersistence.class);

		ServiceTracker
			<EmployeeBenefitSchemePersistence, EmployeeBenefitSchemePersistence>
				serviceTracker =
					new ServiceTracker
						<EmployeeBenefitSchemePersistence,
						 EmployeeBenefitSchemePersistence>(
							 bundle.getBundleContext(),
							 EmployeeBenefitSchemePersistence.class, null);
