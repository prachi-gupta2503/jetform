...
/**
 * Provides the local service utility for EmployeeSavingScheme. This utility wraps
 * <code>com.adjecti.pis.liferay.service.impl.EmployeeSavingSchemeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeeSavingSchemeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeSavingSchemeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeeSavingScheme
		addEmployeeSavingScheme(
			com.adjecti.pis.liferay.model.EmployeeSavingScheme
				employeeSavingScheme) {

		return getService().addEmployeeSavingScheme(employeeSavingScheme);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeSavingScheme
		...
		return getService().createEmployeeSavingScheme(employeeSavingSchemeId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeSavingScheme
		...
		return getService().deleteEmployeeSavingScheme(employeeSavingScheme);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeSavingScheme
		...
		return getService().deleteEmployeeSavingScheme(employeeSavingSchemeId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeSavingScheme
		...
		return getService().fetchEmployeeSavingScheme(employeeSavingSchemeId);
	}
	...
	public static java.util.List
		<com.adjecti.pis.liferay.model.EmployeeSavingScheme> getByEmployeeId(
			long employeeId) {
	...
	public static java.util.List
		<com.adjecti.pis.liferay.model.EmployeeSavingScheme> getByPersonalNo(
			String personalNo) {
	...
	public static com.adjecti.pis.liferay.model.EmployeeSavingScheme
		...
		return getService().getEmployeeSavingScheme(employeeSavingSchemeId);
	}
	...
	public static java.util.List
		...
		return getService().getEmployeeSavingSchemes(start, end);
	}
	 ...
	 */
	public static int getEmployeeSavingSchemesCount() {
		return getService().getEmployeeSavingSchemesCount();
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeSavingScheme
		...
		return getService().updateEmployeeSavingScheme(employeeSavingScheme);
	}

	public static EmployeeSavingSchemeLocalService getService() {
					...
					new ServiceTracker
						<EmployeeSavingSchemeLocalService,
						 EmployeeSavingSchemeLocalService>(
							 ...
							 EmployeeSavingSchemeLocalService.class, null);
