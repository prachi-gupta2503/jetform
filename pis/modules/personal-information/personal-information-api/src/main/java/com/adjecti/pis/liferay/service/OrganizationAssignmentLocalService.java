...
/**
 * Provides the local service interface for OrganizationAssignment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OrganizationAssignmentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OrganizationAssignmentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.OrganizationAssignmentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the organization assignment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OrganizationAssignmentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public OrganizationAssignment addOrganizationAssignment(
	...
	public OrganizationAssignment createOrganizationAssignment(
	...
	public OrganizationAssignment deleteOrganizationAssignment(
			long organizationAssignmentId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrganizationAssignment fetchOrganizationAssignment(
		long organizationAssignmentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrganizationAssignment getOrganizationAssignment(
			long organizationAssignmentId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OrganizationAssignment> getOrganizationAssignmentByEmployeeId(
		long employeeId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OrganizationAssignment> getOrganizationAssignmentByPersonalNo(
		String personalNo);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OrganizationAssignment> getOrganizationAssignments(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OrganizationAssignment updateOrganizationAssignment(
		OrganizationAssignment organizationAssignment);
