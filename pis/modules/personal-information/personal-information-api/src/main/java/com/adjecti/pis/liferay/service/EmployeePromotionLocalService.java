...
/**
 * Provides the local service interface for EmployeePromotion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeePromotionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployeePromotionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeePromotionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee promotion local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeePromotionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EmployeePromotion addEmployeePromotion(
	...
	public EmployeePromotion createEmployeePromotion(long employeePromotionId);
	...
	public EmployeePromotion deleteEmployeePromotion(
		EmployeePromotion employeePromotion);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EmployeePromotion deleteEmployeePromotion(long employeePromotionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeePromotion fetchEmployeePromotion(long employeePromotionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeePromotion getEmployeePromotion(long employeePromotionId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeePromotion> getEmployeePromotions(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EmployeePromotion updateEmployeePromotion(
		EmployeePromotion employeePromotion);
