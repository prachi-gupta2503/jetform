...
/**
 * Provides the local service utility for EmployeeGrade. This utility wraps
 * <code>com.adjecti.pis.liferay.service.impl.EmployeeGradeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeeGradeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeGradeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeeGrade addEmployeeGrade(
		com.adjecti.pis.liferay.model.EmployeeGrade employeeGrade) {

		return getService().addEmployeeGrade(employeeGrade);
	}
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeeGrade
		createEmployeeGrade(long employeeGradeId) {

		return getService().createEmployeeGrade(employeeGradeId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeGrade
		...
		return getService().deleteEmployeeGrade(employeeGrade);
	}
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeeGrade
			deleteEmployeeGrade(long employeeGradeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteEmployeeGrade(employeeGradeId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeGrade
		fetchEmployeeGrade(long employeeGradeId) {

		return getService().fetchEmployeeGrade(employeeGradeId);
	}
	 ...
	 * @throws PortalException if a employee grade with the primary key could not be found
	 */
	public static com.adjecti.pis.liferay.model.EmployeeGrade getEmployeeGrade(
			long employeeGradeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getEmployeeGrade(employeeGradeId);
	}
	...
	public static java.util.List<com.adjecti.pis.liferay.model.EmployeeGrade>
		...
		return getService().getEmployeeGrades(start, end);
	}
	 ...
	 */
	public static int getEmployeeGradesCount() {
		return getService().getEmployeeGradesCount();
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeGrade
		...
		return getService().updateEmployeeGrade(employeeGrade);
	}

	public static EmployeeGradeLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<EmployeeGradeLocalService, EmployeeGradeLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			EmployeeGradeLocalService.class);

		ServiceTracker<EmployeeGradeLocalService, EmployeeGradeLocalService>
			serviceTracker =
				new ServiceTracker
					<EmployeeGradeLocalService, EmployeeGradeLocalService>(
						bundle.getBundleContext(),
						EmployeeGradeLocalService.class, null);
