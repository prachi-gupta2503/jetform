...
/**
 * Provides the local service utility for EmployeeWorkArea. This utility wraps
 * <code>com.adjecti.pis.liferay.service.impl.EmployeeWorkAreaLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeeWorkAreaLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeWorkAreaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeeWorkArea
		addEmployeeWorkArea(
			com.adjecti.pis.liferay.model.EmployeeWorkArea employeeWorkArea) {

		return getService().addEmployeeWorkArea(employeeWorkArea);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeWorkArea
		...
		return getService().createEmployeeWorkArea(employeeWorkAreaId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeWorkArea
		...
		return getService().deleteEmployeeWorkArea(employeeWorkArea);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeWorkArea
		...
		return getService().deleteEmployeeWorkArea(employeeWorkAreaId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeWorkArea
		fetchEmployeeWorkArea(long employeeWorkAreaId) {

		return getService().fetchEmployeeWorkArea(employeeWorkAreaId);
	}

	public static java.util.List<com.adjecti.pis.liferay.model.EmployeeWorkArea>
		findByWorkAreaId(long workAreaId) {

		return getService().findByWorkAreaId(workAreaId);
	}
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeeWorkArea
			getEmployeeWorkArea(long employeeWorkAreaId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getEmployeeWorkArea(employeeWorkAreaId);
	}
	...
	public static java.util.List<com.adjecti.pis.liferay.model.EmployeeWorkArea>
		...
		return getService().getEmployeeWorkAreas(start, end);
	}
	 ...
	 */
	public static int getEmployeeWorkAreasCount() {
		return getService().getEmployeeWorkAreasCount();
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeeWorkArea
		...
		return getService().updateEmployeeWorkArea(employeeWorkArea);
	}

	public static EmployeeWorkAreaLocalService getService() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			EmployeeWorkAreaLocalService.class);
					...
					new ServiceTracker
						<EmployeeWorkAreaLocalService,
						 EmployeeWorkAreaLocalService>(
							 ...
							 EmployeeWorkAreaLocalService.class, null);
