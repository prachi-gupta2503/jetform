...
/**
 * Provides the local service utility for EmployeePromotionRequest. This utility wraps
 * <code>com.adjecti.pis.liferay.service.impl.EmployeePromotionRequestLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeePromotionRequestLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeePromotionRequestLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		addEmployeePromotionRequest(
			com.adjecti.pis.liferay.model.EmployeePromotionRequest
				employeePromotionRequest) {

		return getService().addEmployeePromotionRequest(
			employeePromotionRequest);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		...
		return getService().createEmployeePromotionRequest(
	...
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		...
		return getService().deleteEmployeePromotionRequest(
			employeePromotionRequest);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		...
		return getService().fetchEmployeePromotionRequest(
			employeePromotionRequestId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		...
		return getService().fetchEmployeePromotionRequestByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		...
		return getService().getEmployeePromotionRequest(
			employeePromotionRequestId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		...
		return getService().getEmployeePromotionRequestByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static java.util.List
		...
		return getService().getEmployeePromotionRequests(start, end);
	}
	...
	public static java.util.List
		...
		return getService().getEmployeePromotionRequestsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getEmployeePromotionRequestsCount() {
		return getService().getEmployeePromotionRequestsCount();
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePromotionRequest
		...
		return getService().updateEmployeePromotionRequest(
			employeePromotionRequest);
	}

	public static EmployeePromotionRequestLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<EmployeePromotionRequestLocalService,
		 EmployeePromotionRequestLocalService> _serviceTracker;
	...
	static {
		...
		ServiceTracker
			<EmployeePromotionRequestLocalService,
			 EmployeePromotionRequestLocalService> serviceTracker =
				new ServiceTracker
					<EmployeePromotionRequestLocalService,
					 EmployeePromotionRequestLocalService>(
						 bundle.getBundleContext(),
						 EmployeePromotionRequestLocalService.class, null);
