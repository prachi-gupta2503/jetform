...
/**
 * Provides the local service utility for EmployeePayStructure. This utility wraps
 * <code>com.adjecti.pis.liferay.service.impl.EmployeePayStructureLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeePayStructureLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeePayStructureLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.adjecti.pis.liferay.model.EmployeePayStructure
		addEmployeePayStructure(
			com.adjecti.pis.liferay.model.EmployeePayStructure
				employeePayStructure) {

		return getService().addEmployeePayStructure(employeePayStructure);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePayStructure
		...
		return getService().createEmployeePayStructure(employeePayStructureId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePayStructure
		...
		return getService().deleteEmployeePayStructure(employeePayStructure);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePayStructure
		...
		return getService().deleteEmployeePayStructure(employeePayStructureId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePayStructure
		...
		return getService().fetchEmployeePayStructure(employeePayStructureId);
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePayStructure
		...
		return getService().getEmployeePayStructure(employeePayStructureId);
	}
	...
	public static java.util.List
		...
		return getService().getEmployeePayStructures(start, end);
	}
	 ...
	 */
	public static int getEmployeePayStructuresCount() {
		return getService().getEmployeePayStructuresCount();
	}
	...
	public static com.adjecti.pis.liferay.model.EmployeePayStructure
		...
		return getService().updateEmployeePayStructure(employeePayStructure);
	}

	public static EmployeePayStructureLocalService getService() {
					...
					new ServiceTracker
						<EmployeePayStructureLocalService,
						 EmployeePayStructureLocalService>(
							 ...
							 EmployeePayStructureLocalService.class, null);
