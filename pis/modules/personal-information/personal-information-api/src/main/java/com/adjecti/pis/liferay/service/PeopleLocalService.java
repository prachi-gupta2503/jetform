...
/**
 * Provides the local service interface for People. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PeopleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PeopleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.PeopleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the people local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PeopleLocalServiceUtil} if injection and service tracking are not available.
	 */
	public People addPeople(
			...
			String fatherName_Hi, Date dateOfBirth, long genderId,
	...
	public long addPeople(People person, long employeeId)
		throws PeopleException, PortalException;
