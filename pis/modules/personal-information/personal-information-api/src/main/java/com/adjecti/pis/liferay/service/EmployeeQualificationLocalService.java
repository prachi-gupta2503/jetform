...
public interface EmployeeQualificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.pis.liferay.service.impl.EmployeeQualificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee qualification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeQualificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<EmployeeQualification> addEmployeeQualification(
			List<EmployeeQualification> empQualification)
		throws EmployeeQualificationException, PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeQualification> getEmployeeQualificationByEmployeeId(
		long employeeId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeQualification> getEmployeeQualificationByPersonalNo(
		String personalNo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeQualification>
