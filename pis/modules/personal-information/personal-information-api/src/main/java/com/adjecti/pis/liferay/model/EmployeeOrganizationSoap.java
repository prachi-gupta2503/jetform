...
/**
 * This class is used by SOAP remote services, specifically {@link com.adjecti.pis.liferay.service.http.EmployeeOrganizationServiceSoap}.
 *
 ...
 */
@Deprecated
public class EmployeeOrganizationSoap implements Serializable {

	public static EmployeeOrganizationSoap toSoapModel(
		EmployeeOrganization model) {

		EmployeeOrganizationSoap soapModel = new EmployeeOrganizationSoap();

		soapModel.setEmployeeOrganizationId(model.getEmployeeOrganizationId());
	...
	public static EmployeeOrganizationSoap[] toSoapModels(
		EmployeeOrganization[] models) {

		EmployeeOrganizationSoap[] soapModels =
			new EmployeeOrganizationSoap[models.length];
	...
	public static EmployeeOrganizationSoap[][] toSoapModels(
		...
		EmployeeOrganizationSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels =
				new EmployeeOrganizationSoap[models.length][models[0].length];
		}
		else {
			soapModels = new EmployeeOrganizationSoap[0][0];
		}
	...
	public static EmployeeOrganizationSoap[] toSoapModels(
		List<EmployeeOrganization> models) {

		List<EmployeeOrganizationSoap> soapModels =
			new ArrayList<EmployeeOrganizationSoap>(models.size());

		for (EmployeeOrganization model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(
			new EmployeeOrganizationSoap[soapModels.size()]);
	}

	public EmployeeOrganizationSoap() {
	}
