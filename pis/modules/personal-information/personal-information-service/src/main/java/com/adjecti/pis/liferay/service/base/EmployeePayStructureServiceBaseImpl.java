...
import com.adjecti.pis.liferay.service.EmployeePayStructureService;
...
/**
 * Provides the base implementation for the employee pay structure remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePayStructureServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePayStructureServiceImpl
 * @generated
 */
public abstract class EmployeePayStructureServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeePayStructureService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePayStructureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePayStructureServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePayStructureService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeePayStructureService = (EmployeePayStructureService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePayStructureService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeePayStructureLocalService
		employeePayStructureLocalService;

	protected EmployeePayStructureService employeePayStructureService;
