...
import com.adjecti.pis.liferay.service.EmployeePastExperienceService;
...
/**
 * Provides the base implementation for the employee past experience remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePastExperienceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePastExperienceServiceImpl
 * @generated
 */
public abstract class EmployeePastExperienceServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeePastExperienceService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePastExperienceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePastExperienceServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePastExperienceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeePastExperienceService = (EmployeePastExperienceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePastExperienceService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeePastExperienceLocalService
		employeePastExperienceLocalService;

	protected EmployeePastExperienceService employeePastExperienceService;
