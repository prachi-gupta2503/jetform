...
import com.adjecti.pis.liferay.service.EmployeeTradeService;
...
/**
 * Provides the base implementation for the employee trade remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeTradeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeTradeServiceImpl
 * @generated
 */
public abstract class EmployeeTradeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeTradeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeTradeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeTradeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeTradeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeTradeService = (EmployeeTradeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeTradeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeTradeLocalService
		employeeTradeLocalService;

	protected EmployeeTradeService employeeTradeService;
