...
import com.adjecti.pis.liferay.service.ServiceRequestLocalService;
...
/**
 * Provides the base implementation for the service request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.ServiceRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.ServiceRequestLocalServiceImpl
 * @generated
 */
public abstract class ServiceRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ServiceRequestLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.ServiceRequestLocalServiceUtil</code>.
	 */
	...
	public ServiceRequest addServiceRequest(ServiceRequest serviceRequest) {
		...
		return serviceRequestPersistence.update(serviceRequest);
	}
	...
	public ServiceRequest createServiceRequest(long serviceRequestId) {
		return serviceRequestPersistence.create(serviceRequestId);
	}
	...
	@Override
	public ServiceRequest deleteServiceRequest(long serviceRequestId)
		throws PortalException {

		return serviceRequestPersistence.remove(serviceRequestId);
	}
	...
	public ServiceRequest deleteServiceRequest(ServiceRequest serviceRequest) {
		return serviceRequestPersistence.remove(serviceRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ServiceRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return serviceRequestPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return serviceRequestPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ServiceRequest fetchServiceRequest(long serviceRequestId) {
		return serviceRequestPersistence.fetchByPrimaryKey(serviceRequestId);
	}
	...
	public ServiceRequest getServiceRequest(long serviceRequestId)
		...
		return serviceRequestPersistence.findByPrimaryKey(serviceRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(serviceRequestLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ServiceRequest.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("serviceRequestId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			serviceRequestLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ServiceRequest.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return serviceRequestLocalService.deleteServiceRequest(
			(ServiceRequest)persistedModel);
	}

	public BasePersistence<ServiceRequest> getBasePersistence() {
		return serviceRequestPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return serviceRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceRequest> getServiceRequests(int start, int end) {
		return serviceRequestPersistence.findAll(start, end);
	}
	...
	public int getServiceRequestsCount() {
		return serviceRequestPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ServiceRequestLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestLocalService = (ServiceRequestLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = serviceRequestPersistence.getDataSource();
	...
	protected ServiceRequestLocalService serviceRequestLocalService;
