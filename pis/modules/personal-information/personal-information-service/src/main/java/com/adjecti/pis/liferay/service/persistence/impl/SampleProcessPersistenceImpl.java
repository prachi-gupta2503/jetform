...
import com.adjecti.pis.liferay.model.impl.SampleProcessImpl;
import com.adjecti.pis.liferay.model.impl.SampleProcessModelImpl;
...
/**
 * The persistence implementation for the sample process service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = SampleProcessPersistence.class)
public class SampleProcessPersistenceImpl
	extends BasePersistenceImpl<SampleProcess>
	implements SampleProcessPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>SampleProcessUtil</code> to access the sample process persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		SampleProcessImpl.class.getName();
	 ...
	 */
	@Override
	public List<SampleProcess> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<SampleProcess> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<SampleProcess> findByUuid(
	...
	public List<SampleProcess> findByUuid(
		...
		if (useFinderCache) {
			list = (List<SampleProcess>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (SampleProcess sampleProcess : list) {
					if (!uuid.equals(sampleProcess.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_SAMPLEPROCESS_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(SampleProcessModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<SampleProcess>)QueryUtil.list(
	...
	public SampleProcess findByUuid_First(
		...
		SampleProcess sampleProcess = fetchByUuid_First(
		...
		throw new NoSuchSampleProcessException(sb.toString());
	}
	...
	public SampleProcess fetchByUuid_First(
		...
		List<SampleProcess> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public SampleProcess findByUuid_Last(
		...
		SampleProcess sampleProcess = fetchByUuid_Last(uuid, orderByComparator);
	...
	public SampleProcess fetchByUuid_Last(
		...
		List<SampleProcess> list = findByUuid(
	...
	public SampleProcess[] findByUuid_PrevAndNext(
		...
		SampleProcess sampleProcess = findByPrimaryKey(sampleProcessId);
		...
		try {
			...
			SampleProcess[] array = new SampleProcessImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, sampleProcess, uuid, orderByComparator, true);

			array[1] = sampleProcess;

			array[2] = getByUuid_PrevAndNext(
				session, sampleProcess, uuid, orderByComparator, false);
	...
	protected SampleProcess getByUuid_PrevAndNext(
		Session session, SampleProcess sampleProcess, String uuid,
		OrderByComparator<SampleProcess> orderByComparator, boolean previous) {
		...
		List<SampleProcess> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (SampleProcess sampleProcess :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(sampleProcess);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_SAMPLEPROCESS_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(sampleProcess.uuid IS NULL OR sampleProcess.uuid = '')";
	...
	public SampleProcess findByUUID_G(String uuid, long groupId)
		...
		SampleProcess sampleProcess = fetchByUUID_G(uuid, groupId);
	...
	public SampleProcess fetchByUUID_G(
		...
		if (result instanceof SampleProcess) {
			SampleProcess sampleProcess = (SampleProcess)result;

			if (!Objects.equals(uuid, sampleProcess.getUuid()) ||
				(groupId != sampleProcess.getGroupId())) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					SampleProcess sampleProcess = list.get(0);

					result = sampleProcess;

					cacheResult(sampleProcess);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
	...
	public SampleProcess removeByUUID_G(String uuid, long groupId)
		...
		SampleProcess sampleProcess = findByUUID_G(uuid, groupId);

		return remove(sampleProcess);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"sampleProcess.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(sampleProcess.uuid IS NULL OR sampleProcess.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"sampleProcess.groupId = ?";
	 ...
	 */
	@Override
	public List<SampleProcess> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<SampleProcess> findByUuid_C(
	...
	public List<SampleProcess> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (SampleProcess sampleProcess : list) {
					if (!uuid.equals(sampleProcess.getUuid()) ||
						(companyId != sampleProcess.getCompanyId())) {
	...
	public SampleProcess findByUuid_C_First(
		...
		SampleProcess sampleProcess = fetchByUuid_C_First(
	...
	public SampleProcess fetchByUuid_C_First(
		...
		List<SampleProcess> list = findByUuid_C(
	...
	public SampleProcess findByUuid_C_Last(
		...
		SampleProcess sampleProcess = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public SampleProcess[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, sampleProcess, uuid, companyId, orderByComparator,
				true);
	...
	protected SampleProcess getByUuid_C_PrevAndNext(
		Session session, SampleProcess sampleProcess, String uuid,
		long companyId, OrderByComparator<SampleProcess> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public List<SampleProcess> findByReviewerUserId(long reviewerUserId) {
	 ...
	 */
	@Override
	public List<SampleProcess> findByReviewerUserId(
	...
	public List<SampleProcess> findByReviewerUserId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (SampleProcess sampleProcess : list) {
					if (reviewerUserId != sampleProcess.getReviewerUserId()) {
						list = null;
	...
	public SampleProcess findByReviewerUserId_First(
		...
		SampleProcess sampleProcess = fetchByReviewerUserId_First(
	...
	public SampleProcess fetchByReviewerUserId_First(
		...
		List<SampleProcess> list = findByReviewerUserId(
	...
	public SampleProcess findByReviewerUserId_Last(
		...
		SampleProcess sampleProcess = fetchByReviewerUserId_Last(
			reviewerUserId, orderByComparator);
	...
	public SampleProcess[] findByReviewerUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByReviewerUserId_PrevAndNext(
				session, sampleProcess, reviewerUserId, orderByComparator,
				true);
	...
	protected SampleProcess getByReviewerUserId_PrevAndNext(
		Session session, SampleProcess sampleProcess, long reviewerUserId,
		OrderByComparator<SampleProcess> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<SampleProcess> findByApproverUserId(long approverUserId) {
	 ...
	 */
	@Override
	public List<SampleProcess> findByApproverUserId(
	...
	public List<SampleProcess> findByApproverUserId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (SampleProcess sampleProcess : list) {
					if (approverUserId != sampleProcess.getApproverUserId()) {
						list = null;
	...
	public SampleProcess findByApproverUserId_First(
		...
		SampleProcess sampleProcess = fetchByApproverUserId_First(
	...
	public SampleProcess fetchByApproverUserId_First(
		...
		List<SampleProcess> list = findByApproverUserId(
	...
	public SampleProcess findByApproverUserId_Last(
		...
		SampleProcess sampleProcess = fetchByApproverUserId_Last(
			approverUserId, orderByComparator);
	...
	public SampleProcess[] findByApproverUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByApproverUserId_PrevAndNext(
				session, sampleProcess, approverUserId, orderByComparator,
				true);
	...
	protected SampleProcess getByApproverUserId_PrevAndNext(
		Session session, SampleProcess sampleProcess, long approverUserId,
		OrderByComparator<SampleProcess> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_APPROVERUSERID_APPROVERUSERID_2 =
		"sampleProcess.approverUserId = ?";

	public SampleProcessPersistenceImpl() {
		...
		setModelClass(SampleProcess.class);

		setModelImplClass(SampleProcessImpl.class);
	...
	public void cacheResult(SampleProcess sampleProcess) {
		entityCache.putResult(
			SampleProcessImpl.class, sampleProcess.getPrimaryKey(),
			sampleProcess);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {sampleProcess.getUuid(), sampleProcess.getGroupId()},
			sampleProcess);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<SampleProcess> sampleProcesses) {
		for (SampleProcess sampleProcess : sampleProcesses) {
	...
	/**
	 * Clears the cache for all sample processes.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(SampleProcessImpl.class);
	...
	/**
	 * Clears the cache for the sample process.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(SampleProcess sampleProcess) {
		entityCache.removeResult(SampleProcessImpl.class, sampleProcess);
	}

	@Override
	public void clearCache(List<SampleProcess> sampleProcesses) {
		for (SampleProcess sampleProcess : sampleProcesses) {
			entityCache.removeResult(SampleProcessImpl.class, sampleProcess);
		}
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(SampleProcessImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		SampleProcessModelImpl sampleProcessModelImpl) {

		Object[] args = new Object[] {
			sampleProcessModelImpl.getUuid(),
			sampleProcessModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathCountByUUID_G, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, sampleProcessModelImpl, false);
	}
	...
	public SampleProcess create(long sampleProcessId) {
		SampleProcess sampleProcess = new SampleProcessImpl();

		sampleProcess.setNew(true);
		sampleProcess.setPrimaryKey(sampleProcessId);

		String uuid = PortalUUIDUtil.generate();

		sampleProcess.setUuid(uuid);

		sampleProcess.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public SampleProcess remove(long sampleProcessId)
		...
		return remove((Serializable)sampleProcessId);
	}

	/**
	 * Removes the sample process with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the sample process
	 * @return the sample process that was removed
	 * @throws NoSuchSampleProcessException if a sample process with the primary key could not be found
	 */
	@Override
	public SampleProcess remove(Serializable primaryKey)
		throws NoSuchSampleProcessException {
		...
		try {
			...
			SampleProcess sampleProcess = (SampleProcess)session.get(
				SampleProcessImpl.class, primaryKey);
			...
			if (sampleProcess == null) {
				...
				throw new NoSuchSampleProcessException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(sampleProcess);
		}
		catch (NoSuchSampleProcessException noSuchEntityException) {
	...
	@Override
	protected SampleProcess removeImpl(SampleProcess sampleProcess) {
		Session session = null;

		try {
			session = openSession();

			if (!session.contains(sampleProcess)) {
				sampleProcess = (SampleProcess)session.get(
					SampleProcessImpl.class, sampleProcess.getPrimaryKeyObj());
			}

			if (sampleProcess != null) {
				session.delete(sampleProcess);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
	...
	public SampleProcess updateImpl(SampleProcess sampleProcess) {
		boolean isNew = sampleProcess.isNew();

		if (!(sampleProcess instanceof SampleProcessModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(sampleProcess.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					sampleProcess);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in sampleProcess proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom SampleProcess implementation " +
					sampleProcess.getClass());
		}

		SampleProcessModelImpl sampleProcessModelImpl =
			(SampleProcessModelImpl)sampleProcess;

		if (Validator.isNull(sampleProcess.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (sampleProcess.getCreateDate() == null)) {
			if (serviceContext == null) {
				sampleProcess.setCreateDate(now);
			}
			else {
				sampleProcess.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!sampleProcessModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				sampleProcess.setModifiedDate(now);
			}
			else {
				sampleProcess.setModifiedDate(
		...
		try {
			...
			if (isNew) {
				session.save(sampleProcess);
			}
			else {
				sampleProcess = (SampleProcess)session.merge(sampleProcess);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		entityCache.putResult(
			SampleProcessImpl.class, sampleProcessModelImpl, false, true);

		cacheUniqueFindersCache(sampleProcessModelImpl);

		if (isNew) {
			sampleProcess.setNew(false);
		}

		sampleProcess.resetOriginalValues();

		return sampleProcess;
	}

	/**
	 * Returns the sample process with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the sample process
	 ...
	 */
	@Override
	public SampleProcess findByPrimaryKey(Serializable primaryKey)
		throws NoSuchSampleProcessException {

		SampleProcess sampleProcess = fetchByPrimaryKey(primaryKey);
	...
	public SampleProcess findByPrimaryKey(long sampleProcessId)
		...
		return findByPrimaryKey((Serializable)sampleProcessId);
	}
	...
	public SampleProcess fetchByPrimaryKey(long sampleProcessId) {
		return fetchByPrimaryKey((Serializable)sampleProcessId);
	}
	 ...
	 */
	@Override
	public List<SampleProcess> findAll() {
	 ...
	 */
	@Override
	public List<SampleProcess> findAll(int start, int end) {
	...
	public List<SampleProcess> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_SAMPLEPROCESS);
				...
				sql = _SQL_SELECT_SAMPLEPROCESS;

				sql = sql.concat(SampleProcessModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (SampleProcess sampleProcess : findAll()) {
			remove(sampleProcess);
		}
	}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_SAMPLEPROCESS);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_SAMPLEPROCESS;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return SampleProcessModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the sample process persistence.
	 */
	@Activate
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new SampleProcessModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", SampleProcess.class.getName()));
	...
	public void deactivate() {
		entityCache.removeCache(SampleProcessImpl.class.getName());
	...
	private static final String _SQL_SELECT_SAMPLEPROCESS =
		"SELECT sampleProcess FROM SampleProcess sampleProcess";

	private static final String _SQL_SELECT_SAMPLEPROCESS_WHERE =
		"SELECT sampleProcess FROM SampleProcess sampleProcess WHERE ";

	private static final String _SQL_COUNT_SAMPLEPROCESS =
		"SELECT COUNT(sampleProcess) FROM SampleProcess sampleProcess";

	private static final String _SQL_COUNT_SAMPLEPROCESS_WHERE =
		"SELECT COUNT(sampleProcess) FROM SampleProcess sampleProcess WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "sampleProcess.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No SampleProcess exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No SampleProcess exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		SampleProcessPersistenceImpl.class);
	...
	private static class SampleProcessModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			SampleProcessModelImpl sampleProcessModelImpl =
				(SampleProcessModelImpl)baseModel;

			long columnBitmask = sampleProcessModelImpl.getColumnBitmask();

			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(sampleProcessModelImpl, columnNames, original);
			}
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						sampleProcessModelImpl.getColumnBitmask(columnName);
				}
		...
		private Object[] _getValue(
			SampleProcessModelImpl sampleProcessModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						sampleProcessModelImpl.getColumnOriginalValue(
							columnName);
				}
				else {
					arguments[i] = sampleProcessModelImpl.getColumnValue(
						columnName);
				}
			}
