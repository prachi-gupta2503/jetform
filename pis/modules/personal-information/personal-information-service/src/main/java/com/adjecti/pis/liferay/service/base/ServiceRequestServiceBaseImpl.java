...
import com.adjecti.pis.liferay.service.ServiceRequestService;
...
/**
 * Provides the base implementation for the service request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.ServiceRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.ServiceRequestServiceImpl
 * @generated
 */
public abstract class ServiceRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ServiceRequestService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.ServiceRequestServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ServiceRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		serviceRequestService = (ServiceRequestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.ServiceRequestLocalService
