...
import com.adjecti.pis.liferay.service.FamilyBenefitSchemeLocalService;
...
/**
 * Provides the base implementation for the family benefit scheme local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyBenefitSchemeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyBenefitSchemeLocalServiceImpl
 * @generated
 */
public abstract class FamilyBenefitSchemeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FamilyBenefitSchemeLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyBenefitSchemeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyBenefitSchemeLocalServiceUtil</code>.
	 */
	...
	public FamilyBenefitScheme addFamilyBenefitScheme(
		...
		return familyBenefitSchemePersistence.update(familyBenefitScheme);
	}
	...
	public FamilyBenefitScheme createFamilyBenefitScheme(
		...
		return familyBenefitSchemePersistence.create(familyBenefitSchemeId);
	}
	...
	public FamilyBenefitScheme deleteFamilyBenefitScheme(
		...
		return familyBenefitSchemePersistence.remove(familyBenefitSchemeId);
	}
	...
	public FamilyBenefitScheme deleteFamilyBenefitScheme(
		...
		return familyBenefitSchemePersistence.remove(familyBenefitScheme);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FamilyBenefitScheme.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return familyBenefitSchemePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return familyBenefitSchemePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FamilyBenefitScheme fetchFamilyBenefitScheme(
		...
		return familyBenefitSchemePersistence.fetchByPrimaryKey(
	...
	public FamilyBenefitScheme getFamilyBenefitScheme(
		...
		return familyBenefitSchemePersistence.findByPrimaryKey(
			familyBenefitSchemeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			familyBenefitSchemeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FamilyBenefitScheme.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return familyBenefitSchemePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return familyBenefitSchemeLocalService.deleteFamilyBenefitScheme(
			(FamilyBenefitScheme)persistedModel);
	}

	public BasePersistence<FamilyBenefitScheme> getBasePersistence() {
		return familyBenefitSchemePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return familyBenefitSchemePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FamilyBenefitScheme> getFamilyBenefitSchemes(
		...
		return familyBenefitSchemePersistence.findAll(start, end);
	}
	...
	public int getFamilyBenefitSchemesCount() {
		return familyBenefitSchemePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyBenefitSchemeLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		familyBenefitSchemeLocalService =
			(FamilyBenefitSchemeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyBenefitSchemeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				familyBenefitSchemePersistence.getDataSource();
	...
	protected FamilyBenefitSchemeLocalService familyBenefitSchemeLocalService;
