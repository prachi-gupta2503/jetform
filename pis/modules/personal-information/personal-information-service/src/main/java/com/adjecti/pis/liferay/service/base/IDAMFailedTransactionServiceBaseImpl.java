...
import com.adjecti.pis.liferay.service.IDAMFailedTransactionService;
...
/**
 * Provides the base implementation for the idam failed transaction remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.IDAMFailedTransactionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.IDAMFailedTransactionServiceImpl
 * @generated
 */
public abstract class IDAMFailedTransactionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IDAMFailedTransactionService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IDAMFailedTransactionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.IDAMFailedTransactionServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IDAMFailedTransactionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		idamFailedTransactionService = (IDAMFailedTransactionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return IDAMFailedTransactionService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.IDAMFailedTransactionLocalService
		idamFailedTransactionLocalService;

	protected IDAMFailedTransactionService idamFailedTransactionService;
