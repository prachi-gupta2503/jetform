...
import com.adjecti.pis.liferay.service.JoiningProcessLocalService;
...
/**
 * Provides the base implementation for the joining process local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.JoiningProcessLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.JoiningProcessLocalServiceImpl
 * @generated
 */
public abstract class JoiningProcessLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, JoiningProcessLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JoiningProcessLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.JoiningProcessLocalServiceUtil</code>.
	 */
	...
	@Override
	public JoiningProcess addJoiningProcess(JoiningProcess joiningProcess) {
		joiningProcess.setNew(true);

		return joiningProcessPersistence.update(joiningProcess);
	}
	...
	public JoiningProcess createJoiningProcess(long joiningProcessId) {
		return joiningProcessPersistence.create(joiningProcessId);
	}
	...
	@Override
	public JoiningProcess deleteJoiningProcess(long joiningProcessId)
		throws PortalException {

		return joiningProcessPersistence.remove(joiningProcessId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JoiningProcess deleteJoiningProcess(JoiningProcess joiningProcess) {
		return joiningProcessPersistence.remove(joiningProcess);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JoiningProcess.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return joiningProcessPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return joiningProcessPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return joiningProcessPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return joiningProcessPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public JoiningProcess fetchJoiningProcess(long joiningProcessId) {
		return joiningProcessPersistence.fetchByPrimaryKey(joiningProcessId);
	}
	 ...
	 */
	@Override
	public JoiningProcess fetchJoiningProcessByUuidAndGroupId(
		String uuid, long groupId) {

		return joiningProcessPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public JoiningProcess getJoiningProcess(long joiningProcessId)
		throws PortalException {

		return joiningProcessPersistence.findByPrimaryKey(joiningProcessId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(joiningProcessLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(JoiningProcess.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("joiningProcessId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			joiningProcessLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(JoiningProcess.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<JoiningProcess>() {

				@Override
				public void performAction(JoiningProcess joiningProcess)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, joiningProcess);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return joiningProcessPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return joiningProcessLocalService.deleteJoiningProcess(
			(JoiningProcess)persistedModel);
	}

	public BasePersistence<JoiningProcess> getBasePersistence() {
		return joiningProcessPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return joiningProcessPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JoiningProcess> getJoiningProcessesByUuidAndCompanyId(
		String uuid, long companyId) {

		return joiningProcessPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<JoiningProcess> getJoiningProcessesByUuidAndCompanyId(
		...
		return joiningProcessPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public JoiningProcess getJoiningProcessByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return joiningProcessPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<JoiningProcess> getJoiningProcesses(int start, int end) {
		return joiningProcessPersistence.findAll(start, end);
	}
	...
	public int getJoiningProcessesCount() {
		return joiningProcessPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JoiningProcess updateJoiningProcess(JoiningProcess joiningProcess) {
		return joiningProcessPersistence.update(joiningProcess);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JoiningProcessLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		joiningProcessLocalService = (JoiningProcessLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JoiningProcessLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = joiningProcessPersistence.getDataSource();
	...
	protected JoiningProcessLocalService joiningProcessLocalService;
