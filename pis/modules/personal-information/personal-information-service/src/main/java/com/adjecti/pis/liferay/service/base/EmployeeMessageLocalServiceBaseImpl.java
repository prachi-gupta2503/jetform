...
import com.adjecti.pis.liferay.service.EmployeeMessageLocalService;
...
/**
 * Provides the base implementation for the employee message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeMessageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeMessageLocalServiceImpl
 * @generated
 */
public abstract class EmployeeMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeMessageLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeMessageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeMessageLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeMessage addEmployeeMessage(EmployeeMessage employeeMessage) {
		employeeMessage.setNew(true);

		return employeeMessagePersistence.update(employeeMessage);
	}
	...
	public EmployeeMessage createEmployeeMessage(long employeeMessageId) {
		return employeeMessagePersistence.create(employeeMessageId);
	}
	...
	@Override
	public EmployeeMessage deleteEmployeeMessage(long employeeMessageId)
		throws PortalException {

		return employeeMessagePersistence.remove(employeeMessageId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeMessage deleteEmployeeMessage(
		EmployeeMessage employeeMessage) {

		return employeeMessagePersistence.remove(employeeMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeMessage.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeMessagePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeMessagePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeMessage fetchEmployeeMessage(long employeeMessageId) {
		return employeeMessagePersistence.fetchByPrimaryKey(employeeMessageId);
	}
	 ...
	 */
	@Override
	public EmployeeMessage getEmployeeMessage(long employeeMessageId)
		throws PortalException {

		return employeeMessagePersistence.findByPrimaryKey(employeeMessageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeMessageLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeMessage.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeMessageId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeMessageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeMessage.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeMessagePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeMessageLocalService.deleteEmployeeMessage(
			(EmployeeMessage)persistedModel);
	}

	public BasePersistence<EmployeeMessage> getBasePersistence() {
		return employeeMessagePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeMessage> getEmployeeMessages(int start, int end) {
		return employeeMessagePersistence.findAll(start, end);
	}
	...
	public int getEmployeeMessagesCount() {
		return employeeMessagePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeMessage updateEmployeeMessage(
		EmployeeMessage employeeMessage) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeMessageLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeMessageLocalService = (EmployeeMessageLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeMessageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeMessagePersistence.getDataSource();
	...
	protected EmployeeMessageLocalService employeeMessageLocalService;
