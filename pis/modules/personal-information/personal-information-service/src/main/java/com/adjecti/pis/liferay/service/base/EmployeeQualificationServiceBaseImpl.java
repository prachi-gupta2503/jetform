...
import com.adjecti.pis.liferay.service.EmployeeQualificationService;
...
/**
 * Provides the base implementation for the employee qualification remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeQualificationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeQualificationServiceImpl
 * @generated
 */
public abstract class EmployeeQualificationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeQualificationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeQualificationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeQualificationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeQualificationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeQualificationService = (EmployeeQualificationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeQualificationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeQualificationLocalService
		employeeQualificationLocalService;

	protected EmployeeQualificationService employeeQualificationService;
