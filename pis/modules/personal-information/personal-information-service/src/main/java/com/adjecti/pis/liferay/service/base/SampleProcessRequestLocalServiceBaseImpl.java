...
import com.adjecti.pis.liferay.service.SampleProcessRequestLocalService;
...
/**
 * Provides the base implementation for the sample process request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.SampleProcessRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.SampleProcessRequestLocalServiceImpl
 * @generated
 */
public abstract class SampleProcessRequestLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SampleProcessRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.SampleProcessRequestLocalServiceUtil</code>.
	 */
	...
	public SampleProcessRequest addSampleProcessRequest(
		...
		return sampleProcessRequestPersistence.update(sampleProcessRequest);
	}
	...
	public SampleProcessRequest createSampleProcessRequest(
		...
		return sampleProcessRequestPersistence.create(sampleProcessRequestId);
	}
	...
	public SampleProcessRequest deleteSampleProcessRequest(
		...
		return sampleProcessRequestPersistence.remove(sampleProcessRequestId);
	}
	...
	public SampleProcessRequest deleteSampleProcessRequest(
		...
		return sampleProcessRequestPersistence.remove(sampleProcessRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SampleProcessRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sampleProcessRequestPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sampleProcessRequestPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SampleProcessRequest fetchSampleProcessRequest(
		...
		return sampleProcessRequestPersistence.fetchByPrimaryKey(
	...
	public SampleProcessRequest fetchSampleProcessRequestByUuidAndGroupId(
		...
		return sampleProcessRequestPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public SampleProcessRequest getSampleProcessRequest(
		...
		return sampleProcessRequestPersistence.findByPrimaryKey(
			sampleProcessRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SampleProcessRequest.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, sampleProcessRequest);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					SampleProcessRequest.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sampleProcessRequestPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return sampleProcessRequestLocalService.deleteSampleProcessRequest(
			(SampleProcessRequest)persistedModel);
	}

	public BasePersistence<SampleProcessRequest> getBasePersistence() {
		return sampleProcessRequestPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sampleProcessRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SampleProcessRequest>
		...
		return sampleProcessRequestPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<SampleProcessRequest>
		...
		return sampleProcessRequestPersistence.findByUuid_C(
	...
	public SampleProcessRequest getSampleProcessRequestByUuidAndGroupId(
		...
		return sampleProcessRequestPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<SampleProcessRequest> getSampleProcessRequests(
		...
		return sampleProcessRequestPersistence.findAll(start, end);
	}
	...
	public int getSampleProcessRequestsCount() {
		return sampleProcessRequestPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sampleProcessRequestLocalService =
			(SampleProcessRequestLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SampleProcessRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sampleProcessRequestPersistence.getDataSource();
	...
	protected SampleProcessRequestLocalService sampleProcessRequestLocalService;
