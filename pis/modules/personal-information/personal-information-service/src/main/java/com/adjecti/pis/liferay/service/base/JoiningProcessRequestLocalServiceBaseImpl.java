...
import com.adjecti.pis.liferay.service.JoiningProcessRequestLocalService;
...
/**
 * Provides the base implementation for the joining process request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.JoiningProcessRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.JoiningProcessRequestLocalServiceImpl
 * @generated
 */
public abstract class JoiningProcessRequestLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JoiningProcessRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.JoiningProcessRequestLocalServiceUtil</code>.
	 */
	...
	public JoiningProcessRequest addJoiningProcessRequest(
		...
		return joiningProcessRequestPersistence.update(joiningProcessRequest);
	}
	...
	public JoiningProcessRequest createJoiningProcessRequest(
		...
		return joiningProcessRequestPersistence.create(joiningProcessRequestId);
	}
	...
	public JoiningProcessRequest deleteJoiningProcessRequest(
		...
		return joiningProcessRequestPersistence.remove(joiningProcessRequestId);
	}
	...
	public JoiningProcessRequest deleteJoiningProcessRequest(
		...
		return joiningProcessRequestPersistence.remove(joiningProcessRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JoiningProcessRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return joiningProcessRequestPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return joiningProcessRequestPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public JoiningProcessRequest fetchJoiningProcessRequest(
		...
		return joiningProcessRequestPersistence.fetchByPrimaryKey(
	...
	public JoiningProcessRequest fetchJoiningProcessRequestByUuidAndGroupId(
		...
		return joiningProcessRequestPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public JoiningProcessRequest getJoiningProcessRequest(
		...
		return joiningProcessRequestPersistence.findByPrimaryKey(
			joiningProcessRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(JoiningProcessRequest.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, joiningProcessRequest);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					JoiningProcessRequest.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return joiningProcessRequestPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return joiningProcessRequestLocalService.deleteJoiningProcessRequest(
			(JoiningProcessRequest)persistedModel);
	}

	public BasePersistence<JoiningProcessRequest> getBasePersistence() {
		return joiningProcessRequestPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return joiningProcessRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<JoiningProcessRequest>
		...
		return joiningProcessRequestPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<JoiningProcessRequest>
		...
		return joiningProcessRequestPersistence.findByUuid_C(
	...
	public JoiningProcessRequest getJoiningProcessRequestByUuidAndGroupId(
		...
		return joiningProcessRequestPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<JoiningProcessRequest> getJoiningProcessRequests(
		...
		return joiningProcessRequestPersistence.findAll(start, end);
	}
	...
	public int getJoiningProcessRequestsCount() {
		return joiningProcessRequestPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		joiningProcessRequestLocalService =
			(JoiningProcessRequestLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JoiningProcessRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				joiningProcessRequestPersistence.getDataSource();
	...
	protected JoiningProcessRequestLocalService
		joiningProcessRequestLocalService;
