...
import com.adjecti.pis.liferay.service.EmployeeFamilyService;
...
/**
 * Provides the base implementation for the employee family remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeFamilyServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeFamilyServiceImpl
 * @generated
 */
public abstract class EmployeeFamilyServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeFamilyService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeFamilyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeFamilyServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeFamilyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeFamilyService = (EmployeeFamilyService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeFamilyService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeFamilyLocalService
		employeeFamilyLocalService;

	protected EmployeeFamilyService employeeFamilyService;
