...
import com.adjecti.pis.liferay.service.EmployeeBiodataLocalService;
...
/**
 * Provides the base implementation for the employee biodata local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeBiodataLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeBiodataLocalServiceImpl
 * @generated
 */
public abstract class EmployeeBiodataLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeBiodataLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeBiodataLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeBiodataLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeBiodata addEmployeeBiodata(EmployeeBiodata employeeBiodata) {
		employeeBiodata.setNew(true);

		return employeeBiodataPersistence.update(employeeBiodata);
	}
	...
	public EmployeeBiodata createEmployeeBiodata(long employeeBiodataId) {
		return employeeBiodataPersistence.create(employeeBiodataId);
	}
	...
	@Override
	public EmployeeBiodata deleteEmployeeBiodata(long employeeBiodataId)
		throws PortalException {

		return employeeBiodataPersistence.remove(employeeBiodataId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeBiodata deleteEmployeeBiodata(
		EmployeeBiodata employeeBiodata) {

		return employeeBiodataPersistence.remove(employeeBiodata);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeBiodata.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeBiodataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeBiodataPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeBiodataPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeBiodataPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeBiodata fetchEmployeeBiodata(long employeeBiodataId) {
		return employeeBiodataPersistence.fetchByPrimaryKey(employeeBiodataId);
	}
	 ...
	 */
	@Override
	public EmployeeBiodata getEmployeeBiodata(long employeeBiodataId)
		throws PortalException {

		return employeeBiodataPersistence.findByPrimaryKey(employeeBiodataId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeBiodataLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeBiodata.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeBiodataId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeBiodataLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeBiodata.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeBiodataPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeBiodataLocalService.deleteEmployeeBiodata(
			(EmployeeBiodata)persistedModel);
	}

	public BasePersistence<EmployeeBiodata> getBasePersistence() {
		return employeeBiodataPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeBiodataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeBiodata> getEmployeeBiodatas(int start, int end) {
		return employeeBiodataPersistence.findAll(start, end);
	}
	...
	public int getEmployeeBiodatasCount() {
		return employeeBiodataPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeBiodata updateEmployeeBiodata(
		EmployeeBiodata employeeBiodata) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeBiodataLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeBiodataLocalService = (EmployeeBiodataLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeBiodataLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return EmployeeBiodata.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeBiodataPersistence.getDataSource();
	...
	protected EmployeeBiodataLocalService employeeBiodataLocalService;
