...
import com.adjecti.pis.liferay.service.SampleProcessRequestService;
...
/**
 * Provides the base implementation for the sample process request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.SampleProcessRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.SampleProcessRequestServiceImpl
 * @generated
 */
public abstract class SampleProcessRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   SampleProcessRequestService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SampleProcessRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.SampleProcessRequestServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SampleProcessRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sampleProcessRequestService = (SampleProcessRequestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SampleProcessRequestService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.SampleProcessRequestLocalService
		sampleProcessRequestLocalService;

	protected SampleProcessRequestService sampleProcessRequestService;
