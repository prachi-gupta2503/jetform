...
import com.adjecti.pis.liferay.service.EmployeeWorkstationLocalService;
...
/**
 * Provides the base implementation for the employee workstation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeWorkstationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeWorkstationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeWorkstationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeWorkstationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeWorkstationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeWorkstationLocalServiceUtil</code>.
	 */
	...
	public EmployeeWorkstation addEmployeeWorkstation(
		...
		return employeeWorkstationPersistence.update(employeeWorkstation);
	}
	...
	public EmployeeWorkstation createEmployeeWorkstation(
		...
		return employeeWorkstationPersistence.create(employeeWorkstationId);
	}
	...
	public EmployeeWorkstation deleteEmployeeWorkstation(
		...
		return employeeWorkstationPersistence.remove(employeeWorkstationId);
	}
	...
	public EmployeeWorkstation deleteEmployeeWorkstation(
		...
		return employeeWorkstationPersistence.remove(employeeWorkstation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeWorkstation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeWorkstationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeWorkstationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EmployeeWorkstation fetchEmployeeWorkstation(
		...
		return employeeWorkstationPersistence.fetchByPrimaryKey(
	...
	public EmployeeWorkstation getEmployeeWorkstation(
		...
		return employeeWorkstationPersistence.findByPrimaryKey(
			employeeWorkstationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			employeeWorkstationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeWorkstation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeWorkstationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeWorkstationLocalService.deleteEmployeeWorkstation(
			(EmployeeWorkstation)persistedModel);
	}

	public BasePersistence<EmployeeWorkstation> getBasePersistence() {
		return employeeWorkstationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeWorkstationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EmployeeWorkstation> getEmployeeWorkstations(
		...
		return employeeWorkstationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeWorkstationsCount() {
		return employeeWorkstationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeWorkstationLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeWorkstationLocalService =
			(EmployeeWorkstationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeWorkstationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeWorkstationPersistence.getDataSource();
	...
	protected EmployeeWorkstationLocalService employeeWorkstationLocalService;
