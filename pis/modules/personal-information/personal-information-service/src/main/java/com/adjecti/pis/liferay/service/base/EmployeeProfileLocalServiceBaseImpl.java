...
import com.adjecti.pis.liferay.service.EmployeeProfileLocalService;
...
/**
 * Provides the base implementation for the employee profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeProfileLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeProfileLocalServiceImpl
 * @generated
 */
public abstract class EmployeeProfileLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeProfileLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeProfileLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeProfileLocalServiceUtil</code>.
	 */
	...
	public EmployeeProfile addEmployeeProfile(EmployeeProfile employeeProfile) {
		...
		return employeeProfilePersistence.update(employeeProfile);
	}
	...
	public EmployeeProfile createEmployeeProfile(long employeeProfileId) {
		return employeeProfilePersistence.create(employeeProfileId);
	}
	...
	@Override
	public EmployeeProfile deleteEmployeeProfile(long employeeProfileId)
		throws PortalException {

		return employeeProfilePersistence.remove(employeeProfileId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeProfile deleteEmployeeProfile(
		EmployeeProfile employeeProfile) {

		return employeeProfilePersistence.remove(employeeProfile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeProfile.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeProfilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeProfilePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeProfilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeProfilePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeProfile fetchEmployeeProfile(long employeeProfileId) {
		return employeeProfilePersistence.fetchByPrimaryKey(employeeProfileId);
	}
	 ...
	 */
	@Override
	public EmployeeProfile getEmployeeProfile(long employeeProfileId)
		throws PortalException {

		return employeeProfilePersistence.findByPrimaryKey(employeeProfileId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeProfileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeProfile.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeProfileId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeProfileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeProfile.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeProfilePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeProfileLocalService.deleteEmployeeProfile(
			(EmployeeProfile)persistedModel);
	}

	public BasePersistence<EmployeeProfile> getBasePersistence() {
		return employeeProfilePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeProfilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeProfile> getEmployeeProfiles(int start, int end) {
		return employeeProfilePersistence.findAll(start, end);
	}
	...
	public int getEmployeeProfilesCount() {
		return employeeProfilePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeProfileLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeProfileLocalService = (EmployeeProfileLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeProfileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeProfilePersistence.getDataSource();
	...
	protected EmployeeProfileLocalService employeeProfileLocalService;
