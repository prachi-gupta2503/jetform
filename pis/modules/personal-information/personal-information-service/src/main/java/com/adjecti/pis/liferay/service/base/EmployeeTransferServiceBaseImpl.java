...
import com.adjecti.pis.liferay.service.EmployeeTransferService;
...
/**
 * Provides the base implementation for the employee transfer remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeTransferServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeTransferServiceImpl
 * @generated
 */
public abstract class EmployeeTransferServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeTransferService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeTransferService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeTransferServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeTransferService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeTransferService = (EmployeeTransferService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeTransferService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeTransferLocalService
		employeeTransferLocalService;

	protected EmployeeTransferService employeeTransferService;
