...
import com.adjecti.pis.liferay.service.EmployeeJoiningLocalService;
...
/**
 * Provides the base implementation for the employee joining local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeJoiningLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeJoiningLocalServiceImpl
 * @generated
 */
public abstract class EmployeeJoiningLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeJoiningLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeJoiningLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeJoiningLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeJoining addEmployeeJoining(EmployeeJoining employeeJoining) {
	...
	public EmployeeJoining createEmployeeJoining(long employeeJoiningId) {
		return employeeJoiningPersistence.create(employeeJoiningId);
	}
	...
	@Override
	public EmployeeJoining deleteEmployeeJoining(long employeeJoiningId)
		throws PortalException {

		return employeeJoiningPersistence.remove(employeeJoiningId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeJoining deleteEmployeeJoining(
		EmployeeJoining employeeJoining) {

		return employeeJoiningPersistence.remove(employeeJoining);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeJoining.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeJoiningPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeJoiningPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeJoiningPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeJoiningPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeJoining fetchEmployeeJoining(long employeeJoiningId) {
		return employeeJoiningPersistence.fetchByPrimaryKey(employeeJoiningId);
	}
	 ...
	 */
	@Override
	public EmployeeJoining getEmployeeJoining(long employeeJoiningId)
		throws PortalException {

		return employeeJoiningPersistence.findByPrimaryKey(employeeJoiningId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeJoiningLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeJoining.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeJoiningId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeJoiningLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeJoining.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeJoiningPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeJoiningLocalService.deleteEmployeeJoining(
			(EmployeeJoining)persistedModel);
	}

	public BasePersistence<EmployeeJoining> getBasePersistence() {
		return employeeJoiningPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeJoiningPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeJoining> getEmployeeJoinings(int start, int end) {
		return employeeJoiningPersistence.findAll(start, end);
	}
	...
	public int getEmployeeJoiningsCount() {
		return employeeJoiningPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeJoining updateEmployeeJoining(
		EmployeeJoining employeeJoining) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeJoiningLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeJoiningLocalService = (EmployeeJoiningLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeJoiningLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeJoiningPersistence.getDataSource();
	...
	protected EmployeeJoiningLocalService employeeJoiningLocalService;
