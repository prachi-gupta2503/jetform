...
import com.adjecti.pis.liferay.service.EmployeeDscLocalService;
...
/**
 * Provides the base implementation for the employee dsc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDscLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDscLocalServiceImpl
 * @generated
 */
public abstract class EmployeeDscLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeDscLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDscLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDscLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeDsc addEmployeeDsc(EmployeeDsc employeeDsc) {
		employeeDsc.setNew(true);

		return employeeDscPersistence.update(employeeDsc);
	}
	...
	public EmployeeDsc createEmployeeDsc(long employeeDscId) {
		return employeeDscPersistence.create(employeeDscId);
	}
	...
	@Override
	public EmployeeDsc deleteEmployeeDsc(long employeeDscId)
		throws PortalException {

		return employeeDscPersistence.remove(employeeDscId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeDsc deleteEmployeeDsc(EmployeeDsc employeeDsc) {
		return employeeDscPersistence.remove(employeeDsc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeDsc.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeDscPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeDscPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeDscPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeDscPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeDsc fetchEmployeeDsc(long employeeDscId) {
		return employeeDscPersistence.fetchByPrimaryKey(employeeDscId);
	}
	 ...
	 */
	@Override
	public EmployeeDsc getEmployeeDsc(long employeeDscId)
		throws PortalException {

		return employeeDscPersistence.findByPrimaryKey(employeeDscId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeDscLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeDsc.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeDscId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeDscLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeDsc.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDscPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeDscLocalService.deleteEmployeeDsc(
			(EmployeeDsc)persistedModel);
	}

	public BasePersistence<EmployeeDsc> getBasePersistence() {
		return employeeDscPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDscPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeDsc> getEmployeeDscs(int start, int end) {
		return employeeDscPersistence.findAll(start, end);
	}
	...
	public int getEmployeeDscsCount() {
		return employeeDscPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeDsc updateEmployeeDsc(EmployeeDsc employeeDsc) {
		return employeeDscPersistence.update(employeeDsc);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDscLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeDscLocalService = (EmployeeDscLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDscLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeDscPersistence.getDataSource();
	...
	protected EmployeeDscLocalService employeeDscLocalService;
