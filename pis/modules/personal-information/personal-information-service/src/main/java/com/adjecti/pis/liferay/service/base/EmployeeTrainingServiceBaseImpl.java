...
import com.adjecti.pis.liferay.service.EmployeeTrainingService;
...
/**
 * Provides the base implementation for the employee training remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeTrainingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeTrainingServiceImpl
 * @generated
 */
public abstract class EmployeeTrainingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeTrainingService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeTrainingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeTrainingServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeTrainingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeTrainingService = (EmployeeTrainingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeTrainingService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeTrainingLocalService
		employeeTrainingLocalService;

	protected EmployeeTrainingService employeeTrainingService;
