...
import com.adjecti.pis.liferay.service.FamilyEducationDetailService;
...
/**
 * Provides the base implementation for the family education detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyEducationDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyEducationDetailServiceImpl
 * @generated
 */
public abstract class FamilyEducationDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FamilyEducationDetailService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyEducationDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyEducationDetailServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyEducationDetailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		familyEducationDetailService = (FamilyEducationDetailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyEducationDetailService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.FamilyEducationDetailLocalService
		familyEducationDetailLocalService;

	protected FamilyEducationDetailService familyEducationDetailService;
