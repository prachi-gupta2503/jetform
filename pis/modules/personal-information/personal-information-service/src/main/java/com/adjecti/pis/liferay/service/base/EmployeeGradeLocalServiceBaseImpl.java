...
import com.adjecti.pis.liferay.service.EmployeeGradeLocalService;
...
/**
 * Provides the base implementation for the employee grade local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeGradeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeGradeLocalServiceImpl
 * @generated
 */
public abstract class EmployeeGradeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeGradeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeGradeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeGradeLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeGrade addEmployeeGrade(EmployeeGrade employeeGrade) {
		employeeGrade.setNew(true);

		return employeeGradePersistence.update(employeeGrade);
	}
	...
	public EmployeeGrade createEmployeeGrade(long employeeGradeId) {
		return employeeGradePersistence.create(employeeGradeId);
	}
	...
	@Override
	public EmployeeGrade deleteEmployeeGrade(long employeeGradeId)
		throws PortalException {

		return employeeGradePersistence.remove(employeeGradeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeGrade deleteEmployeeGrade(EmployeeGrade employeeGrade) {
		return employeeGradePersistence.remove(employeeGrade);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeGrade.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeGradePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeGradePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeGradePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeGradePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeGrade fetchEmployeeGrade(long employeeGradeId) {
		return employeeGradePersistence.fetchByPrimaryKey(employeeGradeId);
	}
	 ...
	 */
	@Override
	public EmployeeGrade getEmployeeGrade(long employeeGradeId)
		throws PortalException {

		return employeeGradePersistence.findByPrimaryKey(employeeGradeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeGradeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeGrade.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeGradeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeGradeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeGrade.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeGradePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeGradeLocalService.deleteEmployeeGrade(
			(EmployeeGrade)persistedModel);
	}

	public BasePersistence<EmployeeGrade> getBasePersistence() {
		return employeeGradePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeGradePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeGrade> getEmployeeGrades(int start, int end) {
		return employeeGradePersistence.findAll(start, end);
	}
	...
	public int getEmployeeGradesCount() {
		return employeeGradePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeGrade updateEmployeeGrade(EmployeeGrade employeeGrade) {
		return employeeGradePersistence.update(employeeGrade);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeGradeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeGradeLocalService = (EmployeeGradeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeGradeLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return EmployeeGrade.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeGradePersistence.getDataSource();
	...
	protected EmployeeGradeLocalService employeeGradeLocalService;
