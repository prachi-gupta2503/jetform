...
import com.adjecti.pis.liferay.service.EmployeeExperienceService;
...
/**
 * Provides the base implementation for the employee experience remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeExperienceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeExperienceServiceImpl
 * @generated
 */
public abstract class EmployeeExperienceServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeExperienceService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeExperienceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeExperienceServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeExperienceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeExperienceService = (EmployeeExperienceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeExperienceService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeExperienceLocalService
		employeeExperienceLocalService;

	protected EmployeeExperienceService employeeExperienceService;
