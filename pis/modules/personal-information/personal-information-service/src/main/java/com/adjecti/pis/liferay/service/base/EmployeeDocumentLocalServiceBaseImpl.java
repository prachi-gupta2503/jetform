...
/**
 * Provides the base implementation for the employee document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDocumentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDocumentLocalServiceImpl
 * @generated
 */
public abstract class EmployeeDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeDocumentLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDocumentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDocumentLocalServiceUtil</code>.
	 */
	...
	public EmployeeDocument addEmployeeDocument(
		...
		return employeeDocumentPersistence.update(employeeDocument);
	}
	...
	public EmployeeDocument createEmployeeDocument(long employeeDocumentId) {
		return employeeDocumentPersistence.create(employeeDocumentId);
	}
	...
	@Override
	public EmployeeDocument deleteEmployeeDocument(long employeeDocumentId)
		throws PortalException {

		return employeeDocumentPersistence.remove(employeeDocumentId);
	}
	...
	public EmployeeDocument deleteEmployeeDocument(
		...
		return employeeDocumentPersistence.remove(employeeDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeDocument.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeDocumentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeDocumentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeDocument fetchEmployeeDocument(long employeeDocumentId) {
		return employeeDocumentPersistence.fetchByPrimaryKey(
			employeeDocumentId);
	}
	 ...
	 */
	@Override
	public EmployeeDocument getEmployeeDocument(long employeeDocumentId)
		throws PortalException {

		return employeeDocumentPersistence.findByPrimaryKey(employeeDocumentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeDocument.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeDocumentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeeDocument.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDocumentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeDocumentLocalService.deleteEmployeeDocument(
			(EmployeeDocument)persistedModel);
	}

	public BasePersistence<EmployeeDocument> getBasePersistence() {
		return employeeDocumentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EmployeeDocument> getEmployeeDocuments(int start, int end) {
		return employeeDocumentPersistence.findAll(start, end);
	}
	...
	public int getEmployeeDocumentsCount() {
		return employeeDocumentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDocumentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeDocumentLocalService = (EmployeeDocumentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDocumentLocalService.class.getName();
	}
	...
	protected EmployeeDocumentLocalService employeeDocumentLocalService;
