...
import com.adjecti.pis.liferay.service.EmployeeDeputationLocalService;
...
/**
 * Provides the base implementation for the employee deputation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDeputationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDeputationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeDeputationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeDeputationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDeputationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDeputationLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeDeputation addEmployeeDeputation(
		EmployeeDeputation employeeDeputation) {

		employeeDeputation.setNew(true);

		return employeeDeputationPersistence.update(employeeDeputation);
	}
	...
	public EmployeeDeputation createEmployeeDeputation(
		long employeeDeputationId) {

		return employeeDeputationPersistence.create(employeeDeputationId);
	}
	...
	@Override
	public EmployeeDeputation deleteEmployeeDeputation(
			long employeeDeputationId)
		throws PortalException {

		return employeeDeputationPersistence.remove(employeeDeputationId);
	}
	...
	public EmployeeDeputation deleteEmployeeDeputation(
		...
		return employeeDeputationPersistence.remove(employeeDeputation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeDeputation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeDeputationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeDeputationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeDeputationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeeDeputation fetchEmployeeDeputation(
		long employeeDeputationId) {

		return employeeDeputationPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public EmployeeDeputation getEmployeeDeputation(long employeeDeputationId)
		throws PortalException {

		return employeeDeputationPersistence.findByPrimaryKey(
			employeeDeputationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeDeputation.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeeDeputation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDeputationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeDeputationLocalService.deleteEmployeeDeputation(
			(EmployeeDeputation)persistedModel);
	}

	public BasePersistence<EmployeeDeputation> getBasePersistence() {
		return employeeDeputationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDeputationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeDeputation> getEmployeeDeputations(int start, int end) {
		return employeeDeputationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeDeputationsCount() {
		return employeeDeputationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeDeputation updateEmployeeDeputation(
		EmployeeDeputation employeeDeputation) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDeputationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeDeputationLocalService =
			(EmployeeDeputationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDeputationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeDeputationPersistence.getDataSource();
	...
	protected EmployeeDeputationLocalService employeeDeputationLocalService;
