...
import com.adjecti.pis.liferay.service.EmployeeTradeLocalService;
...
/**
 * Provides the base implementation for the employee trade local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeTradeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeTradeLocalServiceImpl
 * @generated
 */
public abstract class EmployeeTradeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeTradeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeTradeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeTradeLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeTrade addEmployeeTrade(EmployeeTrade employeeTrade) {
		employeeTrade.setNew(true);

		return employeeTradePersistence.update(employeeTrade);
	}
	...
	public EmployeeTrade createEmployeeTrade(long employeeTradeId) {
		return employeeTradePersistence.create(employeeTradeId);
	}
	...
	@Override
	public EmployeeTrade deleteEmployeeTrade(long employeeTradeId)
		throws PortalException {

		return employeeTradePersistence.remove(employeeTradeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeTrade deleteEmployeeTrade(EmployeeTrade employeeTrade) {
		return employeeTradePersistence.remove(employeeTrade);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeTrade.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeTradePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeTradePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeTradePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeTradePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeTrade fetchEmployeeTrade(long employeeTradeId) {
		return employeeTradePersistence.fetchByPrimaryKey(employeeTradeId);
	}
	 ...
	 */
	@Override
	public EmployeeTrade getEmployeeTrade(long employeeTradeId)
		throws PortalException {

		return employeeTradePersistence.findByPrimaryKey(employeeTradeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeTradeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeTrade.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeTradeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeTradeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeTrade.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeTradePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeTradeLocalService.deleteEmployeeTrade(
			(EmployeeTrade)persistedModel);
	}

	public BasePersistence<EmployeeTrade> getBasePersistence() {
		return employeeTradePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeTradePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeTrade> getEmployeeTrades(int start, int end) {
		return employeeTradePersistence.findAll(start, end);
	}
	...
	public int getEmployeeTradesCount() {
		return employeeTradePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeTrade updateEmployeeTrade(EmployeeTrade employeeTrade) {
		return employeeTradePersistence.update(employeeTrade);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeTradeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeTradeLocalService = (EmployeeTradeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeTradeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeTradePersistence.getDataSource();
	...
	protected EmployeeTradeLocalService employeeTradeLocalService;
