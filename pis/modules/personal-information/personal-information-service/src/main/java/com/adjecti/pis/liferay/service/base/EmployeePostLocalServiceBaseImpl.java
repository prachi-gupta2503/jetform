...
import com.adjecti.pis.liferay.service.EmployeePostLocalService;
...
/**
 * Provides the base implementation for the employee post local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePostLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePostLocalServiceImpl
 * @generated
 */
public abstract class EmployeePostLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeePostLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePostLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePostLocalServiceUtil</code>.
	 */
	...
	public EmployeePost addEmployeePost(EmployeePost employeePost) {
		...
		return employeePostPersistence.update(employeePost);
	}
	...
	public EmployeePost createEmployeePost(long employeePostId) {
		return employeePostPersistence.create(employeePostId);
	}
	...
	@Override
	public EmployeePost deleteEmployeePost(long employeePostId)
		throws PortalException {

		return employeePostPersistence.remove(employeePostId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeePost deleteEmployeePost(EmployeePost employeePost) {
		return employeePostPersistence.remove(employeePost);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeePost.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeePostPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeePostPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeePostPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeePostPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeePost fetchEmployeePost(long employeePostId) {
		return employeePostPersistence.fetchByPrimaryKey(employeePostId);
	}
	 ...
	 */
	@Override
	public EmployeePost getEmployeePost(long employeePostId)
		throws PortalException {

		return employeePostPersistence.findByPrimaryKey(employeePostId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeePostLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeePost.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeePostId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeePostLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeePost.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeePostPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeePostLocalService.deleteEmployeePost(
			(EmployeePost)persistedModel);
	}

	public BasePersistence<EmployeePost> getBasePersistence() {
		return employeePostPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeePostPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeePost> getEmployeePosts(int start, int end) {
		return employeePostPersistence.findAll(start, end);
	}
	...
	public int getEmployeePostsCount() {
		return employeePostPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeePost updateEmployeePost(EmployeePost employeePost) {
		return employeePostPersistence.update(employeePost);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePostLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeePostLocalService = (EmployeePostLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePostLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeePostPersistence.getDataSource();
	...
	protected EmployeePostLocalService employeePostLocalService;
