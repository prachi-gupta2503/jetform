...
import com.adjecti.pis.liferay.service.EmployeePermissionLocalService;
...
/**
 * Provides the base implementation for the employee permission local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePermissionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePermissionLocalServiceImpl
 * @generated
 */
public abstract class EmployeePermissionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeePermissionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePermissionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePermissionLocalServiceUtil</code>.
	 */
	...
	public EmployeePermission addEmployeePermission(
		...
		return employeePermissionPersistence.update(employeePermission);
	}
	...
	public EmployeePermission createEmployeePermission(
		...
		return employeePermissionPersistence.create(employeePermissionId);
	}
	...
	public EmployeePermission deleteEmployeePermission(
		...
		return employeePermissionPersistence.remove(employeePermissionId);
	}
	...
	public EmployeePermission deleteEmployeePermission(
		...
		return employeePermissionPersistence.remove(employeePermission);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeePermission.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeePermissionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeePermissionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeePermissionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EmployeePermission fetchEmployeePermission(
		...
		return employeePermissionPersistence.fetchByPrimaryKey(
	...
	public EmployeePermission getEmployeePermission(long employeePermissionId)
		...
		return employeePermissionPersistence.findByPrimaryKey(
			employeePermissionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeePermission.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeePermission.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeePermissionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeePermissionLocalService.deleteEmployeePermission(
			(EmployeePermission)persistedModel);
	}

	public BasePersistence<EmployeePermission> getBasePersistence() {
		return employeePermissionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeePermissionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EmployeePermission> getEmployeePermissions(int start, int end) {
		return employeePermissionPersistence.findAll(start, end);
	}
	...
	public int getEmployeePermissionsCount() {
		return employeePermissionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePermissionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeePermissionLocalService =
			(EmployeePermissionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePermissionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeePermissionPersistence.getDataSource();
	...
	protected EmployeePermissionLocalService employeePermissionLocalService;
