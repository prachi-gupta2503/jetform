...
import com.adjecti.pis.liferay.service.EmployeeBenefitSchemeService;
...
/**
 * Provides the base implementation for the employee benefit scheme remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeBenefitSchemeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeBenefitSchemeServiceImpl
 * @generated
 */
public abstract class EmployeeBenefitSchemeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeBenefitSchemeService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeBenefitSchemeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeBenefitSchemeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeBenefitSchemeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeBenefitSchemeService = (EmployeeBenefitSchemeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeBenefitSchemeService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeBenefitSchemePersistence.getDataSource();
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeBenefitSchemeLocalService
		employeeBenefitSchemeLocalService;

	protected EmployeeBenefitSchemeService employeeBenefitSchemeService;
