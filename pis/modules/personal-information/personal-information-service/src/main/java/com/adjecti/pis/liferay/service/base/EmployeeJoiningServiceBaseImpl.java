...
import com.adjecti.pis.liferay.service.EmployeeJoiningService;
...
/**
 * Provides the base implementation for the employee joining remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeJoiningServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeJoiningServiceImpl
 * @generated
 */
public abstract class EmployeeJoiningServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeJoiningService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeJoiningService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeJoiningServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeJoiningService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeJoiningService = (EmployeeJoiningService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeJoiningService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeJoiningLocalService
		employeeJoiningLocalService;

	protected EmployeeJoiningService employeeJoiningService;
