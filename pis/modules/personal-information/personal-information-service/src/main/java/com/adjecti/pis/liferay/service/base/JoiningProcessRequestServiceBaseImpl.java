...
import com.adjecti.pis.liferay.service.JoiningProcessRequestService;
...
/**
 * Provides the base implementation for the joining process request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.JoiningProcessRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.JoiningProcessRequestServiceImpl
 * @generated
 */
public abstract class JoiningProcessRequestServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JoiningProcessRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.JoiningProcessRequestServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JoiningProcessRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		joiningProcessRequestService = (JoiningProcessRequestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JoiningProcessRequestService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.JoiningProcessRequestLocalService
		joiningProcessRequestLocalService;

	protected JoiningProcessRequestService joiningProcessRequestService;
