...
import com.adjecti.pis.liferay.service.EmployeeVerificationService;
...
/**
 * Provides the base implementation for the employee verification remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeVerificationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeVerificationServiceImpl
 * @generated
 */
public abstract class EmployeeVerificationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeVerificationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeVerificationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeVerificationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeVerificationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeVerificationService = (EmployeeVerificationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeVerificationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeVerificationLocalService
		employeeVerificationLocalService;

	protected EmployeeVerificationService employeeVerificationService;
