...
import com.adjecti.pis.liferay.service.EmployeeEmailService;
...
/**
 * Provides the base implementation for the employee email remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeEmailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeEmailServiceImpl
 * @generated
 */
public abstract class EmployeeEmailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeEmailService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeEmailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeEmailServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeEmailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeEmailService = (EmployeeEmailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeEmailService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeEmailLocalService
		employeeEmailLocalService;

	protected EmployeeEmailService employeeEmailService;
