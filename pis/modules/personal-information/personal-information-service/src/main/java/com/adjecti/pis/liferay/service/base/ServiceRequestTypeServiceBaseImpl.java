...
import com.adjecti.pis.liferay.service.ServiceRequestTypeService;
...
/**
 * Provides the base implementation for the service request type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.ServiceRequestTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.ServiceRequestTypeServiceImpl
 * @generated
 */
public abstract class ServiceRequestTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ServiceRequestTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.ServiceRequestTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ServiceRequestTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		serviceRequestTypeService = (ServiceRequestTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestTypeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.ServiceRequestTypeLocalService
		serviceRequestTypeLocalService;

	protected ServiceRequestTypeService serviceRequestTypeService;
