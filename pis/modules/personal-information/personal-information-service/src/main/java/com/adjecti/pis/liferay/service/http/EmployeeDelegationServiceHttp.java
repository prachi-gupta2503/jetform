 ...
 * @see EmployeeDelegationServiceSoap
 * @generated
 */
public class EmployeeDelegationServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				EmployeeDelegationServiceUtil.class, "getByEmployeeId",
			...
			return (java.util.List
				<com.adjecti.pis.liferay.model.EmployeeDelegation>)returnObj;
		}
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				EmployeeDelegationServiceUtil.class, "getByPersonalNo",
			...
			try {
				...
				if (exception instanceof
					...
					throw (com.adjecti.pis.liferay.exception.
						NoSuchEmployeeDelegationException)exception;
				}
	...
	private static Log _log = LogFactoryUtil.getLog(
		EmployeeDelegationServiceHttp.class);
