...
import com.adjecti.pis.liferay.service.FamilyServiceDetailService;
...
/**
 * Provides the base implementation for the family service detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyServiceDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyServiceDetailServiceImpl
 * @generated
 */
public abstract class FamilyServiceDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FamilyServiceDetailService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyServiceDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyServiceDetailServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyServiceDetailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		familyServiceDetailService = (FamilyServiceDetailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyServiceDetailService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.FamilyServiceDetailLocalService
		familyServiceDetailLocalService;

	protected FamilyServiceDetailService familyServiceDetailService;
