...
import com.adjecti.pis.liferay.service.FamilyHealthDetailService;
...
/**
 * Provides the base implementation for the family health detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyHealthDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyHealthDetailServiceImpl
 * @generated
 */
public abstract class FamilyHealthDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FamilyHealthDetailService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyHealthDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyHealthDetailServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyHealthDetailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		familyHealthDetailService = (FamilyHealthDetailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyHealthDetailService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.FamilyHealthDetailLocalService
		familyHealthDetailLocalService;

	protected FamilyHealthDetailService familyHealthDetailService;
