...
import com.adjecti.pis.liferay.service.EmployeeOrganizationService;
...
/**
 * Provides the base implementation for the employee organization remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeOrganizationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeOrganizationServiceImpl
 * @generated
 */
public abstract class EmployeeOrganizationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeOrganizationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeOrganizationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeOrganizationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeOrganizationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeOrganizationService = (EmployeeOrganizationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeOrganizationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeOrganizationLocalService
		employeeOrganizationLocalService;

	protected EmployeeOrganizationService employeeOrganizationService;
