...
import com.adjecti.pis.liferay.service.PeopleService;
...
/**
 * Provides the base implementation for the people remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.PeopleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.PeopleServiceImpl
 * @generated
 */
public abstract class PeopleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PeopleService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PeopleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.PeopleServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PeopleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		peopleService = (PeopleService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PeopleService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.PeopleLocalService
		peopleLocalService;
