...
import com.adjecti.pis.liferay.service.EmployeeSavingSchemeService;
...
/**
 * Provides the base implementation for the employee saving scheme remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeSavingSchemeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeSavingSchemeServiceImpl
 * @generated
 */
public abstract class EmployeeSavingSchemeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeSavingSchemeService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeSavingSchemeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeSavingSchemeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeSavingSchemeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeSavingSchemeService = (EmployeeSavingSchemeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeSavingSchemeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeSavingSchemeLocalService
		employeeSavingSchemeLocalService;

	protected EmployeeSavingSchemeService employeeSavingSchemeService;
