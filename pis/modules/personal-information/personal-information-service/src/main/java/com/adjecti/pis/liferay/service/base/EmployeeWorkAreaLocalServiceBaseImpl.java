...
import com.adjecti.pis.liferay.service.EmployeeWorkAreaLocalService;
...
/**
 * Provides the base implementation for the employee work area local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeWorkAreaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeWorkAreaLocalServiceImpl
 * @generated
 */
public abstract class EmployeeWorkAreaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeWorkAreaLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeWorkAreaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeWorkAreaLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeWorkArea addEmployeeWorkArea(
		EmployeeWorkArea employeeWorkArea) {

		employeeWorkArea.setNew(true);

		return employeeWorkAreaPersistence.update(employeeWorkArea);
	}
	...
	public EmployeeWorkArea createEmployeeWorkArea(long employeeWorkAreaId) {
		return employeeWorkAreaPersistence.create(employeeWorkAreaId);
	}
	...
	@Override
	public EmployeeWorkArea deleteEmployeeWorkArea(long employeeWorkAreaId)
		throws PortalException {

		return employeeWorkAreaPersistence.remove(employeeWorkAreaId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeWorkArea deleteEmployeeWorkArea(
		EmployeeWorkArea employeeWorkArea) {

		return employeeWorkAreaPersistence.remove(employeeWorkArea);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeWorkArea.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeWorkAreaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeWorkAreaPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeWorkAreaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeWorkAreaPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeWorkArea fetchEmployeeWorkArea(long employeeWorkAreaId) {
		return employeeWorkAreaPersistence.fetchByPrimaryKey(
			employeeWorkAreaId);
	}
	 ...
	 */
	@Override
	public EmployeeWorkArea getEmployeeWorkArea(long employeeWorkAreaId)
		throws PortalException {

		return employeeWorkAreaPersistence.findByPrimaryKey(employeeWorkAreaId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			employeeWorkAreaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeWorkArea.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeWorkAreaId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeeWorkArea.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeWorkAreaPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeWorkAreaLocalService.deleteEmployeeWorkArea(
			(EmployeeWorkArea)persistedModel);
	}

	public BasePersistence<EmployeeWorkArea> getBasePersistence() {
		return employeeWorkAreaPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeWorkAreaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeWorkArea> getEmployeeWorkAreas(int start, int end) {
		return employeeWorkAreaPersistence.findAll(start, end);
	}
	...
	public int getEmployeeWorkAreasCount() {
		return employeeWorkAreaPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeWorkArea updateEmployeeWorkArea(
		EmployeeWorkArea employeeWorkArea) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeWorkAreaLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeWorkAreaLocalService = (EmployeeWorkAreaLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeWorkAreaLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeWorkAreaPersistence.getDataSource();
	...
	protected EmployeeWorkAreaLocalService employeeWorkAreaLocalService;
