...
import com.adjecti.pis.liferay.service.EmployeeDelegationService;
...
/**
 * Provides the base implementation for the employee delegation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDelegationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDelegationServiceImpl
 * @generated
 */
public abstract class EmployeeDelegationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeDelegationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDelegationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDelegationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDelegationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeDelegationService = (EmployeeDelegationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDelegationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeDelegationLocalService
		employeeDelegationLocalService;

	protected EmployeeDelegationService employeeDelegationService;
