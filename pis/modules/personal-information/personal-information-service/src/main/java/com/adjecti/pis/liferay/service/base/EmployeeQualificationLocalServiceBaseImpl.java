...
/**
 * Provides the base implementation for the employee qualification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeQualificationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeQualificationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeQualificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeQualificationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeQualificationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeQualificationLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeQualification addEmployeeQualification(
		EmployeeQualification employeeQualification) {

		employeeQualification.setNew(true);

		return employeeQualificationPersistence.update(employeeQualification);
	}
	...
	public EmployeeQualification createEmployeeQualification(
		long employeeQualificationId) {

		return employeeQualificationPersistence.create(employeeQualificationId);
	}
	...
	@Override
	public EmployeeQualification deleteEmployeeQualification(
			long employeeQualificationId)
		throws PortalException {

		return employeeQualificationPersistence.remove(employeeQualificationId);
	}
	...
	public EmployeeQualification deleteEmployeeQualification(
		...
		return employeeQualificationPersistence.remove(employeeQualification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeQualification.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeQualificationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeQualificationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeeQualification fetchEmployeeQualification(
		long employeeQualificationId) {

		return employeeQualificationPersistence.fetchByPrimaryKey(
	...
	public EmployeeQualification getEmployeeQualification(
		...
		return employeeQualificationPersistence.findByPrimaryKey(
			employeeQualificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeQualification.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeQualificationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeQualificationLocalService.deleteEmployeeQualification(
			(EmployeeQualification)persistedModel);
	}

	public BasePersistence<EmployeeQualification> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeQualificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EmployeeQualification> getEmployeeQualifications(
		...
		return employeeQualificationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeQualificationsCount() {
		return employeeQualificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeQualification updateEmployeeQualification(
		EmployeeQualification employeeQualification) {
	...
	public void setAopProxy(Object aopProxy) {
		employeeQualificationLocalService =
			(EmployeeQualificationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeQualificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeQualificationPersistence.getDataSource();
	...
	protected EmployeeQualificationLocalService
		employeeQualificationLocalService;
