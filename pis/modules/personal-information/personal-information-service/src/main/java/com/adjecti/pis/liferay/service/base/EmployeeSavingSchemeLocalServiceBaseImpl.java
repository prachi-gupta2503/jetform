...
import com.adjecti.pis.liferay.service.EmployeeSavingSchemeLocalService;
...
/**
 * Provides the base implementation for the employee saving scheme local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeSavingSchemeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeSavingSchemeLocalServiceImpl
 * @generated
 */
public abstract class EmployeeSavingSchemeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeSavingSchemeLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeSavingSchemeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeSavingSchemeLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeSavingScheme addEmployeeSavingScheme(
		EmployeeSavingScheme employeeSavingScheme) {

		employeeSavingScheme.setNew(true);

		return employeeSavingSchemePersistence.update(employeeSavingScheme);
	}
	...
	public EmployeeSavingScheme createEmployeeSavingScheme(
		long employeeSavingSchemeId) {

		return employeeSavingSchemePersistence.create(employeeSavingSchemeId);
	}
	...
	@Override
	public EmployeeSavingScheme deleteEmployeeSavingScheme(
			long employeeSavingSchemeId)
		throws PortalException {

		return employeeSavingSchemePersistence.remove(employeeSavingSchemeId);
	}
	...
	public EmployeeSavingScheme deleteEmployeeSavingScheme(
		...
		return employeeSavingSchemePersistence.remove(employeeSavingScheme);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeSavingScheme.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeSavingSchemePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeSavingSchemePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeeSavingScheme fetchEmployeeSavingScheme(
		long employeeSavingSchemeId) {

		return employeeSavingSchemePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public EmployeeSavingScheme getEmployeeSavingScheme(
			long employeeSavingSchemeId)
		throws PortalException {

		return employeeSavingSchemePersistence.findByPrimaryKey(
			employeeSavingSchemeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			employeeSavingSchemeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeSavingScheme.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeSavingSchemePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeSavingSchemeLocalService.deleteEmployeeSavingScheme(
			(EmployeeSavingScheme)persistedModel);
	}

	public BasePersistence<EmployeeSavingScheme> getBasePersistence() {
		return employeeSavingSchemePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeSavingSchemePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeSavingScheme> getEmployeeSavingSchemes(
		int start, int end) {

		return employeeSavingSchemePersistence.findAll(start, end);
	}
	...
	public int getEmployeeSavingSchemesCount() {
		return employeeSavingSchemePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeSavingScheme updateEmployeeSavingScheme(
		EmployeeSavingScheme employeeSavingScheme) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeSavingSchemeLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeSavingSchemeLocalService =
			(EmployeeSavingSchemeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeSavingSchemeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeSavingSchemePersistence.getDataSource();
	...
	protected EmployeeSavingSchemeLocalService employeeSavingSchemeLocalService;
