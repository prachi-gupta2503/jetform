...
import com.adjecti.pis.liferay.service.EmployeeDelegationLocalService;
...
/**
 * Provides the base implementation for the employee delegation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDelegationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDelegationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeDelegationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeDelegationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDelegationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDelegationLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeDelegation addEmployeeDelegation(
		EmployeeDelegation employeeDelegation) {

		employeeDelegation.setNew(true);

		return employeeDelegationPersistence.update(employeeDelegation);
	}
	...
	public EmployeeDelegation createEmployeeDelegation(
		...
		return employeeDelegationPersistence.create(employeeDelegationId);
	}
	...
	@Override
	public EmployeeDelegation deleteEmployeeDelegation(
			long employeeDelegationId)
		throws PortalException {

		return employeeDelegationPersistence.remove(employeeDelegationId);
	}
	...
	public EmployeeDelegation deleteEmployeeDelegation(
		...
		return employeeDelegationPersistence.remove(employeeDelegation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeDelegation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeDelegationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeDelegationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeDelegationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeeDelegation fetchEmployeeDelegation(
		long employeeDelegationId) {

		return employeeDelegationPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public EmployeeDelegation getEmployeeDelegation(long employeeDelegationId)
		throws PortalException {

		return employeeDelegationPersistence.findByPrimaryKey(
			employeeDelegationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeDelegation.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeeDelegation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDelegationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeDelegationLocalService.deleteEmployeeDelegation(
			(EmployeeDelegation)persistedModel);
	}

	public BasePersistence<EmployeeDelegation> getBasePersistence() {
		return employeeDelegationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDelegationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeDelegation> getEmployeeDelegations(int start, int end) {
		return employeeDelegationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeDelegationsCount() {
		return employeeDelegationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeDelegation updateEmployeeDelegation(
		EmployeeDelegation employeeDelegation) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDelegationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeDelegationLocalService =
			(EmployeeDelegationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDelegationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeDelegationPersistence.getDataSource();
	...
	protected EmployeeDelegationLocalService employeeDelegationLocalService;
