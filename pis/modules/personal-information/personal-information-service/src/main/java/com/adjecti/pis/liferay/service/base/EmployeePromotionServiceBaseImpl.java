...
import com.adjecti.pis.liferay.service.EmployeePromotionService;
...
/**
 * Provides the base implementation for the employee promotion remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePromotionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePromotionServiceImpl
 * @generated
 */
public abstract class EmployeePromotionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeePromotionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePromotionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePromotionServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePromotionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeePromotionService = (EmployeePromotionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePromotionService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeePromotionPersistence.getDataSource();
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeePromotionLocalService
		employeePromotionLocalService;

	protected EmployeePromotionService employeePromotionService;
