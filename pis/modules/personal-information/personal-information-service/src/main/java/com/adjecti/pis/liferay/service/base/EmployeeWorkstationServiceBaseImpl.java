...
import com.adjecti.pis.liferay.service.EmployeeWorkstationService;
...
/**
 * Provides the base implementation for the employee workstation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeWorkstationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeWorkstationServiceImpl
 * @generated
 */
public abstract class EmployeeWorkstationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeWorkstationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeWorkstationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeWorkstationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeWorkstationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeWorkstationService = (EmployeeWorkstationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeWorkstationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeWorkstationLocalService
		employeeWorkstationLocalService;

	protected EmployeeWorkstationService employeeWorkstationService;
