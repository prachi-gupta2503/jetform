...
import com.adjecti.pis.liferay.service.EmployeeContactService;
...
/**
 * Provides the base implementation for the employee contact remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeContactServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeContactServiceImpl
 * @generated
 */
public abstract class EmployeeContactServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeContactService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeContactService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeContactServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeContactService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeContactService = (EmployeeContactService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeContactService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeContactPersistence.getDataSource();
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeContactLocalService
		employeeContactLocalService;
