...
import com.adjecti.pis.liferay.service.EmployeeApplicationService;
...
/**
 * Provides the base implementation for the employee application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeApplicationServiceImpl
 * @generated
 */
public abstract class EmployeeApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeApplicationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeApplicationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeApplicationService = (EmployeeApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeApplicationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeApplicationLocalService
		employeeApplicationLocalService;

	protected EmployeeApplicationService employeeApplicationService;
