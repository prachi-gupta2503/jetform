...
import com.adjecti.pis.liferay.service.EmployeeConfirmationLocalService;
...
/**
 * Provides the base implementation for the employee confirmation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeConfirmationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeConfirmationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeConfirmationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeConfirmationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeConfirmationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeConfirmationLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeConfirmation addEmployeeConfirmation(
		EmployeeConfirmation employeeConfirmation) {

		employeeConfirmation.setNew(true);

		return employeeConfirmationPersistence.update(employeeConfirmation);
	}
	...
	public EmployeeConfirmation createEmployeeConfirmation(
		long employeeConfirmationId) {

		return employeeConfirmationPersistence.create(employeeConfirmationId);
	}
	...
	@Override
	public EmployeeConfirmation deleteEmployeeConfirmation(
			long employeeConfirmationId)
		throws PortalException {

		return employeeConfirmationPersistence.remove(employeeConfirmationId);
	}
	...
	public EmployeeConfirmation deleteEmployeeConfirmation(
		...
		return employeeConfirmationPersistence.remove(employeeConfirmation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeConfirmation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeConfirmationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeConfirmationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeeConfirmation fetchEmployeeConfirmation(
		long employeeConfirmationId) {

		return employeeConfirmationPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public EmployeeConfirmation getEmployeeConfirmation(
			long employeeConfirmationId)
		throws PortalException {

		return employeeConfirmationPersistence.findByPrimaryKey(
			employeeConfirmationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeConfirmation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeConfirmationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeConfirmationLocalService.deleteEmployeeConfirmation(
			(EmployeeConfirmation)persistedModel);
	}

	public BasePersistence<EmployeeConfirmation> getBasePersistence() {
		return employeeConfirmationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeConfirmationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeConfirmation> getEmployeeConfirmations(
		int start, int end) {

		return employeeConfirmationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeConfirmationsCount() {
		return employeeConfirmationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeConfirmation updateEmployeeConfirmation(
		EmployeeConfirmation employeeConfirmation) {
	...
	public void setAopProxy(Object aopProxy) {
		employeeConfirmationLocalService =
			(EmployeeConfirmationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeConfirmationLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return EmployeeConfirmation.class;
	}

	protected String getModelClassName() {
		return EmployeeConfirmation.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeConfirmationPersistence.getDataSource();
	...
	protected EmployeeConfirmationLocalService employeeConfirmationLocalService;
