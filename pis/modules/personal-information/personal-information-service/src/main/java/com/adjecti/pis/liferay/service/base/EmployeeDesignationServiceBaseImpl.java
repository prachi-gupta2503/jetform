...
import com.adjecti.pis.liferay.service.EmployeeDesignationService;
...
/**
 * Provides the base implementation for the employee designation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDesignationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDesignationServiceImpl
 * @generated
 */
public abstract class EmployeeDesignationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeDesignationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDesignationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDesignationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDesignationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeDesignationService = (EmployeeDesignationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDesignationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeDesignationLocalService
