...
import com.adjecti.pis.liferay.service.EmployeeAddressService;
...
/**
 * Provides the base implementation for the employee address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeAddressServiceImpl
 * @generated
 */
public abstract class EmployeeAddressServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeAddressService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeAddressServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeAddressService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeAddressService = (EmployeeAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeAddressService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeAddressLocalService
		employeeAddressLocalService;

	protected EmployeeAddressService employeeAddressService;
