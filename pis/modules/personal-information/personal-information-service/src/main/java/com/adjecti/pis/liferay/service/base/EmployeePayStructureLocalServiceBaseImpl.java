...
import com.adjecti.pis.liferay.service.EmployeePayStructureLocalService;
...
/**
 * Provides the base implementation for the employee pay structure local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePayStructureLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePayStructureLocalServiceImpl
 * @generated
 */
public abstract class EmployeePayStructureLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeePayStructureLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePayStructureLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePayStructureLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeePayStructure addEmployeePayStructure(
		EmployeePayStructure employeePayStructure) {

		employeePayStructure.setNew(true);

		return employeePayStructurePersistence.update(employeePayStructure);
	}
	...
	public EmployeePayStructure createEmployeePayStructure(
		long employeePayStructureId) {

		return employeePayStructurePersistence.create(employeePayStructureId);
	}
	...
	@Override
	public EmployeePayStructure deleteEmployeePayStructure(
			long employeePayStructureId)
		throws PortalException {

		return employeePayStructurePersistence.remove(employeePayStructureId);
	}
	...
	public EmployeePayStructure deleteEmployeePayStructure(
		...
		return employeePayStructurePersistence.remove(employeePayStructure);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeePayStructure.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeePayStructurePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeePayStructurePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeePayStructure fetchEmployeePayStructure(
		long employeePayStructureId) {

		return employeePayStructurePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public EmployeePayStructure getEmployeePayStructure(
			long employeePayStructureId)
		throws PortalException {

		return employeePayStructurePersistence.findByPrimaryKey(
			employeePayStructureId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			employeePayStructureLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeePayStructure.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeePayStructurePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeePayStructureLocalService.deleteEmployeePayStructure(
			(EmployeePayStructure)persistedModel);
	}

	public BasePersistence<EmployeePayStructure> getBasePersistence() {
		return employeePayStructurePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeePayStructurePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeePayStructure> getEmployeePayStructures(
		int start, int end) {

		return employeePayStructurePersistence.findAll(start, end);
	}
	...
	public int getEmployeePayStructuresCount() {
		return employeePayStructurePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeePayStructure updateEmployeePayStructure(
		EmployeePayStructure employeePayStructure) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePayStructureLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeePayStructureLocalService =
			(EmployeePayStructureLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePayStructureLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeePayStructurePersistence.getDataSource();
	...
	protected EmployeePayStructureLocalService employeePayStructureLocalService;
