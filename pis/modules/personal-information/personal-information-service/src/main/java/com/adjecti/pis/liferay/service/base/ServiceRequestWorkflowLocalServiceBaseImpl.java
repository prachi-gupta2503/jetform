...
import com.adjecti.pis.liferay.service.ServiceRequestWorkflowLocalService;
...
/**
 * Provides the base implementation for the service request workflow local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.ServiceRequestWorkflowLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.ServiceRequestWorkflowLocalServiceImpl
 * @generated
 */
public abstract class ServiceRequestWorkflowLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestWorkflowLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.ServiceRequestWorkflowLocalServiceUtil</code>.
	 */
	...
	@Override
	public ServiceRequestWorkflow addServiceRequestWorkflow(
		ServiceRequestWorkflow serviceRequestWorkflow) {

		serviceRequestWorkflow.setNew(true);

		return serviceRequestWorkflowPersistence.update(serviceRequestWorkflow);
	}
	...
	public ServiceRequestWorkflow createServiceRequestWorkflow(
		long serviceRequestWorkflowId) {

		return serviceRequestWorkflowPersistence.create(
	...
	@Override
	public ServiceRequestWorkflow deleteServiceRequestWorkflow(
			long serviceRequestWorkflowId)
		throws PortalException {

		return serviceRequestWorkflowPersistence.remove(
			serviceRequestWorkflowId);
	}
	...
	public ServiceRequestWorkflow deleteServiceRequestWorkflow(
		...
		return serviceRequestWorkflowPersistence.remove(serviceRequestWorkflow);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ServiceRequestWorkflow.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceRequestWorkflowPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceRequestWorkflowPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ServiceRequestWorkflow fetchServiceRequestWorkflow(
		long serviceRequestWorkflowId) {

		return serviceRequestWorkflowPersistence.fetchByPrimaryKey(
			serviceRequestWorkflowId);
	}
	 ...
	 */
	@Override
	public ServiceRequestWorkflow getServiceRequestWorkflow(
			long serviceRequestWorkflowId)
		throws PortalException {

		return serviceRequestWorkflowPersistence.findByPrimaryKey(
			serviceRequestWorkflowId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ServiceRequestWorkflow.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return serviceRequestWorkflowLocalService.deleteServiceRequestWorkflow(
			(ServiceRequestWorkflow)persistedModel);
	}

	public BasePersistence<ServiceRequestWorkflow> getBasePersistence() {
		return serviceRequestWorkflowPersistence;
	}
	 ...
	 */
	@Override
	public List<ServiceRequestWorkflow> getServiceRequestWorkflows(
		int start, int end) {

		return serviceRequestWorkflowPersistence.findAll(start, end);
	}
	...
	public int getServiceRequestWorkflowsCount() {
		return serviceRequestWorkflowPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceRequestWorkflow updateServiceRequestWorkflow(
		ServiceRequestWorkflow serviceRequestWorkflow) {
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestWorkflowLocalService =
			(ServiceRequestWorkflowLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestWorkflowLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return ServiceRequestWorkflow.class;
	}

	protected String getModelClassName() {
		return ServiceRequestWorkflow.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				serviceRequestWorkflowPersistence.getDataSource();
	...
	protected ServiceRequestWorkflowLocalService
		serviceRequestWorkflowLocalService;
