...
import com.adjecti.pis.liferay.service.EmployeeConfirmationService;
...
/**
 * Provides the base implementation for the employee confirmation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeConfirmationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeConfirmationServiceImpl
 * @generated
 */
public abstract class EmployeeConfirmationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeConfirmationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeConfirmationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeConfirmationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeConfirmationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeConfirmationService = (EmployeeConfirmationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeConfirmationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeConfirmationLocalService
