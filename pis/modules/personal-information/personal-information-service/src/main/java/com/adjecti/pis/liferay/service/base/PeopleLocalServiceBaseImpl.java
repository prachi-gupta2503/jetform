...
/**
 * Provides the base implementation for the people local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.PeopleLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.PeopleLocalServiceImpl
 * @generated
 */
public abstract class PeopleLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PeopleLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PeopleLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.PeopleLocalServiceUtil</code>.
	 */
	...
	public People addPeople(People people) {
		...
		return peoplePersistence.update(people);
	}
	...
	public People createPeople(long peopleId) {
		return peoplePersistence.create(peopleId);
	}
	...
	@Override
	public People deletePeople(long peopleId) throws PortalException {
		return peoplePersistence.remove(peopleId);
	}
	...
	public People deletePeople(People people) {
		return peoplePersistence.remove(people);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			People.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return peoplePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return peoplePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return peoplePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return peoplePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return peoplePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public People fetchPeople(long peopleId) {
		return peoplePersistence.fetchByPrimaryKey(peopleId);
	}
	 ...
	 */
	@Override
	public People getPeople(long peopleId) throws PortalException {
		return peoplePersistence.findByPrimaryKey(peopleId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(peopleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(People.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(peopleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(People.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return peoplePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return peopleLocalService.deletePeople((People)persistedModel);
	}

	public BasePersistence<People> getBasePersistence() {
		return peoplePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return peoplePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<People> getPeoples(int start, int end) {
		return peoplePersistence.findAll(start, end);
	}
	...
	public int getPeoplesCount() {
		return peoplePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PeopleLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		peopleLocalService = (PeopleLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PeopleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = peoplePersistence.getDataSource();
	...
	protected PeopleLocalService peopleLocalService;
