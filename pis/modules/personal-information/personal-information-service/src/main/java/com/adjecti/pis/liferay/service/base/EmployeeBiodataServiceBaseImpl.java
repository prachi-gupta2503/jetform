...
import com.adjecti.pis.liferay.service.EmployeeBiodataService;
...
/**
 * Provides the base implementation for the employee biodata remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeBiodataServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeBiodataServiceImpl
 * @generated
 */
public abstract class EmployeeBiodataServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeBiodataService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeBiodataService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeBiodataServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeBiodataService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeBiodataService = (EmployeeBiodataService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeBiodataService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeBiodataLocalService
		employeeBiodataLocalService;

	protected EmployeeBiodataService employeeBiodataService;
