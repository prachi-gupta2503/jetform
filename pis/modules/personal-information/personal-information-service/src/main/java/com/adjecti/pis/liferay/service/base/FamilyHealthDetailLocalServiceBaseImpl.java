...
import com.adjecti.pis.liferay.service.FamilyHealthDetailLocalService;
...
/**
 * Provides the base implementation for the family health detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyHealthDetailLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyHealthDetailLocalServiceImpl
 * @generated
 */
public abstract class FamilyHealthDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FamilyHealthDetailLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyHealthDetailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyHealthDetailLocalServiceUtil</code>.
	 */
	...
	@Override
	public FamilyHealthDetail addFamilyHealthDetail(
		FamilyHealthDetail familyHealthDetail) {

		familyHealthDetail.setNew(true);

		return familyHealthDetailPersistence.update(familyHealthDetail);
	}
	...
	public FamilyHealthDetail createFamilyHealthDetail(
		long familyHealthDetailId) {

		return familyHealthDetailPersistence.create(familyHealthDetailId);
	}
	...
	@Override
	public FamilyHealthDetail deleteFamilyHealthDetail(
			long familyHealthDetailId)
		throws PortalException {

		return familyHealthDetailPersistence.remove(familyHealthDetailId);
	}
	...
	public FamilyHealthDetail deleteFamilyHealthDetail(
		...
		return familyHealthDetailPersistence.remove(familyHealthDetail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FamilyHealthDetail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return familyHealthDetailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return familyHealthDetailPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return familyHealthDetailPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public FamilyHealthDetail fetchFamilyHealthDetail(
		long familyHealthDetailId) {

		return familyHealthDetailPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public FamilyHealthDetail getFamilyHealthDetail(long familyHealthDetailId)
		throws PortalException {

		return familyHealthDetailPersistence.findByPrimaryKey(
			familyHealthDetailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FamilyHealthDetail.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(FamilyHealthDetail.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return familyHealthDetailPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return familyHealthDetailLocalService.deleteFamilyHealthDetail(
			(FamilyHealthDetail)persistedModel);
	}

	public BasePersistence<FamilyHealthDetail> getBasePersistence() {
		return familyHealthDetailPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return familyHealthDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FamilyHealthDetail> getFamilyHealthDetails(int start, int end) {
		return familyHealthDetailPersistence.findAll(start, end);
	}
	...
	public int getFamilyHealthDetailsCount() {
		return familyHealthDetailPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FamilyHealthDetail updateFamilyHealthDetail(
		FamilyHealthDetail familyHealthDetail) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyHealthDetailLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		familyHealthDetailLocalService =
			(FamilyHealthDetailLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyHealthDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				familyHealthDetailPersistence.getDataSource();
	...
	protected FamilyHealthDetailLocalService familyHealthDetailLocalService;
