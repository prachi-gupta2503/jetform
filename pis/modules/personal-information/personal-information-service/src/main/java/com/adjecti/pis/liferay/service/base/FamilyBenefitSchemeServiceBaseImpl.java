...
import com.adjecti.pis.liferay.service.FamilyBenefitSchemeService;
...
/**
 * Provides the base implementation for the family benefit scheme remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyBenefitSchemeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyBenefitSchemeServiceImpl
 * @generated
 */
public abstract class FamilyBenefitSchemeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FamilyBenefitSchemeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyBenefitSchemeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyBenefitSchemeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyBenefitSchemeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		familyBenefitSchemeService = (FamilyBenefitSchemeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyBenefitSchemeService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.FamilyBenefitSchemeLocalService
		familyBenefitSchemeLocalService;

	protected FamilyBenefitSchemeService familyBenefitSchemeService;
