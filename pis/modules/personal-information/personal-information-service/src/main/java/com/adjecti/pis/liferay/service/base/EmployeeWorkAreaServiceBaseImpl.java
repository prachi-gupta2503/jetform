...
import com.adjecti.pis.liferay.service.EmployeeWorkAreaService;
...
/**
 * Provides the base implementation for the employee work area remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeWorkAreaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeWorkAreaServiceImpl
 * @generated
 */
public abstract class EmployeeWorkAreaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeWorkAreaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeWorkAreaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeWorkAreaServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeWorkAreaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeWorkAreaService = (EmployeeWorkAreaService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeWorkAreaService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeWorkAreaLocalService
		employeeWorkAreaLocalService;

	protected EmployeeWorkAreaService employeeWorkAreaService;
