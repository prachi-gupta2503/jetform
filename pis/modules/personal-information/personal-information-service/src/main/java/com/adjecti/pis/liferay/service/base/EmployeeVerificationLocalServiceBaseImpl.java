...
import com.adjecti.pis.liferay.service.EmployeeVerificationLocalService;
...
/**
 * Provides the base implementation for the employee verification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeVerificationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeVerificationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeVerificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeVerificationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeVerificationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeVerificationLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeVerification addEmployeeVerification(
		EmployeeVerification employeeVerification) {

		employeeVerification.setNew(true);

		return employeeVerificationPersistence.update(employeeVerification);
	}
	...
	public EmployeeVerification createEmployeeVerification(
		long employeeVerificationId) {

		return employeeVerificationPersistence.create(employeeVerificationId);
	}
	...
	@Override
	public EmployeeVerification deleteEmployeeVerification(
			long employeeVerificationId)
		throws PortalException {

		return employeeVerificationPersistence.remove(employeeVerificationId);
	}
	...
	public EmployeeVerification deleteEmployeeVerification(
		...
		return employeeVerificationPersistence.remove(employeeVerification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeVerification.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeVerificationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeVerificationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeeVerification fetchEmployeeVerification(
		long employeeVerificationId) {

		return employeeVerificationPersistence.fetchByPrimaryKey(
	...
	public EmployeeVerification getEmployeeVerification(
		...
		return employeeVerificationPersistence.findByPrimaryKey(
			employeeVerificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeVerification.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeVerificationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeVerificationLocalService.deleteEmployeeVerification(
			(EmployeeVerification)persistedModel);
	}

	public BasePersistence<EmployeeVerification> getBasePersistence() {
		return employeeVerificationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeVerificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeVerification> getEmployeeVerifications(
		int start, int end) {

		return employeeVerificationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeVerificationsCount() {
		return employeeVerificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeVerification updateEmployeeVerification(
		EmployeeVerification employeeVerification) {
	...
	public void setAopProxy(Object aopProxy) {
		employeeVerificationLocalService =
			(EmployeeVerificationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeVerificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeVerificationPersistence.getDataSource();
	...
	protected EmployeeVerificationLocalService employeeVerificationLocalService;
