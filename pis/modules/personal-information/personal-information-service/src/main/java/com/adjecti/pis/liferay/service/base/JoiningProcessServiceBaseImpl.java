...
import com.adjecti.pis.liferay.service.JoiningProcessService;
...
/**
 * Provides the base implementation for the joining process remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.JoiningProcessServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.JoiningProcessServiceImpl
 * @generated
 */
public abstract class JoiningProcessServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JoiningProcessService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JoiningProcessService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.JoiningProcessServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JoiningProcessService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		joiningProcessService = (JoiningProcessService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JoiningProcessService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.JoiningProcessLocalService
		joiningProcessLocalService;

	protected JoiningProcessService joiningProcessService;
