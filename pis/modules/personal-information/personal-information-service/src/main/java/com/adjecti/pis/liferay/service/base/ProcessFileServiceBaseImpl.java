...
import com.adjecti.pis.liferay.service.ProcessFileService;
...
/**
 * Provides the base implementation for the process file remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.ProcessFileServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.ProcessFileServiceImpl
 * @generated
 */
public abstract class ProcessFileServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProcessFileService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcessFileService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.ProcessFileServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcessFileService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		processFileService = (ProcessFileService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcessFileService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = processFilePersistence.getDataSource();
	...
	@Reference
	protected com.adjecti.pis.liferay.service.ProcessFileLocalService
		processFileLocalService;

	protected ProcessFileService processFileService;
