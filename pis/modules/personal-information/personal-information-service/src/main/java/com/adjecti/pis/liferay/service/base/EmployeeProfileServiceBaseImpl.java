...
import com.adjecti.pis.liferay.service.EmployeeProfileService;
...
/**
 * Provides the base implementation for the employee profile remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeProfileServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeProfileServiceImpl
 * @generated
 */
public abstract class EmployeeProfileServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeProfileService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeProfileService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeProfileServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeProfileService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeProfileService = (EmployeeProfileService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeProfileService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeProfileLocalService
		employeeProfileLocalService;

	protected EmployeeProfileService employeeProfileService;
