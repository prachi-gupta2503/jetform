...
import com.adjecti.pis.liferay.service.MonthlySalaryComponentService;
...
/**
 * Provides the base implementation for the monthly salary component remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.MonthlySalaryComponentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.MonthlySalaryComponentServiceImpl
 * @generated
 */
public abstract class MonthlySalaryComponentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MonthlySalaryComponentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MonthlySalaryComponentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.MonthlySalaryComponentServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MonthlySalaryComponentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		monthlySalaryComponentService = (MonthlySalaryComponentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MonthlySalaryComponentService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				monthlySalaryComponentPersistence.getDataSource();
	...
	@Reference
	protected com.adjecti.pis.liferay.service.MonthlySalaryComponentLocalService
		monthlySalaryComponentLocalService;

	protected MonthlySalaryComponentService monthlySalaryComponentService;
