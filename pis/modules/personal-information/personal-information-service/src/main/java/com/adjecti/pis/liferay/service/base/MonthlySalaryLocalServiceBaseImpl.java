...
import com.adjecti.pis.liferay.service.MonthlySalaryLocalService;
...
/**
 * Provides the base implementation for the monthly salary local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.MonthlySalaryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.MonthlySalaryLocalServiceImpl
 * @generated
 */
public abstract class MonthlySalaryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MonthlySalaryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MonthlySalaryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.MonthlySalaryLocalServiceUtil</code>.
	 */
	...
	@Override
	public MonthlySalary addMonthlySalary(MonthlySalary monthlySalary) {
		monthlySalary.setNew(true);

		return monthlySalaryPersistence.update(monthlySalary);
	}
	...
	public MonthlySalary createMonthlySalary(long monthlySalaryId) {
		return monthlySalaryPersistence.create(monthlySalaryId);
	}
	...
	@Override
	public MonthlySalary deleteMonthlySalary(long monthlySalaryId)
		throws PortalException {

		return monthlySalaryPersistence.remove(monthlySalaryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MonthlySalary deleteMonthlySalary(MonthlySalary monthlySalary) {
		return monthlySalaryPersistence.remove(monthlySalary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MonthlySalary.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return monthlySalaryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return monthlySalaryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return monthlySalaryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return monthlySalaryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MonthlySalary fetchMonthlySalary(long monthlySalaryId) {
		return monthlySalaryPersistence.fetchByPrimaryKey(monthlySalaryId);
	}
	 ...
	 */
	@Override
	public MonthlySalary getMonthlySalary(long monthlySalaryId)
		throws PortalException {

		return monthlySalaryPersistence.findByPrimaryKey(monthlySalaryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(monthlySalaryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MonthlySalary.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("monthlySalaryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			monthlySalaryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MonthlySalary.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return monthlySalaryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return monthlySalaryLocalService.deleteMonthlySalary(
			(MonthlySalary)persistedModel);
	}

	public BasePersistence<MonthlySalary> getBasePersistence() {
		return monthlySalaryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return monthlySalaryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MonthlySalary> getMonthlySalaries(int start, int end) {
		return monthlySalaryPersistence.findAll(start, end);
	}
	...
	public int getMonthlySalariesCount() {
		return monthlySalaryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MonthlySalaryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		monthlySalaryLocalService = (MonthlySalaryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MonthlySalaryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = monthlySalaryPersistence.getDataSource();
	...
	protected MonthlySalaryLocalService monthlySalaryLocalService;
