...
import com.adjecti.pis.liferay.service.IDAMFailedTransactionLocalService;
...
/**
 * Provides the base implementation for the idam failed transaction local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.IDAMFailedTransactionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.IDAMFailedTransactionLocalServiceImpl
 * @generated
 */
public abstract class IDAMFailedTransactionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IDAMFailedTransactionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IDAMFailedTransactionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.IDAMFailedTransactionLocalServiceUtil</code>.
	 */
	...
	public IDAMFailedTransaction addIDAMFailedTransaction(
		...
		return idamFailedTransactionPersistence.update(idamFailedTransaction);
	}
	...
	public IDAMFailedTransaction createIDAMFailedTransaction(
		...
		return idamFailedTransactionPersistence.create(idamFailedTransactionId);
	}
	...
	public IDAMFailedTransaction deleteIDAMFailedTransaction(
		...
		return idamFailedTransactionPersistence.remove(idamFailedTransactionId);
	}
	...
	public IDAMFailedTransaction deleteIDAMFailedTransaction(
		...
		return idamFailedTransactionPersistence.remove(idamFailedTransaction);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			IDAMFailedTransaction.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return idamFailedTransactionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return idamFailedTransactionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public IDAMFailedTransaction fetchIDAMFailedTransaction(
		...
		return idamFailedTransactionPersistence.fetchByPrimaryKey(
	...
	public IDAMFailedTransaction getIDAMFailedTransaction(
		...
		return idamFailedTransactionPersistence.findByPrimaryKey(
			idamFailedTransactionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(IDAMFailedTransaction.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return idamFailedTransactionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return idamFailedTransactionLocalService.deleteIDAMFailedTransaction(
			(IDAMFailedTransaction)persistedModel);
	}

	public BasePersistence<IDAMFailedTransaction> getBasePersistence() {
		return idamFailedTransactionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return idamFailedTransactionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<IDAMFailedTransaction> getIDAMFailedTransactions(
		...
		return idamFailedTransactionPersistence.findAll(start, end);
	}
	...
	public int getIDAMFailedTransactionsCount() {
		return idamFailedTransactionPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		idamFailedTransactionLocalService =
			(IDAMFailedTransactionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return IDAMFailedTransactionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				idamFailedTransactionPersistence.getDataSource();
	...
	protected IDAMFailedTransactionLocalService
		idamFailedTransactionLocalService;
