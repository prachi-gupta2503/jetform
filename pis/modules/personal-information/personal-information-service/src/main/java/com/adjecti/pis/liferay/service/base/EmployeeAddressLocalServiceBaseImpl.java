...
/**
 * Provides the base implementation for the employee address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeAddressLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeAddressLocalServiceImpl
 * @generated
 */
public abstract class EmployeeAddressLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeAddressLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeAddressLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeAddressLocalServiceUtil</code>.
	 */
	...
	public EmployeeAddress createEmployeeAddress(long employeeAddressId) {
		return employeeAddressPersistence.create(employeeAddressId);
	}
	...
	@Override
	public EmployeeAddress deleteEmployeeAddress(long employeeAddressId)
		throws PortalException {

		return employeeAddressPersistence.remove(employeeAddressId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeAddress deleteEmployeeAddress(
		EmployeeAddress employeeAddress) {

		return employeeAddressPersistence.remove(employeeAddress);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeAddress.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeAddressPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeAddressPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeAddressPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeAddressPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeAddress fetchEmployeeAddress(long employeeAddressId) {
		return employeeAddressPersistence.fetchByPrimaryKey(employeeAddressId);
	}
	 ...
	 */
	@Override
	public EmployeeAddress getEmployeeAddress(long employeeAddressId)
		throws PortalException {

		return employeeAddressPersistence.findByPrimaryKey(employeeAddressId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeAddressLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeAddress.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeAddressId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeAddressLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeAddress.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeAddressPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeAddressLocalService.deleteEmployeeAddress(
			(EmployeeAddress)persistedModel);
	}

	public BasePersistence<EmployeeAddress> getBasePersistence() {
		return employeeAddressPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeAddressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeAddress> getEmployeeAddresses(int start, int end) {
		return employeeAddressPersistence.findAll(start, end);
	}
	...
	public int getEmployeeAddressesCount() {
		return employeeAddressPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeAddress updateEmployeeAddress(
		EmployeeAddress employeeAddress) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeAddressLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeAddressLocalService = (EmployeeAddressLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeAddressLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeAddressPersistence.getDataSource();
	...
	protected EmployeeAddressLocalService employeeAddressLocalService;
