...
import com.adjecti.pis.liferay.service.FamilyMemberServiceDetailService;
...
/**
 * Provides the base implementation for the family member service detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyMemberServiceDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyMemberServiceDetailServiceImpl
 * @generated
 */
public abstract class FamilyMemberServiceDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FamilyMemberServiceDetailService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyMemberServiceDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyMemberServiceDetailServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FamilyMemberServiceDetailService.class,
	...
	public void setAopProxy(Object aopProxy) {
		familyMemberServiceDetailService =
			(FamilyMemberServiceDetailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyMemberServiceDetailService.class.getName();
	}
	...
	@Reference
	protected
		com.adjecti.pis.liferay.service.FamilyMemberServiceDetailLocalService
			familyMemberServiceDetailLocalService;

	protected FamilyMemberServiceDetailService familyMemberServiceDetailService;
