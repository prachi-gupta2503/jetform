...
import com.adjecti.pis.liferay.service.FamilyServiceDetailLocalService;
...
/**
 * Provides the base implementation for the family service detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.FamilyServiceDetailLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.FamilyServiceDetailLocalServiceImpl
 * @generated
 */
public abstract class FamilyServiceDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FamilyServiceDetailLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FamilyServiceDetailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.FamilyServiceDetailLocalServiceUtil</code>.
	 */
	...
	@Override
	public FamilyServiceDetail addFamilyServiceDetail(
		FamilyServiceDetail familyServiceDetail) {

		familyServiceDetail.setNew(true);

		return familyServiceDetailPersistence.update(familyServiceDetail);
	}
	...
	public FamilyServiceDetail createFamilyServiceDetail(
		long familyServiceDetailId) {

		return familyServiceDetailPersistence.create(familyServiceDetailId);
	}
	...
	@Override
	public FamilyServiceDetail deleteFamilyServiceDetail(
			long familyServiceDetailId)
		throws PortalException {

		return familyServiceDetailPersistence.remove(familyServiceDetailId);
	}
	...
	public FamilyServiceDetail deleteFamilyServiceDetail(
		...
		return familyServiceDetailPersistence.remove(familyServiceDetail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FamilyServiceDetail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return familyServiceDetailPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return familyServiceDetailPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public FamilyServiceDetail fetchFamilyServiceDetail(
		long familyServiceDetailId) {

		return familyServiceDetailPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public FamilyServiceDetail getFamilyServiceDetail(
			long familyServiceDetailId)
		throws PortalException {

		return familyServiceDetailPersistence.findByPrimaryKey(
			familyServiceDetailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FamilyServiceDetail.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return familyServiceDetailPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return familyServiceDetailLocalService.deleteFamilyServiceDetail(
			(FamilyServiceDetail)persistedModel);
	}

	public BasePersistence<FamilyServiceDetail> getBasePersistence() {
		return familyServiceDetailPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return familyServiceDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FamilyServiceDetail> getFamilyServiceDetails(
		int start, int end) {

		return familyServiceDetailPersistence.findAll(start, end);
	}
	...
	public int getFamilyServiceDetailsCount() {
		return familyServiceDetailPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FamilyServiceDetail updateFamilyServiceDetail(
		FamilyServiceDetail familyServiceDetail) {
	...
	public void setAopProxy(Object aopProxy) {
		familyServiceDetailLocalService =
			(FamilyServiceDetailLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FamilyServiceDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				familyServiceDetailPersistence.getDataSource();
	...
	protected FamilyServiceDetailLocalService familyServiceDetailLocalService;
