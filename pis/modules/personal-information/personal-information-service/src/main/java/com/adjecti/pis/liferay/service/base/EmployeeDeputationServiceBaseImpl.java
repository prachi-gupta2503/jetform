...
import com.adjecti.pis.liferay.service.EmployeeDeputationService;
...
/**
 * Provides the base implementation for the employee deputation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDeputationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDeputationServiceImpl
 * @generated
 */
public abstract class EmployeeDeputationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeDeputationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDeputationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDeputationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDeputationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeDeputationService = (EmployeeDeputationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDeputationService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeDeputationLocalService
		employeeDeputationLocalService;

	protected EmployeeDeputationService employeeDeputationService;
