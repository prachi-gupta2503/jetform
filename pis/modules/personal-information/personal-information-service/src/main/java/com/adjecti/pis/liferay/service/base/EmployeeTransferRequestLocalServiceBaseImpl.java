...
import com.adjecti.pis.liferay.service.EmployeeTransferRequestLocalService;
...
/**
 * Provides the base implementation for the employee transfer request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeTransferRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeTransferRequestLocalServiceImpl
 * @generated
 */
public abstract class EmployeeTransferRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeTransferRequestLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeTransferRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeTransferRequestLocalServiceUtil</code>.
	 */
	...
	public EmployeeTransferRequest addEmployeeTransferRequest(
		...
		return employeeTransferRequestPersistence.update(
	...
	public EmployeeTransferRequest createEmployeeTransferRequest(
		...
		return employeeTransferRequestPersistence.create(
	...
	public EmployeeTransferRequest deleteEmployeeTransferRequest(
		...
		return employeeTransferRequestPersistence.remove(
			employeeTransferRequestId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeTransferRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeTransferRequestPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeTransferRequestPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EmployeeTransferRequest fetchEmployeeTransferRequest(
		...
		return employeeTransferRequestPersistence.fetchByPrimaryKey(
			employeeTransferRequestId);
	}
	...
	public EmployeeTransferRequest fetchEmployeeTransferRequestByUuidAndGroupId(
		...
		return employeeTransferRequestPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EmployeeTransferRequest getEmployeeTransferRequest(
		...
		return employeeTransferRequestPersistence.findByPrimaryKey(
			employeeTransferRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeTransferRequest.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, employeeTransferRequest);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					EmployeeTransferRequest.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeTransferRequestLocalService.
			deleteEmployeeTransferRequest(
				(EmployeeTransferRequest)persistedModel);
	}

	public BasePersistence<EmployeeTransferRequest> getBasePersistence() {
		return employeeTransferRequestPersistence;
	}
	...
	public List<EmployeeTransferRequest>
		...
		return employeeTransferRequestPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EmployeeTransferRequest>
		...
		return employeeTransferRequestPersistence.findByUuid_C(
	...
	public EmployeeTransferRequest getEmployeeTransferRequestByUuidAndGroupId(
		...
		return employeeTransferRequestPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EmployeeTransferRequest> getEmployeeTransferRequests(
		...
		return employeeTransferRequestPersistence.findAll(start, end);
	}
	...
	public int getEmployeeTransferRequestsCount() {
		return employeeTransferRequestPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeTransferRequestLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeTransferRequestLocalService =
			(EmployeeTransferRequestLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeTransferRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeTransferRequestPersistence.getDataSource();
	...
	protected EmployeeTransferRequestLocalService
		employeeTransferRequestLocalService;
