...
import com.adjecti.pis.liferay.service.EmployeeReportingService;
...
/**
 * Provides the base implementation for the employee reporting remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeReportingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeReportingServiceImpl
 * @generated
 */
public abstract class EmployeeReportingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeReportingService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeReportingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeReportingServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeReportingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeReportingService = (EmployeeReportingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeReportingService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeReportingLocalService
		employeeReportingLocalService;

	protected EmployeeReportingService employeeReportingService;
