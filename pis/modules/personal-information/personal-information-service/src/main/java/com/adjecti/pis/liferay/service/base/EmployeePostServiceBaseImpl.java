...
import com.adjecti.pis.liferay.service.EmployeePostService;
...
/**
 * Provides the base implementation for the employee post remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePostServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePostServiceImpl
 * @generated
 */
public abstract class EmployeePostServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeePostService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePostService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePostServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePostService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeePostService = (EmployeePostService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePostService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeePostLocalService
		employeePostLocalService;

	protected EmployeePostService employeePostService;
