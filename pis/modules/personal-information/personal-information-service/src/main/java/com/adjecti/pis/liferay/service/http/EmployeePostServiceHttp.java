 ...
 * @see EmployeePostServiceSoap
 * @generated
 */
public class EmployeePostServiceHttp {
	...
	public static com.liferay.portal.kernel.json.JSONArray getByEmployeeId(
		...
		try {
			MethodKey methodKey = new MethodKey(
				EmployeePostServiceUtil.class, "getByEmployeeId",
	...
	public static com.liferay.portal.kernel.json.JSONArray getByPersonalNo(
		...
		try {
			MethodKey methodKey = new MethodKey(
				EmployeePostServiceUtil.class, "getByPersonalNo",
