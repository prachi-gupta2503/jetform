...
import com.adjecti.pis.liferay.service.ServiceRequestWfStatusTypeLocalService;
...
/**
 * Provides the base implementation for the service request wf status type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.ServiceRequestWfStatusTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.ServiceRequestWfStatusTypeLocalServiceImpl
 * @generated
 */
public abstract class ServiceRequestWfStatusTypeLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ServiceRequestWfStatusTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.ServiceRequestWfStatusTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public ServiceRequestWfStatusType addServiceRequestWfStatusType(
		ServiceRequestWfStatusType serviceRequestWfStatusType) {

		serviceRequestWfStatusType.setNew(true);

		return serviceRequestWfStatusTypePersistence.update(
	...
	public ServiceRequestWfStatusType createServiceRequestWfStatusType(
		long serviceRequestWfStatusTypeId) {

		return serviceRequestWfStatusTypePersistence.create(
	...
	@Override
	public ServiceRequestWfStatusType deleteServiceRequestWfStatusType(
			long serviceRequestWfStatusTypeId)
		throws PortalException {

		return serviceRequestWfStatusTypePersistence.remove(
			serviceRequestWfStatusTypeId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ServiceRequestWfStatusType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceRequestWfStatusTypePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceRequestWfStatusTypePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ServiceRequestWfStatusType fetchServiceRequestWfStatusType(
		long serviceRequestWfStatusTypeId) {

		return serviceRequestWfStatusTypePersistence.fetchByPrimaryKey(
			serviceRequestWfStatusTypeId);
	}
	 ...
	 */
	@Override
	public ServiceRequestWfStatusType getServiceRequestWfStatusType(
			long serviceRequestWfStatusTypeId)
		throws PortalException {

		return serviceRequestWfStatusTypePersistence.findByPrimaryKey(
			serviceRequestWfStatusTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ServiceRequestWfStatusType.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ServiceRequestWfStatusType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return serviceRequestWfStatusTypeLocalService.
			deleteServiceRequestWfStatusType(
				(ServiceRequestWfStatusType)persistedModel);
	}

	public BasePersistence<ServiceRequestWfStatusType> getBasePersistence() {
		return serviceRequestWfStatusTypePersistence;
	}
	 ...
	 */
	@Override
	public List<ServiceRequestWfStatusType> getServiceRequestWfStatusTypes(
		int start, int end) {

		return serviceRequestWfStatusTypePersistence.findAll(start, end);
	}
	...
	public int getServiceRequestWfStatusTypesCount() {
		return serviceRequestWfStatusTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceRequestWfStatusType updateServiceRequestWfStatusType(
		ServiceRequestWfStatusType serviceRequestWfStatusType) {
	...
	public void setAopProxy(Object aopProxy) {
		serviceRequestWfStatusTypeLocalService =
			(ServiceRequestWfStatusTypeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceRequestWfStatusTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				serviceRequestWfStatusTypePersistence.getDataSource();
	...
	protected ServiceRequestWfStatusTypeLocalService
		serviceRequestWfStatusTypeLocalService;
