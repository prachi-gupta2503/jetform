...
import com.adjecti.pis.liferay.service.base.AddressServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.adjecti.pis.liferay.service.AddressService</code> interface.
 *
 * <p>
...
public class AddressServiceImpl extends AddressServiceBaseImpl {
	...
	public List<Address> addAddress(List<Address> addressDetails,long employeeId) throws PortalException, EmployeeAddressException
	{
		List<Address> addresses=addressLocalService.addAddress(addressDetails,employeeId);
