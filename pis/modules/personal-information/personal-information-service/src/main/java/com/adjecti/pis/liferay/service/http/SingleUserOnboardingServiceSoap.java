 ...
 * <code>com.adjecti.pis.liferay.model.SingleUserOnboardingSoap</code>. If the method in the
 * service utility returns a
 * <code>com.adjecti.pis.liferay.model.SingleUserOnboarding</code>, that is translated to a
 * <code>com.adjecti.pis.liferay.model.SingleUserOnboardingSoap</code>. Methods that SOAP
 ...
 * @see SingleUserOnboardingServiceHttp
 * @deprecated As of Athanasius (7.3.x), with no direct replacement
 * @generated
 */
@Deprecated
public class SingleUserOnboardingServiceSoap {
	...
	public static int currentStatusBySingleUserOnboardingId(
		...
		try {
			int returnValue =
				SingleUserOnboardingServiceUtil.
	...
	private static Log _log = LogFactoryUtil.getLog(
		SingleUserOnboardingServiceSoap.class);
