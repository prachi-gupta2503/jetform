...
import com.adjecti.pis.liferay.service.EmployeeSeparationRequestLocalService;
...
/**
 * Provides the base implementation for the employee separation request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeSeparationRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeSeparationRequestLocalServiceImpl
 * @generated
 */
public abstract class EmployeeSeparationRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeSeparationRequestLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeSeparationRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeSeparationRequestLocalServiceUtil</code>.
	 */
	...
	public EmployeeSeparationRequest addEmployeeSeparationRequest(
		...
		return employeeSeparationRequestPersistence.update(
	...
	public EmployeeSeparationRequest createEmployeeSeparationRequest(
		...
		return employeeSeparationRequestPersistence.create(
	...
	public EmployeeSeparationRequest deleteEmployeeSeparationRequest(
		...
		return employeeSeparationRequestPersistence.remove(
			employeeSeparationRequestId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeSeparationRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeSeparationRequestPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeSeparationRequestPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EmployeeSeparationRequest fetchEmployeeSeparationRequest(
		...
		return employeeSeparationRequestPersistence.fetchByPrimaryKey(
			employeeSeparationRequestId);
	}
	...
	public EmployeeSeparationRequest
		...
		return employeeSeparationRequestPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public EmployeeSeparationRequest getEmployeeSeparationRequest(
		...
		return employeeSeparationRequestPersistence.findByPrimaryKey(
			employeeSeparationRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeSeparationRequest.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			EmployeeSeparationRequest.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, employeeSeparationRequest);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeSeparationRequestLocalService.
			deleteEmployeeSeparationRequest(
				(EmployeeSeparationRequest)persistedModel);
	}

	public BasePersistence<EmployeeSeparationRequest> getBasePersistence() {
		return employeeSeparationRequestPersistence;
	}
	...
	public List<EmployeeSeparationRequest>
		...
		return employeeSeparationRequestPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public EmployeeSeparationRequest
		...
		return employeeSeparationRequestPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EmployeeSeparationRequest> getEmployeeSeparationRequests(
		...
		return employeeSeparationRequestPersistence.findAll(start, end);
	}
	...
	public int getEmployeeSeparationRequestsCount() {
		return employeeSeparationRequestPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		employeeSeparationRequestLocalService =
			(EmployeeSeparationRequestLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeSeparationRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeSeparationRequestPersistence.getDataSource();
	...
	protected EmployeeSeparationRequestLocalService
		employeeSeparationRequestLocalService;
