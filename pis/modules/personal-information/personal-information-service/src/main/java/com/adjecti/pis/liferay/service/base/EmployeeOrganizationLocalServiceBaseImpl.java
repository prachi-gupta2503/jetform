...
import com.adjecti.pis.liferay.service.EmployeeOrganizationLocalService;
...
/**
 * Provides the base implementation for the employee organization local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeOrganizationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeOrganizationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeOrganizationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeOrganizationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeOrganizationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeOrganizationLocalServiceUtil</code>.
	 */
	...
	public EmployeeOrganization addEmployeeOrganization(
		...
		return employeeOrganizationPersistence.update(employeeOrganization);
	}
	...
	public EmployeeOrganization createEmployeeOrganization(
		...
		return employeeOrganizationPersistence.create(employeeOrganizationId);
	}
	...
	public EmployeeOrganization deleteEmployeeOrganization(
		...
		return employeeOrganizationPersistence.remove(employeeOrganizationId);
	}
	...
	public EmployeeOrganization deleteEmployeeOrganization(
		...
		return employeeOrganizationPersistence.remove(employeeOrganization);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeOrganization.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeOrganizationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeOrganizationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EmployeeOrganization fetchEmployeeOrganization(
		...
		return employeeOrganizationPersistence.fetchByPrimaryKey(
	...
	public EmployeeOrganization getEmployeeOrganization(
		...
		return employeeOrganizationPersistence.findByPrimaryKey(
			employeeOrganizationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeOrganization.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeOrganizationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeOrganizationLocalService.deleteEmployeeOrganization(
			(EmployeeOrganization)persistedModel);
	}

	public BasePersistence<EmployeeOrganization> getBasePersistence() {
		return employeeOrganizationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeOrganizationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EmployeeOrganization> getEmployeeOrganizations(
		...
		return employeeOrganizationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeOrganizationsCount() {
		return employeeOrganizationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		employeeOrganizationLocalService =
			(EmployeeOrganizationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeOrganizationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				employeeOrganizationPersistence.getDataSource();
	...
	protected EmployeeOrganizationLocalService employeeOrganizationLocalService;
