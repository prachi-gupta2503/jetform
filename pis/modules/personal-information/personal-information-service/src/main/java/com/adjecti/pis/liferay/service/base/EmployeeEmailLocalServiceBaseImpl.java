...
import com.adjecti.pis.liferay.service.EmployeeEmailLocalService;
...
/**
 * Provides the base implementation for the employee email local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeEmailLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeEmailLocalServiceImpl
 * @generated
 */
public abstract class EmployeeEmailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeEmailLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeEmailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeEmailLocalServiceUtil</code>.
	 */
	...
	public EmployeeEmail addEmployeeEmail(EmployeeEmail employeeEmail) {
		...
		return employeeEmailPersistence.update(employeeEmail);
	}
	...
	public EmployeeEmail createEmployeeEmail(long employeeEmailId) {
		return employeeEmailPersistence.create(employeeEmailId);
	}
	...
	@Override
	public EmployeeEmail deleteEmployeeEmail(long employeeEmailId)
		throws PortalException {

		return employeeEmailPersistence.remove(employeeEmailId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeEmail deleteEmployeeEmail(EmployeeEmail employeeEmail) {
		return employeeEmailPersistence.remove(employeeEmail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeEmail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeEmailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeEmailPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeEmailPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeEmailPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeEmail fetchEmployeeEmail(long employeeEmailId) {
		return employeeEmailPersistence.fetchByPrimaryKey(employeeEmailId);
	}
	 ...
	 */
	@Override
	public EmployeeEmail getEmployeeEmail(long employeeEmailId)
		throws PortalException {

		return employeeEmailPersistence.findByPrimaryKey(employeeEmailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeEmailLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeEmail.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeEmailId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			employeeEmailLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeEmail.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeEmailPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeEmailLocalService.deleteEmployeeEmail(
			(EmployeeEmail)persistedModel);
	}

	public BasePersistence<EmployeeEmail> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeEmailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeEmail> getEmployeeEmails(int start, int end) {
		return employeeEmailPersistence.findAll(start, end);
	}
	...
	public int getEmployeeEmailsCount() {
		return employeeEmailPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeEmail updateEmployeeEmail(EmployeeEmail employeeEmail) {
		return employeeEmailPersistence.update(employeeEmail);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeEmailLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeEmailLocalService = (EmployeeEmailLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeEmailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeEmailPersistence.getDataSource();
