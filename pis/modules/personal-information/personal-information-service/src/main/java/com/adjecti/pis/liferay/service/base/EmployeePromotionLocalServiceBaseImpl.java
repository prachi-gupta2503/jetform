...
import com.adjecti.pis.liferay.service.EmployeePromotionLocalService;
...
/**
 * Provides the base implementation for the employee promotion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeePromotionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeePromotionLocalServiceImpl
 * @generated
 */
public abstract class EmployeePromotionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeePromotionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeePromotionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeePromotionLocalServiceUtil</code>.
	 */
	...
	public EmployeePromotion addEmployeePromotion(
		...
		return employeePromotionPersistence.update(employeePromotion);
	}
	...
	public EmployeePromotion createEmployeePromotion(long employeePromotionId) {
		return employeePromotionPersistence.create(employeePromotionId);
	}
	...
	public EmployeePromotion deleteEmployeePromotion(long employeePromotionId)
		...
		return employeePromotionPersistence.remove(employeePromotionId);
	}
	...
	public EmployeePromotion deleteEmployeePromotion(
		...
		return employeePromotionPersistence.remove(employeePromotion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeePromotion.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeePromotionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeePromotionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeePromotionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeePromotionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeePromotion fetchEmployeePromotion(long employeePromotionId) {
		return employeePromotionPersistence.fetchByPrimaryKey(
			employeePromotionId);
	}
	...
	public EmployeePromotion getEmployeePromotion(long employeePromotionId)
		...
		return employeePromotionPersistence.findByPrimaryKey(
			employeePromotionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeePromotion.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeePromotionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeePromotion.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeePromotionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeePromotionLocalService.deleteEmployeePromotion(
			(EmployeePromotion)persistedModel);
	}

	public BasePersistence<EmployeePromotion> getBasePersistence() {
		return employeePromotionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeePromotionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EmployeePromotion> getEmployeePromotions(int start, int end) {
		return employeePromotionPersistence.findAll(start, end);
	}
	...
	public int getEmployeePromotionsCount() {
		return employeePromotionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeePromotionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeePromotionLocalService = (EmployeePromotionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeePromotionLocalService.class.getName();
	}
	...
	protected EmployeePromotionLocalService employeePromotionLocalService;
