...
import com.adjecti.pis.liferay.service.EmployeeDscService;
...
/**
 * Provides the base implementation for the employee dsc remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeDscServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeDscServiceImpl
 * @generated
 */
public abstract class EmployeeDscServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeDscService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDscService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeDscServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDscService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeDscService = (EmployeeDscService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDscService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeDscLocalService
		employeeDscLocalService;

	protected EmployeeDscService employeeDscService;
