...
import com.adjecti.pis.liferay.service.EmployeeMessageService;
...
/**
 * Provides the base implementation for the employee message remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeMessageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeMessageServiceImpl
 * @generated
 */
public abstract class EmployeeMessageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeMessageService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeMessageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeMessageServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeMessageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeMessageService = (EmployeeMessageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeMessageService.class.getName();
	}
	...
	@Reference
	protected com.adjecti.pis.liferay.service.EmployeeMessageLocalService
		employeeMessageLocalService;

	protected EmployeeMessageService employeeMessageService;
