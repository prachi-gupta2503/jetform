...
import com.adjecti.pis.liferay.service.EmployeeTransferLocalService;
...
/**
 * Provides the base implementation for the employee transfer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adjecti.pis.liferay.service.impl.EmployeeTransferLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adjecti.pis.liferay.service.impl.EmployeeTransferLocalServiceImpl
 * @generated
 */
public abstract class EmployeeTransferLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeTransferLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeTransferLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.adjecti.pis.liferay.service.EmployeeTransferLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeTransfer addEmployeeTransfer(
		EmployeeTransfer employeeTransfer) {

		employeeTransfer.setNew(true);

		return employeeTransferPersistence.update(employeeTransfer);
	}
	...
	public EmployeeTransfer createEmployeeTransfer(long employeeTransferId) {
		return employeeTransferPersistence.create(employeeTransferId);
	}
	...
	public EmployeeTransfer deleteEmployeeTransfer(long employeeTransferId)
		...
		return employeeTransferPersistence.remove(employeeTransferId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeTransfer deleteEmployeeTransfer(
		EmployeeTransfer employeeTransfer) {

		return employeeTransferPersistence.remove(employeeTransfer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeTransfer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeTransferPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeTransferPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeTransferPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeTransferPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeTransfer fetchEmployeeTransfer(long employeeTransferId) {
		return employeeTransferPersistence.fetchByPrimaryKey(
			employeeTransferId);
	}
	 ...
	 */
	@Override
	public EmployeeTransfer getEmployeeTransfer(long employeeTransferId)
		throws PortalException {

		return employeeTransferPersistence.findByPrimaryKey(employeeTransferId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeTransfer.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeeTransferId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeeTransfer.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeTransferPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return employeeTransferLocalService.deleteEmployeeTransfer(
			(EmployeeTransfer)persistedModel);
	}

	public BasePersistence<EmployeeTransfer> getBasePersistence() {
		return employeeTransferPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeTransferPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeTransfer> getEmployeeTransfers(int start, int end) {
		return employeeTransferPersistence.findAll(start, end);
	}
	...
	public int getEmployeeTransfersCount() {
		return employeeTransferPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeTransfer updateEmployeeTransfer(
		EmployeeTransfer employeeTransfer) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeTransferLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeTransferLocalService = (EmployeeTransferLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeTransferLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeTransferPersistence.getDataSource();
	...
	protected EmployeeTransferLocalService employeeTransferLocalService;
