					...
					<aui:form name="employee-msform">
						...
						<ul id="progressbar">
						  ...
						  <fieldset id="fs1">
							  ...
							  <%@include file="/jsp/employee/employee_personal_details_add.jsp"%>  
						  ...
						  <fieldset id="fs2">
							  <%@include file="/jsp/employee/employee_address_detail_add.jsp"%>  
						   ...
						   <fieldset id="fs3">
							 ...
							 <%@include file="/jsp/employee/employee_work_experience_add.jsp"%>  
							<input type="button" name="previous"
								class="btn btn-secondary previous action-button-previous"
								value="Previous"> <input type="button" name="next"
						 ...
						 <fieldset id="fs4">
							 ...
							 <%@include file="/jsp/employee/employee_verification_add.jsp"%>  
							<input type="button" name="previous"
								class="btn btn-secondary previous action-button-previous"
								value="Previous"> <input type="button" name="next"
						...
						<fieldset id="fs5">
							  ...
							  <%@include file="/jsp/employee/employee_joining_details_add.jsp"%>
							<input type="button" name="previous"
								class="btn btn-secondary previous action-button-previous"
						...
						<fieldset id="fs6">
						<%@include file="/jsp/employee/employee_documents_add.jsp"%>
						<input type="button" name="previous"
								class="btn btn-secondary previous action-button-previous"
								value="Previous"> <input type="button"
								 name="next"
						...
						<fieldset id="fs7">
						 ...
						 <%@include file="/jsp/employee/employee_permission_add.jsp"%>
							<input type="button" name="previous"
								class="btn btn-secondary previous action-button-previous"
								value="Previous"> <input type="button"
						 ...
						 <fieldset id="fs8">
							  <%@include file="/jsp/employee/employee_qualification_add.jsp"%>  
							<input type="button" name="previous"
								class="btn btn-secondary previous action-button-previous"
								value="Previous"> <input type="button" name="next"
				 ...
				 '/pis.people/add-people',
				  {
				    ...
				    dateOfBirth: $("#<portlet:namespace/>dateOfBirth").val(),
				    citizenId: 1 ,
				    phTypeId: $("#<portlet:namespace/>phTypeId").val() ,
				    religionId: $("#<portlet:namespace/>religion").val(),
				    aadhaarNo: $("#<portlet:namespace/>aadhaarNo").val(),
				    panNo: $("#<portlet:namespace/>panNo").val(),
				    identityProofId: identityProofId,
				    color: $("#<portlet:namespace/>color").val(),
				    height: $("#<portlet:namespace/>height").val(),
				    identificationMark:  $("#<portlet:namespace/>identificationMark").val(),
				    firstName_Hi: $("#<portlet:namespace/>firstName_Hindi_").val(),
				    lastName_Hi: $("#<portlet:namespace/>lastName_Hindi_").val(),
				    middleName_Hi: $("#<portlet:namespace/>middleName_Hindi_").val(),
				    firstName_En: $("#<portlet:namespace/>firstName_English_").val(),
				    fatherName_Hi: $("#<portlet:namespace/>fatherName_Hindi_").val(),
				    fatherName_En: $("#<portlet:namespace/>fatherName_English_").val(),
				    lastName_En: $("#<portlet:namespace/>lastName_English_").val(),
				    middleName_En: $("#<portlet:namespace/>middleName_English_").val(),
				    appellation: $("#<portlet:namespace/>appellation").val(),
				    bloodGroup: $("#<portlet:namespace/>bloodGroup").val(),
				    gender: $("#<portlet:namespace/>inlineRadio1").val(),
				    castCategory: $("#<portlet:namespace/>inlineRadio2").val(),
				    maritalStatus: $("#<portlet:namespace/>inlineRadio3").val(),
				    exServiceMan:  $("#<portlet:namespace/>ex_Service_Man").val()
				  },
				  function(obj) {
				    console.log(obj);
				    this.employeeId=obj;
