...
/**
 * Provides the local service interface for AuditEventArchive. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AuditEventArchiveLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AuditEventArchiveLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.ayudh.audit.service.impl.AuditEventArchiveLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the audit event archive local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuditEventArchiveLocalServiceUtil} if injection and service tracking are not available.
	 */
