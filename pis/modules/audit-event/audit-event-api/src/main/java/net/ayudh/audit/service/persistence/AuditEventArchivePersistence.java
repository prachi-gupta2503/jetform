...
/**
 * The persistence interface for the audit event archive service.
 *
 * <p>
 ...
 * @see AuditEventArchiveUtil
 * @generated
 */
@ProviderType
public interface AuditEventArchivePersistence
	extends BasePersistence<AuditEventArchive> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AuditEventArchiveUtil} to access the audit event archive persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<AuditEventArchive> auditEventArchives);
	 ...
	 */
	public java.util.List<AuditEventArchive> findAll();
	 ...
	 */
	public java.util.List<AuditEventArchive> findAll(int start, int end);
	...
	public java.util.List<AuditEventArchive> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AuditEventArchive>
			orderByComparator);
