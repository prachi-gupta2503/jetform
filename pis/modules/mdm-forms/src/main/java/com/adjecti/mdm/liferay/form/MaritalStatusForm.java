...
@HtmlForm(formId="MaritalStatusForm_123456",
entityClass=MaritalStatus.class, advanceFilter = true,
	elements={
	@HtmlElement(name="maritalStatusId", controlType=ControlType.hidden, key=true),
