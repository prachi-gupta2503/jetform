...
@HtmlForm(formId="SubjectOfTrainingForm_123456",
entityClass=SubjectOfTraining.class, advanceFilter = true,
	elements={
	@HtmlElement(name="subjectOfTrainingId", controlType=ControlType.hidden, key=true),
	@HtmlElement(name="code", seachable = true, required = true, unique=true, controlType = ControlType.number, max = 2147483647, min = 1 ),
	@HtmlElement(name="trainingSubject", seachable = true,unique=true, required = true,regExp = HtmlElement.REGEXP_ALPHA_WITHALLSYMBOL, maxLength = 255),
...
public class SubjectOfTrainingForm {
