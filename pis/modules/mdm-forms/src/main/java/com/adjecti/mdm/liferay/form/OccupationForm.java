...
@HtmlForm(formId="OccupationForm_123456",
entityClass=Occupation.class, advanceFilter = true,
	elements={
	@HtmlElement(name="occupationId", controlType=ControlType.hidden, key=true),
