...
@HtmlForm(formId="TradeForm_123456",
entityClass=Trade.class, advanceFilter = true,
	elements={
	@HtmlElement(name="tradeId", controlType=ControlType.hidden, key=true),
	@HtmlElement(name="code", seachable = true, required = true, unique=true, controlType = ControlType.number, max = 2147483647, min = 1 ),
	@HtmlElement(name="name", seachable = true, required = true, unique=true, regExp = HtmlElement.REGEXP_ALPHA_WITHALLSYMBOL/*REGEXP_ALPHA_SPACE*/, maxLength = 255),
