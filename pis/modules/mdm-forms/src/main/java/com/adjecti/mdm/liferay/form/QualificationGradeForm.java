...
@HtmlForm(formId="QualificationGradeForm_123456",
entityClass=QualificationGrade.class, advanceFilter = true,
	elements={
	@HtmlElement(name="qualificationGradeId", controlType=ControlType.hidden, key=true),
...
public class QualificationGradeForm {
