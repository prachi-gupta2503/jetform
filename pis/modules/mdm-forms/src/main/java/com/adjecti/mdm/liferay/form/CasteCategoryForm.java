...
@HtmlForm(formId="CasteCategoryForm_123456",
entityClass=CasteCategory.class, advanceFilter = true,
	elements={
	@HtmlElement(name="casteCategoryId", controlType=ControlType.hidden, key=true),
...
public class CasteCategoryForm {
