...
@HtmlForm(formId="ServiceRequestTypeForm_123456",
entityClass=ServiceRequestType.class, advanceFilter = true,
	elements={
	@HtmlElement(name="serviceRequestTypeId", controlType=ControlType.hidden, key=true),
...
public class ServiceRequestTypeForm {
