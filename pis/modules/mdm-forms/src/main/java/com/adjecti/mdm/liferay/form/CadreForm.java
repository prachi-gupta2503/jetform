...
@HtmlForm(formId="CadreForm_123456",
entityClass=Cadre.class, advanceFilter = true,
	elements={
	@HtmlElement(name="cadreId", controlType=ControlType.hidden, key=true),
...
public class CadreForm {
	Cadre cadre;

	public CadreForm(Cadre cadre) {
		super();
		this.cadre = cadre;
	}
}
