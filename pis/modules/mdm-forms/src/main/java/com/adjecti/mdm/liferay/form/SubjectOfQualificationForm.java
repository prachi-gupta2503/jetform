...
@HtmlForm(formId="SubjectOfQualificationForm_123456",
entityClass=SubjectOfQualification.class, advanceFilter = true,
	elements={
	@HtmlElement(name="subjectOfQualificationId", controlType=ControlType.hidden, key=true),
	@HtmlElement(name="code", seachable = true, required = true, unique=true, controlType = ControlType.number, max = 2147483647, min = 1 ),
	@HtmlElement(name="subjectOfQualification", seachable = true,unique=true, required = true,regExp = HtmlElement.REGEXP_ALPHA_WITHALLSYMBOL, maxLength = 255),
...
public class SubjectOfQualificationForm {
