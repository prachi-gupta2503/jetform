...
@HtmlForm(formId="BenefitSchemeForm_123456",
entityClass=BenefitScheme.class, advanceFilter = true,
	elements={
	@HtmlElement(name="benefitSchemeId", controlType=ControlType.hidden, key=true),
	@HtmlElement(name="code", seachable = true, required = true, unique=true, validType =HtmlElement.ValidType.alphanum, maxLength = 30 ),
...
public class BenefitSchemeForm {
