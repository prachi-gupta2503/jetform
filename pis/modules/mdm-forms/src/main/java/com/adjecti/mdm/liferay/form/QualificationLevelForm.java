...
@HtmlForm(formId="QualificationLevelForm_123456",
entityClass=QualificationLevel.class, advanceFilter = true,
	elements={
			          
	@HtmlElement(name="qualificationLevelId", controlType=ControlType.hidden, key=true),
...
public class QualificationLevelForm {
