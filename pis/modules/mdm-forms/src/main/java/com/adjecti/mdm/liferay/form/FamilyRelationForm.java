...
@HtmlForm(formId="FamilyRelationForm_123456",
entityClass=FamilyRelation.class, advanceFilter = true,
	elements={
	@HtmlElement(name="familyRelationId", controlType=ControlType.hidden, key=true),
	@HtmlElement(name="code", seachable = true, required = true, unique=true, controlType = ControlType.number, max = 2147483647, min = 1 ),
	@HtmlElement(name="name", seachable = true, required = true,unique=true, regExp=HtmlElement.REGEXP_ALPHA_WITHALLSYMBOL, maxLength = 255/*"/^[A-Za-z\\- ]+$/"*/),
...
public class FamilyRelationForm {
