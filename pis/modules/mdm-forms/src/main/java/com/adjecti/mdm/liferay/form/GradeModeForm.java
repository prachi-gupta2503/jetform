...
@HtmlForm(formId="GradeModeForm_123456",
entityClass=GradeMode.class, advanceFilter = true,
	elements={
	@HtmlElement(name="gradeModeId", controlType=ControlType.hidden, key=true),
